# Rate Calculator Scenarios -- 20260510_035223

**Run ID:** `701d3bb9-220b-4d51-b063-351fa7c55894`
**Total scenarios:** 45
...
- load_id: `2dd777f7-ce87-4c9e-a8db-357989b4dfc0`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `b6a1d79c-6f28-454e-8e7e-3e40bc1d5052`
...
- load_id: `ca3e6164-a04d-4317-bc5f-0dafdfcf926b`
...
- load_id: `fc4bf951-714c-4b2d-a0bb-60d506e2800b`
...
- load_id: `5855298b-223e-4663-9c37-0c9e0ff2799e`
...
- load_id: `db5e070e-b380-445c-a9b5-b9734c786345`
...
- cost_estimate matched (1610.0).
- load_id: `71e0d3f6-9a7a-4868-9108-14121ce3d8c8`
...
- load_id: `06e8aba8-d064-427c-9b94-bbd0c4846a14`
...
- load_id: `4dff9dd0-065a-441c-b0a7-b5f7bbf31815`
...
- load_id: `e8b6aced-85c0-494b-b33e-104e50c346cb`
...
- load_id: `c4022de4-64d6-4336-976e-eefa26aa0a9c`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `39c5f115-0e00-44d4-9642-4300b50fb919`
...
- load_id: `816151b0-89b5-483f-ab8f-b3897144fd35`
...
- load_id: `80f10a82-70a7-49c8-896c-611e7f471b6c`
...
- load_id: `73d664b2-66d0-432b-bce9-98a2b3a54754`
...
- cost_estimate matched (1610.0).
- load_id: `f8a60f15-5935-4ee9-8818-a91a623c456f`
...
- cost_estimate matched (1610.0).
- load_id: `1ac4b638-eb06-4d5b-a234-a34b093711e3`
...
- cost_estimate matched (1610.0).
- load_id: `8c422a08-c058-4d4e-a57f-c1262c3820be`
...
- cost_estimate matched (1610.0).
- load_id: `f3dd89e6-00d1-47a0-b903-d2001b25eae2`
...
- cost_estimate matched (1610.0).
- load_id: `2ccdc4db-9695-4c02-a792-84088ef2395f`
...
- cost_estimate matched (1610.0).
- load_id: `35bca364-a8de-4eb3-b8ca-4a60e1cdca90`
...
- cost_estimate matched (1610.0).
- load_id: `3900b4dd-387e-4d20-a32a-1dc2150fcc5d`
...
- cost_estimate matched (1610.0).
- load_id: `7356c819-214d-4eaa-a36c-9286d39ea895`
...
- cost_estimate matched (1610.0).
- load_id: `55c15c56-275e-4207-82d0-2e8d0a49a6a1`
...
- cost_estimate matched (1610.0).
- load_id: `438136c8-197d-401f-86fe-9b03750f86d4`
...
- cost_estimate matched (1610.0).
- load_id: `9feddd7a-a927-43ff-8f84-59d7f02f4825`
...
- cost_estimate matched (1610.0).
- load_id: `547f33fa-3b8e-4d83-96bc-1cef9b0d6c76`
...
- cost_estimate matched (1610.0).
- load_id: `3d5e9fc1-b752-488b-a31e-f97e97a73012`
...
- cost_estimate matched (245.0).
- load_id: `b26a2672-c3cf-4400-999f-dd1076b56187`
...
- load_id: `b2d63277-94f9-4936-9db8-050d7584226e`
...
- load_id: `bc9f50fc-cbd4-44bf-b8fa-ffd1b0c207cd`
...
- load_id: `16a4ac3e-d920-489f-b211-0056cfbebd4b`
...
- load_id: `f8c52087-5321-4f4b-90bb-97857c88133a`
...
- load_id: `f8b15816-1073-4112-b491-1cb70de45b40`
...
- load_id: `5961a831-8c84-43a7-8b8d-03cbff54d2d8`
...
- No graded predictions; document-only.
- load_id: `6b86ba66-03b7-4112-ab91-81eeac4efe33`
