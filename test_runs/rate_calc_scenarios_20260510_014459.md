# Rate Calculator Scenarios -- 20260510_014459

**Run ID:** `0fe5a464-71eb-475b-a693-bf53e6b5497e`
**Total scenarios:** 45
...
- load_id: `60379441-8d97-4dc7-92db-de56f236a506`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `5ab5e629-f77f-4861-9709-1bb3150c9964`
...
- load_id: `f578c2a6-7b23-4e9a-aa72-47628cf6c393`
...
- load_id: `6d98feda-fda9-4847-8357-859ae0de7ae4`
...
- load_id: `8db6b119-ef62-4e88-a88f-f8afaa11b044`
...
- load_id: `0b4b2c88-911c-4ec7-9403-700e982bce30`
...
- cost_estimate matched (1610.0).
- load_id: `79091fe6-f297-4ff7-91e0-dcb04194147f`
...
- load_id: `566815f7-a3d0-47d9-acb5-01150b058430`
...
- load_id: `650c6316-d32e-405c-8210-3c090b4b2ba7`
...
- load_id: `1323d438-d5b0-4852-94a3-80dbfd5ea802`
...
- load_id: `a80ea3ba-3170-4de2-aa89-38846bbd8a99`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `793d2848-5239-4185-984a-720102639296`
...
- load_id: `483ac491-cc82-4950-9bcb-9a9648680a5f`
...
- load_id: `13822328-c012-4c99-bfa9-8afdd2fc2edd`
...
- load_id: `c85c6a44-65fe-4be7-8931-0a44f8180436`
...
- cost_estimate matched (1610.0).
- load_id: `a00af7b0-5d59-4656-8c9e-8e42990979fb`
...
- cost_estimate matched (1610.0).
- load_id: `c5d29435-9450-4020-86d5-eadbac375bcd`
...
- cost_estimate matched (1610.0).
- load_id: `224ac500-55b3-4e19-af18-2202f41b4bf6`
...
- cost_estimate matched (1610.0).
- load_id: `121bdd9e-9ce8-4e2d-a8c9-4a1ba7b78558`
...
- cost_estimate matched (1610.0).
- load_id: `49ace586-51b8-4489-af4e-b3bcea62017f`
...
- cost_estimate matched (1610.0).
- load_id: `ed92d896-22fa-487f-a9ad-f8a8c2c0b381`
...
- cost_estimate matched (1610.0).
- load_id: `5530e712-0efc-4def-b9ad-c2efa6285ed6`
...
- cost_estimate matched (1610.0).
- load_id: `37c75b26-d9bd-4dd7-bb33-58a4faf877a6`
...
- cost_estimate matched (1610.0).
- load_id: `549e6bf6-95ff-4dd1-a149-72c820cfb798`
...
- cost_estimate matched (1610.0).
- load_id: `7930c8f2-d505-4e3d-a098-fd17274a2528`
...
- cost_estimate matched (1610.0).
- load_id: `a2bb758b-d2d6-4880-9e25-dd593bbc97b3`
...
- cost_estimate matched (1610.0).
- load_id: `f0063447-d36b-4ed5-9c38-d51bfaf79917`
...
- cost_estimate matched (1610.0).
- load_id: `75efa3d2-e652-47f4-a1d5-15ee93668531`
...
- cost_estimate matched (245.0).
- load_id: `bebd99a7-0d7e-4d82-975b-93cacc0638b8`
...
- load_id: `9a2f1bf1-74d2-40e8-8daf-ef8fde736951`
...
- load_id: `9c42045d-e6a0-4471-a8e1-0c0fe7c21e2e`
...
- load_id: `9c4f4a6d-dbf1-4bb4-9836-26ce04612794`
...
- load_id: `fb36fca2-3c95-4007-bb2e-4e73ff85ea7e`
...
- load_id: `8f44529f-eee3-4f24-9609-2e0be5d31ba6`
...
- load_id: `923b0c3e-70fb-4c1b-a2d4-92f64bcca17f`
...
- No graded predictions; document-only.
- load_id: `59e0399a-a1de-4458-aded-cfe48b51e7ac`
