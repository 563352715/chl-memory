# Rate Calculator Scenarios -- 20260510_120620

**Run ID:** `5fdf3115-fd5f-454d-a82e-78ce64719e6d`
**Total scenarios:** 45
...
- load_id: `96a000ca-d3fd-4f5e-a865-91ceb5897447`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `84b51423-74bf-4e8c-bbec-836127331089`
...
- load_id: `96d6b4c9-1547-485c-84c9-61b3457dd295`
...
- load_id: `7adde6d2-9a54-42a9-99c4-85fe8f193f61`
...
- load_id: `217d0bfa-7a18-4923-abfe-d0bf8a35a031`
...
- load_id: `d224da97-4da1-420f-b2a4-a38caca5bf3e`
...
- cost_estimate matched (1610.0).
- load_id: `dfe0f49b-16f3-4c4e-ad90-9f974b8348b8`
...
- load_id: `0175664d-f1d2-4e1f-bc95-e01884c19537`
...
- load_id: `66ffb394-cf20-42a8-aeb8-21c828f20c7a`
...
- load_id: `f6208351-b79e-4262-ab1d-5a6bb877c1d2`
...
- load_id: `000847fb-2d86-4109-9b12-c8352e04dc1d`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `1d72e284-2965-4037-848c-b9d12f07c877`
...
- load_id: `39fc3159-441d-400e-ae8a-e50099b4980f`
...
- load_id: `f400b88b-a7cf-4704-bdfd-0f4c5c155faf`
...
- load_id: `0811b33e-407e-4fb5-a29f-6b890a3d639b`
...
- cost_estimate matched (1610.0).
- load_id: `657af38b-9bf8-4cdf-b5cf-6e6a81bd90d1`
...
- cost_estimate matched (1610.0).
- load_id: `3c9c2532-d4b7-4f06-b339-8f58cee3973a`
...
- cost_estimate matched (1610.0).
- load_id: `44b21eec-bbf8-40e4-833a-31043c43d748`
...
- cost_estimate matched (1610.0).
- load_id: `5ae08c2e-ca9c-40d1-a999-6adb724652f6`
...
- cost_estimate matched (1610.0).
- load_id: `dde97e19-5fd7-42d9-8823-32b959a48cfc`
...
- cost_estimate matched (1610.0).
- load_id: `5541c779-016b-41d0-b76a-c6ea5aa08748`
...
- cost_estimate matched (1610.0).
- load_id: `e53fe2a7-973e-40b3-93a0-a5f842240143`
...
- cost_estimate matched (1610.0).
- load_id: `b4997125-7380-4601-9574-78c59503f1ef`
...
- cost_estimate matched (1610.0).
- load_id: `37fad058-9d07-41e4-8d7b-0832c4917c24`
...
- cost_estimate matched (1610.0).
- load_id: `1d5fb529-36f0-444f-9bfb-707aedeb2ef4`
...
- cost_estimate matched (1610.0).
- load_id: `e3ede61b-dece-4ff1-9bbd-9f15abac5335`
...
- cost_estimate matched (1610.0).
- load_id: `dc2729f4-d1f5-4a4e-9684-a179950ad240`
...
- cost_estimate matched (1610.0).
- load_id: `65adf028-7d92-4275-bf41-7de4679a4c04`
...
- cost_estimate matched (245.0).
- load_id: `95bd1db0-2489-4932-aa17-1b4573f32811`
...
- load_id: `04710db6-6cc2-4ef3-8c59-e55d06d64aaf`
...
- load_id: `fad883ed-6e8b-4b7d-8ba0-36523806f100`
...
- load_id: `50959a94-7f44-4c71-ac73-01cddadbadac`
...
- load_id: `f8b9a962-cb9c-477b-a44d-1384365a44e2`
...
- load_id: `76f02742-f54e-440a-a875-27165f2d04b8`
...
- load_id: `825b4791-c788-461b-94a8-e8edd08b29ea`
...
- No graded predictions; document-only.
- load_id: `617774ab-6c8b-464b-a5b0-6a2d6606c330`
