# Rate Calculator Scenarios -- 20260510_013451

**Run ID:** `dc09f6a2-0f0e-4cbb-a89f-afcf42deaffb`
**Total scenarios:** 45
...
- load_id: `73a569e9-0142-42a6-ba8a-a31e83edcd3a`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `f7a8b833-0c36-4da9-bcdd-1f0725259a2f`
...
- load_id: `674af903-600a-4db8-b9d9-c320503ba6b9`
...
- load_id: `10c39414-55e7-4090-95de-1b694817f193`
...
- load_id: `079e4c4f-26b5-4b9b-9514-64db357f9315`
...
- load_id: `d6ba4fda-969a-400e-9030-f1c921ee9b8e`
...
- cost_estimate matched (1610.0).
- load_id: `08b7f06f-f267-47ff-b40a-654453467fb2`
...
- load_id: `bc8a391d-a39e-418a-8696-856dc84e075b`
...
- load_id: `83fa5802-e437-41bb-8975-037d937a58df`
...
- load_id: `91dab25b-4df2-4002-ac3d-6ab1cba6a923`
...
- load_id: `49ae0f1c-bb70-429a-baf2-58f51efaf50c`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `47b5d7e1-6f8f-4913-bac6-834049820e46`
...
- load_id: `dd8a05f7-dae3-4ee0-b5e8-8b127010482d`
...
- load_id: `6ff680b9-58ee-4f78-82e8-8d68470e0f24`
...
- load_id: `46de7522-b0d5-4d84-9f83-ee8279482f95`
...
- cost_estimate matched (1610.0).
- load_id: `cb588052-75ed-473b-b7d1-1d2f00e0cf3e`
...
- cost_estimate matched (1610.0).
- load_id: `8f1afde9-2bb7-4020-83f3-6ba2c727fafe`
...
- cost_estimate matched (1610.0).
- load_id: `649713b7-a1a2-458e-9c9f-43bffc682678`
...
- cost_estimate matched (1610.0).
- load_id: `91d9fabf-4425-4499-9c0e-4734e415cab2`
...
- cost_estimate matched (1610.0).
- load_id: `5cd5ec6e-aaec-4802-9d88-40556b015f95`
...
- cost_estimate matched (1610.0).
- load_id: `8fa372de-d113-4a73-93ce-5d1bca402dd8`
...
- cost_estimate matched (1610.0).
- load_id: `64dbee3a-3bd9-4a74-9dd4-a9b844af841e`
...
- cost_estimate matched (1610.0).
- load_id: `337ec18f-1fa0-4999-abf8-5f3d0a136a10`
...
- cost_estimate matched (1610.0).
- load_id: `0d781b4b-0157-4c13-be7d-ecba0188882a`
...
- cost_estimate matched (1610.0).
- load_id: `319319f8-b7a8-4992-afbc-8de11f1e27a3`
...
- cost_estimate matched (1610.0).
- load_id: `8d8fabf0-8df2-4bce-bb18-6aa3edef5438`
...
- cost_estimate matched (1610.0).
- load_id: `b674c4d6-1a55-4658-a107-0ac97110c0ce`
...
- cost_estimate matched (1610.0).
- load_id: `939828a9-3ebd-40f7-a08a-2550f1ac206d`
...
- cost_estimate matched (245.0).
- load_id: `75ad2a17-63b0-4252-b46b-481949c4a0a5`
...
- load_id: `760956c2-7e02-4a3b-9842-14f552dd60e8`
...
- load_id: `2c703cc6-1729-4b2e-9b3d-3953ff12bf90`
...
- load_id: `cd2f9a13-d932-48f5-a8a6-43d009ee18d2`
...
- load_id: `d2ecd741-1bdb-49fd-af0f-d027251caa2c`
...
- load_id: `857609d8-a8e4-4dc1-983f-9dedc3e0c9a0`
...
- load_id: `78dbc400-e77d-4216-b627-37bb8f96e0f9`
...
- No graded predictions; document-only.
- load_id: `439e3980-69fe-4115-9218-8e3f411d1ecc`
