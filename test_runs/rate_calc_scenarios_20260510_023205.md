# Rate Calculator Scenarios -- 20260510_023205

**Run ID:** `27d1b0b0-9151-491a-af90-ed1103c7c2b3`
**Total scenarios:** 45
...
- load_id: `869ecc3d-7e76-499d-b5df-fc5aac71236a`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `45fca3c1-3c73-4baf-adb9-ac3b882d41bb`
...
- load_id: `3252238d-757f-4cfb-9088-d30a5976d535`
...
- load_id: `67fb218e-e6e0-4ebe-ab4d-dc5873742df2`
...
- load_id: `28ab87aa-1e51-4aea-9bfd-dfde0f117d43`
...
- load_id: `8691ccdf-415c-45b1-952f-e58af3f5576c`
...
- cost_estimate matched (1610.0).
- load_id: `ed8ed2ba-a63d-4a61-b44b-e031ce70d2ba`
...
- load_id: `8cdb63d7-2e5c-4b37-8d58-dab1eaa9b521`
...
- load_id: `cb01b1d1-53b5-4df6-a871-f15c30f62c9b`
...
- load_id: `5e233118-ad76-40dd-bdad-c5f3a8fb5565`
...
- load_id: `0713048c-7f13-4c32-a7b1-b199913756ea`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `c1c42d67-3f8e-41b9-839f-6a94b36e8e8e`
...
- load_id: `2173e557-be15-446f-8b8f-8d9705e1e8c1`
...
- load_id: `6d1005a5-aeb9-487e-abe7-514282a59df0`
...
- load_id: `e7afef75-7578-41c9-aa35-c2f96f7c6a87`
...
- cost_estimate matched (1610.0).
- load_id: `6ac0853e-ae5f-4e24-9631-f03da6a2455d`
...
- cost_estimate matched (1610.0).
- load_id: `4b86d227-75d0-4475-8fd3-31ddbd57cf11`
...
- cost_estimate matched (1610.0).
- load_id: `192f8350-c45d-452e-81f1-481705a2d853`
...
- cost_estimate matched (1610.0).
- load_id: `9856b95e-81fe-47ab-83e2-f896b30b2315`
...
- cost_estimate matched (1610.0).
- load_id: `d346aca3-b4ae-400d-9ae9-7a37030b58c0`
...
- cost_estimate matched (1610.0).
- load_id: `c28f8048-f954-4824-95f0-e4c3cbee8923`
...
- cost_estimate matched (1610.0).
- load_id: `129a69aa-29bd-4fa6-9857-0ac64e6fdd84`
...
- cost_estimate matched (1610.0).
- load_id: `d9f9d866-020a-4d0b-b5c5-959601b39e31`
...
- cost_estimate matched (1610.0).
- load_id: `0be14551-f33c-494f-aacd-0507f76bccde`
...
- cost_estimate matched (1610.0).
- load_id: `8159fd22-6dc4-4107-98b7-969fd78bfe45`
...
- cost_estimate matched (1610.0).
- load_id: `25cdf499-74e4-469a-9f4c-f4771c425613`
...
- cost_estimate matched (1610.0).
- load_id: `ed172f4e-61ef-4d4f-84eb-6fbe8ce4e8a4`
...
- cost_estimate matched (1610.0).
- load_id: `f3fcd3a3-1173-41a9-a419-17118c970644`
...
- cost_estimate matched (245.0).
- load_id: `f881997d-e46b-4394-ad20-125c665966b9`
...
- load_id: `77747802-afc7-4f65-b15d-7789824ba676`
...
- load_id: `18e9331c-aaea-44b2-9535-eeafe2d9c32b`
...
- load_id: `22b625d3-808f-4991-9fb3-3e3e71704813`
...
- load_id: `41bcdc7c-d11c-4837-8c71-3fa67a4927bb`
...
- load_id: `4c50146d-7eb1-4f45-ae9c-436e26128305`
...
- load_id: `d6746094-7225-491a-8c58-f8d7a611c1eb`
...
- No graded predictions; document-only.
- load_id: `bd3e820c-0f2c-4a39-b6ca-ef73b6ff65f4`
