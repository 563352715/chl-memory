# Rate Calculator Scenarios -- 20260509_210549

**Run ID:** `2fe0dee1-5f1c-496b-875e-cd3b4c33b4cc`
**Total scenarios:** 45
...
- load_id: `7535d446-234a-45ba-a091-89234b3982a2`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `4c40c895-068c-4797-bd89-e96e113ce196`
...
- load_id: `98c1e78c-c3fe-40a4-a727-f5cd529e57d6`
...
- load_id: `fc9dea05-8a4a-480d-9b07-8ab25af3e441`
...
- load_id: `745891cf-8a87-4373-a424-88e128c068a5`
...
- load_id: `35bcec28-4a92-456d-b769-6fd3af6cff90`
...
- cost_estimate matched (1610.0).
- load_id: `d4cb13c8-dce1-46a3-bd09-39091ad0061b`
...
- load_id: `f125058d-1ac3-4ba5-ad4a-d595d182b6e4`
...
- load_id: `17d632bb-20c6-4d96-bf67-c5cf990eb114`
...
- load_id: `90243891-2529-49f3-95e3-5b772f83201f`
...
- load_id: `8a54c22d-91e4-49bf-bf40-7ea8134bac96`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `0e0c70e1-27ed-463c-94ae-8f111adc255b`
...
- load_id: `0ec3a406-548a-4306-874e-be4f413a2a1e`
...
- load_id: `8a344ae6-c56b-4316-8bac-be2933e973b0`
...
- load_id: `8971a6f3-3eef-480e-9fab-3f94e9072a5a`
...
- cost_estimate matched (1610.0).
- load_id: `15bfa01d-39c1-45b6-b6e1-a04ae5c32969`
...
- cost_estimate matched (1610.0).
- load_id: `2f102451-5aea-40ab-9147-9cd732f110c6`
...
- cost_estimate matched (1610.0).
- load_id: `bd6a1cf6-c6f2-469b-83ee-0038136b90af`
...
- cost_estimate matched (1610.0).
- load_id: `2d4bcf33-c2db-413a-9818-ee89e58895a2`
...
- cost_estimate matched (1610.0).
- load_id: `7d57ea2c-775f-4c19-89e2-ace38e17b0cb`
...
- cost_estimate matched (1610.0).
- load_id: `c1d2c687-3730-47f4-85ec-f1d562b35cb6`
...
- cost_estimate matched (1610.0).
- load_id: `f1a86429-6ba7-4dcb-be41-99db15f6eb2b`
...
- cost_estimate matched (1610.0).
- load_id: `ddb9428f-aca3-42d3-851b-24e3f32cd0a8`
...
- cost_estimate matched (1610.0).
- load_id: `e30b9558-8665-4683-902c-c0ca0f9d1596`
...
- cost_estimate matched (1610.0).
- load_id: `f2636bfb-5344-43ff-b10f-428ff9475f11`
...
- cost_estimate matched (1610.0).
- load_id: `2a737d38-8eaf-4aa8-bdc6-181fee698eba`
...
- cost_estimate matched (1610.0).
- load_id: `58dd3538-0a4e-40e1-9f25-56facfc615bd`
...
- cost_estimate matched (1610.0).
- load_id: `a217d6b5-9dd6-4f93-86ae-84f2ae7f515d`
...
- cost_estimate matched (245.0).
- load_id: `fcda9763-1ad3-4166-96a5-63d51b6ac142`
...
- load_id: `8dd378d5-0e27-4089-ab82-21171e2722a4`
...
- No graded predictions; document-only.
- load_id: `0b313942-346f-4755-be7b-566f645696d9`
...
- load_id: `f0cf7e92-e83c-49cc-bfec-80f810b89048`
...
- load_id: `bd2909bc-1fb6-4469-acae-0eca1fc0a919`
...
- load_id: `9f14a4ca-da83-428b-b197-b2838c3454d5`
...
- load_id: `6d55b92a-07d3-4f40-8973-9bfe8a871c0a`
...
- load_id: `de44d7c0-dc41-4367-9c68-0fcb3ebf5195`
...
- No graded predictions; document-only.
- load_id: `232e2816-5903-4195-98a1-fc8667c898d8`
...
- No graded predictions; document-only.
- load_id: `40dca0d6-6f20-4145-b4d3-0c80002177c8`
