# Rate Calculator Scenarios -- 20260510_022458

**Run ID:** `b2fab65c-02fa-4af0-ac98-9cf35ac2bac2`
**Total scenarios:** 45
...
- load_id: `b457c39a-606c-4844-b1a6-b511a76f5b90`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `6374747c-c707-4852-a654-91086632c759`
...
- load_id: `e23e209c-7865-4987-9ed9-9bec86f0ee5a`
...
- load_id: `653dbd06-a5ac-43ee-8995-67d1baa9bd45`
...
- load_id: `959ae8ef-9edd-4d4b-8755-e5251fc8de7b`
...
- load_id: `5c89803e-a464-4aba-9975-0419d9043d26`
...
- cost_estimate matched (1610.0).
- load_id: `0a4652fd-5151-466e-9ecf-cb69181eeb7e`
...
- load_id: `63ece530-9fdc-4c5b-93d1-6083723b35e2`
...
- load_id: `7509bf0f-c670-44fa-9a74-9a5d0ae68a7d`
...
- load_id: `5159790c-4fbf-4d25-adb0-f214d8c5ca46`
...
- load_id: `1e22854f-ea1a-416b-93c4-141c2414a975`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `fbff5930-af70-4289-aebf-18f00e0e9f8a`
...
- load_id: `aebfc142-96c6-4bc3-9c4f-fdc392289a44`
...
- load_id: `0d0e7e92-6739-4e1c-adec-58d8c4badd60`
...
- load_id: `0d77a434-9756-408d-81a8-caa5a4c98e8a`
...
- cost_estimate matched (1610.0).
- load_id: `b5abf645-5c16-4cd6-b060-9c8b8d62f5ba`
...
- cost_estimate matched (1610.0).
- load_id: `0547fe4d-6d78-4114-bbfc-9ca06c4b3162`
...
- cost_estimate matched (1610.0).
- load_id: `0e1d3744-fccf-4902-b999-d548ceaaaa5c`
...
- cost_estimate matched (1610.0).
- load_id: `cefaa246-62f2-43f0-a419-8173ca73bbde`
...
- cost_estimate matched (1610.0).
- load_id: `8ea3519d-9a6a-4f8f-864f-091bc45bc647`
...
- cost_estimate matched (1610.0).
- load_id: `7009b32b-7d79-4718-ab7c-f0db9cf1bb7f`
...
- cost_estimate matched (1610.0).
- load_id: `5def67c6-0fd1-4cc7-ae65-0f38e4e71d78`
...
- cost_estimate matched (1610.0).
- load_id: `1d86f4a8-50ec-4ef3-87ad-26235db77ae3`
...
- cost_estimate matched (1610.0).
- load_id: `ff5701b3-3e3d-466d-a10b-58ddd86e217a`
...
- cost_estimate matched (1610.0).
- load_id: `eb9570b0-b612-4a27-9488-20755315dc88`
...
- cost_estimate matched (1610.0).
- load_id: `162e2ab4-a504-4566-ba52-f9b872b7aae3`
...
- cost_estimate matched (1610.0).
- load_id: `1e70341f-1a3a-4ffa-a3ac-60ffc98541db`
...
- cost_estimate matched (1610.0).
- load_id: `56ccef38-1ead-493b-890e-8ff3b23def8e`
...
- cost_estimate matched (245.0).
- load_id: `b65de3eb-b1f9-4bc7-ae47-4e79d5f22d45`
...
- load_id: `a0011de0-93f5-4990-ae09-1f149d74fdfd`
...
- load_id: `fe343d26-a8a5-4e99-a94f-f7cd7a68c82a`
...
- load_id: `73d59672-f520-425d-8787-d53c67621c82`
...
- load_id: `f09f3d0b-e7a8-4feb-a98c-8993aa78acc4`
...
- load_id: `094d79c8-4965-4c5f-83dc-9a72aeefff76`
...
- load_id: `6087c22b-67cb-4843-849c-e5b29cde3cc1`
...
- No graded predictions; document-only.
- load_id: `62c1dca6-95f1-4daa-985a-63e4563d1a6b`
