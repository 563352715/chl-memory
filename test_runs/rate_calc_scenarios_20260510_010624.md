# Rate Calculator Scenarios -- 20260510_010624

**Run ID:** `16de948d-0e79-41a3-9821-7541566f247b`
**Total scenarios:** 45
...
- load_id: `77b7688d-c2af-43c0-b9c8-dc237640a986`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `01e4d563-3d92-4edf-9bc7-1d7869b4cf45`
...
- load_id: `076be583-390a-49e4-bf15-828a15f180a4`
...
- load_id: `37a24a84-7fb2-49c1-b9c9-1d9064aeacb1`
...
- load_id: `ce492f4c-d393-4312-9875-ad9364b66903`
...
- load_id: `16fdc1e3-b848-40c1-b9cc-44909e664322`
...
- cost_estimate matched (1610.0).
- load_id: `cb6084f5-4b70-479d-a2e0-bf414f79dfaf`
...
- load_id: `2a3a3339-e74d-4718-a7d8-c09c85c786cb`
...
- load_id: `3f0d9ae6-f37d-4bc5-b3b0-6d24022cb0fd`
...
- load_id: `8a3cfc9d-b319-4477-b912-49feadaa6b95`
...
- load_id: `e0fa869e-d75c-4e74-9e36-02a788fa90a8`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `79154d32-03b9-4000-b3dc-d8529c3a8bca`
...
- load_id: `f3f62fb8-0701-4c9d-a526-27ef071fa139`
...
- load_id: `38e732bd-dc57-4527-b677-5eacd9549add`
...
- load_id: `11f72a5a-66e7-442d-9dd9-8b30c5da7706`
...
- cost_estimate matched (1610.0).
- load_id: `9107f9f4-c1d2-4ca4-8d53-d016e85ab76e`
...
- cost_estimate matched (1610.0).
- load_id: `7159441a-afe2-4371-b62b-f09fc9dc3605`
...
- cost_estimate matched (1610.0).
- load_id: `856b719c-5373-4f8f-986a-8c80e3d347f5`
...
- cost_estimate matched (1610.0).
- load_id: `c04390d2-4b52-48c5-90ec-5c17894b0324`
...
- cost_estimate matched (1610.0).
- load_id: `db1ca535-e272-4ae1-9acd-bd68378b5326`
...
- cost_estimate matched (1610.0).
- load_id: `62fd4bf2-fb87-484f-83ea-54cb8174f33a`
...
- cost_estimate matched (1610.0).
- load_id: `468207c5-bc7e-4b08-b8c2-213661d06a2e`
...
- cost_estimate matched (1610.0).
- load_id: `d94213de-9521-4169-98f9-75d6dcff70a2`
...
- cost_estimate matched (1610.0).
- load_id: `ef289f63-ad16-419c-8d10-716188541f6c`
...
- cost_estimate matched (1610.0).
- load_id: `4ecfcea3-17fd-4b90-b023-f5d472f6da7b`
...
- cost_estimate matched (1610.0).
- load_id: `289eaafd-2ba6-47e2-9314-25afde377b0d`
...
- cost_estimate matched (1610.0).
- load_id: `cb015111-26d1-4019-9c93-f3ced5e6a568`
...
- cost_estimate matched (1610.0).
- load_id: `bfe2b637-8418-4643-bc0c-84db82f3e8a4`
...
- cost_estimate matched (245.0).
- load_id: `14ee3fff-34f3-4ba6-aefb-502a37a45104`
...
- load_id: `d6ab3045-9fa8-4372-89d9-776088c418b1`
...
- load_id: `b212299e-1398-4f90-b8a5-0739610f71db`
...
- load_id: `324d52be-f748-49aa-b205-dc5726d423a9`
...
- load_id: `9d6e7469-a9c8-4f61-bc7a-8c6ee9aee472`
...
- load_id: `5c70976f-8546-4160-b7a0-7e5191e24f31`
...
- load_id: `b7c7ddba-049a-44a1-9694-095b94c1770a`
...
- No graded predictions; document-only.
- load_id: `efd96774-abf2-4dac-9eed-fb49357a49a6`
