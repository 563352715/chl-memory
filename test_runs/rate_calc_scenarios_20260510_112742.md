# Rate Calculator Scenarios -- 20260510_112742

**Run ID:** `b6011240-74dc-4027-b014-1f239985b043`
**Total scenarios:** 45
...
- load_id: `e4452f02-2517-414f-ade7-d1cdea8950ca`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `e01aeecb-2acd-4843-a4f7-7b19b69b1df2`
...
- load_id: `93f51b76-4b38-44a0-a1a3-399aa337ec83`
...
- load_id: `c9cfcde6-2e30-4490-83bd-c6d152bf65cf`
...
- load_id: `a549cf02-bbb8-4aae-b7be-42dc8a3a2b9f`
...
- load_id: `8f58d2bf-7414-41c9-a4ac-7761c0503f78`
...
- cost_estimate matched (1610.0).
- load_id: `43d7bfc1-4fac-498e-ad2d-56d3f37cafe6`
...
- load_id: `6b4611ce-81d4-4270-b76c-e5265c8cc5c4`
...
- load_id: `4a72e97b-f554-404a-ba0d-5f948be4c8f7`
...
- load_id: `03c5d1a3-a6cb-41b5-99f1-8f5b7775de7d`
...
- load_id: `30a34525-0198-452f-83c2-8c5b69f4d715`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `cd7b0edf-db20-4455-8a1b-8d2f76a827dd`
...
- load_id: `a9d560f3-2fcc-44a7-a95a-203de0c290aa`
...
- load_id: `d13f7945-57d2-482b-8379-42af5bca1aeb`
...
- load_id: `8d748f54-d7ec-4ec3-b2ac-b241aa24c233`
...
- cost_estimate matched (1610.0).
- load_id: `a2e75465-9a80-4437-b9b2-8c3499145d4e`
...
- cost_estimate matched (1610.0).
- load_id: `2da3ea3f-d396-483c-8261-ebf0fb9aae76`
...
- cost_estimate matched (1610.0).
- load_id: `be932de2-84c2-407c-b29d-e24a2d38905f`
...
- cost_estimate matched (1610.0).
- load_id: `cae8bdb8-1520-4dfd-9db0-83337ce63c84`
...
- cost_estimate matched (1610.0).
- load_id: `73cfcd1e-4cb9-42f2-b8f8-14f703d5c683`
...
- cost_estimate matched (1610.0).
- load_id: `8348940c-da31-4612-b936-7009dbe0b60a`
...
- cost_estimate matched (1610.0).
- load_id: `a23f5947-dbd1-4e86-b1cd-7054365bca43`
...
- cost_estimate matched (1610.0).
- load_id: `50e5a419-d881-4f1a-ba4d-73ef9e90d61e`
...
- cost_estimate matched (1610.0).
- load_id: `5900e2e2-e8dd-4471-a211-2a35fe13f6bc`
...
- cost_estimate matched (1610.0).
- load_id: `0eac6416-3eb1-41a4-b07a-bb787282d6fa`
...
- cost_estimate matched (1610.0).
- load_id: `e844f2a3-0b4b-421f-8245-7e754dbcc156`
...
- cost_estimate matched (1610.0).
- load_id: `5279c606-48b7-46ba-9179-90c699811803`
...
- cost_estimate matched (1610.0).
- load_id: `e4a87aee-5f54-40dc-b2dc-41361baa52fb`
...
- cost_estimate matched (245.0).
- load_id: `1fd55dc3-a90f-4620-ab35-8608d26e3cf6`
...
- load_id: `0a2deb8a-7790-4cfa-9267-ae243e15d42d`
...
- load_id: `940de91e-1e18-4990-bf58-d7802bed7e25`
...
- load_id: `e2efc67a-8111-41be-aed7-e76edb011f56`
...
- load_id: `350e8063-5f7a-4366-9e34-c64b6c286dfb`
...
- load_id: `8a414908-b17c-4eb7-8023-c93a875aaa33`
...
- load_id: `cfc41133-2b46-4cd2-b91d-8fdab27c97a2`
...
- No graded predictions; document-only.
- load_id: `27b6a60d-2c6a-4c26-a06c-dc3b2bdccf6c`
