# Rate Calculator Scenarios -- 20260509_222547

**Run ID:** `4a8a2f50-4c8a-4b8b-b58f-fad7dc5e28ae`
**Total scenarios:** 45
...
- load_id: `20326faf-f31e-4edf-9e31-d7508bf96d9a`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `759afc2e-0e04-4913-861c-e5ecaf22be36`
...
- load_id: `18a6aade-37a2-467e-93dd-c7e05b283382`
...
- load_id: `be8e3e35-7e6c-4158-b25f-c99207cd4d41`
...
- load_id: `23cd51af-8cb1-4b6c-ab5d-57dea2c1c9d3`
...
- load_id: `9617da77-6d46-4a02-84fc-12a722c3ac7e`
...
- cost_estimate matched (1610.0).
- load_id: `35a7c996-fa5a-4fed-a2e6-a41803c7f375`
...
- load_id: `2829e811-e7e3-46a9-af47-d241dcf4e549`
...
- load_id: `68aaa956-1fd3-4dc6-b5b0-c735f62e43ff`
...
- load_id: `464c4ade-8299-4528-91de-f7a272e3a5d5`
...
- load_id: `1428eb6b-e1a4-4084-b9a5-310caa4163c1`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `fe98b27d-55e5-4789-9d41-4765cf99f6ad`
...
- load_id: `e2504ce6-6947-42b6-bc47-e65114d3f670`
...
- load_id: `d83bf003-3a54-4419-b1cc-8aa602146748`
...
- load_id: `3857b9a4-2e9d-4b6b-bb1e-f752321cba5f`
...
- cost_estimate matched (1610.0).
- load_id: `7494d61c-e900-421c-9ca1-2ce51590f1cc`
...
- cost_estimate matched (1610.0).
- load_id: `1790dcf2-bfc8-40a2-84cf-7a7cd7bbf74d`
...
- cost_estimate matched (1610.0).
- load_id: `479fb39c-0aaa-4db9-a57d-8c19ee055e85`
...
- cost_estimate matched (1610.0).
- load_id: `31ecf4f8-7b7c-4848-b1a1-47e2e0ef13aa`
...
- cost_estimate matched (1610.0).
- load_id: `f92c5ddc-38ff-4d10-a0d6-8097681f3980`
...
- cost_estimate matched (1610.0).
- load_id: `ef890103-b3fa-47c3-9b1b-eb5d7bd97f21`
...
- cost_estimate matched (1610.0).
- load_id: `84e0bfe8-be23-4b3f-b39d-4ad8f6186830`
...
- cost_estimate matched (1610.0).
- load_id: `ac65034a-bbae-412e-b33b-646789667691`
...
- cost_estimate matched (1610.0).
- load_id: `25711bc0-5e9b-44f2-b4e3-bed0628fd7d3`
...
- cost_estimate matched (1610.0).
- load_id: `ff4bcd87-07bc-43d9-868f-6f9131a44ea3`
...
- cost_estimate matched (1610.0).
- load_id: `8414e442-0658-417e-8ec1-40c604dcdbde`
...
- cost_estimate matched (1610.0).
- load_id: `2bff64c2-fbeb-4ac5-9d42-27957baa04d9`
...
- cost_estimate matched (1610.0).
- load_id: `81480015-647e-4d5f-bd5c-30a60e925d32`
...
- cost_estimate matched (245.0).
- load_id: `76557528-1076-44d8-8338-6e6e8791d955`
...
- load_id: `bdcca6ee-2555-49b0-ba5d-ab4c1832df00`
...
- No graded predictions; document-only.
- load_id: `ef09d5f5-61ef-4b0c-9095-bab0b7561bf1`
...
- load_id: `8782e884-b463-4605-b693-f7a5fb6092d4`
...
- load_id: `da0113d1-c8ba-47f3-a05c-c651f41f83f9`
...
- load_id: `cfb0a12d-5b6b-4b32-8e21-ec23e09fafa5`
...
- load_id: `5fe2876b-e9b3-4998-936b-d6522a440645`
...
- load_id: `b664306a-5739-4087-a6bc-1ebd0ac35c8a`
...
- No graded predictions; document-only.
- load_id: `3400523d-6581-4203-80a9-e3854e77835f`
...
- No graded predictions; document-only.
- load_id: `e49150c6-e782-49ec-b11a-180568ba6ef4`
