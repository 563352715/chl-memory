# Rate Calculator Scenarios -- 20260510_043805

**Run ID:** `0c252623-e665-4cdb-bf0c-cda4e21161b3`
**Total scenarios:** 45
...
- load_id: `9d6d30f7-fa80-4a29-bc29-3f9c0c80cb76`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `ae17fe4f-4d71-4f6f-b743-b1af382099ff`
...
- load_id: `7a2a2490-aa7e-41d4-9e1e-c8b39c533864`
...
- load_id: `bcdf8e2e-2721-4c50-aad7-f556c1168607`
...
- load_id: `fec0c169-e413-4aea-933e-5311ad2b9d1d`
...
- load_id: `2f154e81-b360-4405-9dfb-220376b0073e`
...
- cost_estimate matched (1610.0).
- load_id: `2b3674ea-1084-4cda-bb0b-af6f10c8cc47`
...
- load_id: `ecc3e717-ea67-49cd-b6cc-d69de725db17`
...
- load_id: `5c31a4d7-3c17-4eaf-ae29-c3463591b8a4`
...
- load_id: `899c5feb-22a9-4955-a102-9f562f698a85`
...
- load_id: `051eae60-306c-4a3e-9a44-63a17fddf882`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `9170aa57-76d1-4c75-a522-5aa7a212fd1f`
...
- load_id: `8264d8f7-6f8a-498e-9ed1-6b93597d871a`
...
- load_id: `26df2fa4-7e00-419d-a045-38edeb5e831a`
...
- load_id: `247d4a8e-48ac-4340-a258-364808d4f3e4`
...
- cost_estimate matched (1610.0).
- load_id: `4c899ca4-6fbc-4156-82dc-3f0c0faee34e`
...
- cost_estimate matched (1610.0).
- load_id: `f3c8319e-b408-4d2e-aebd-f732da3c3db1`
...
- cost_estimate matched (1610.0).
- load_id: `defaf9c5-bf1b-4c1a-8b3e-f86bd9e6ea56`
...
- cost_estimate matched (1610.0).
- load_id: `187b8eac-3efb-4cc3-a5d1-79b23685342a`
...
- cost_estimate matched (1610.0).
- load_id: `2040cb32-93fb-441a-801a-b71458a6e9e5`
...
- cost_estimate matched (1610.0).
- load_id: `3d38cb3a-8103-4b59-aeb5-26b3d2ff96ff`
...
- cost_estimate matched (1610.0).
- load_id: `db503f92-2d3b-42c1-844d-80c830ebb396`
...
- cost_estimate matched (1610.0).
- load_id: `10398468-88b6-4d14-a051-45bd3e765fde`
...
- cost_estimate matched (1610.0).
- load_id: `cc09da50-6d12-4fde-86e2-bfbb09c4384d`
...
- cost_estimate matched (1610.0).
- load_id: `3fa10e9c-e3b4-41d9-ba9b-df59edd33011`
...
- cost_estimate matched (1610.0).
- load_id: `29960606-c067-4bb2-a1c9-acdf15ed2247`
...
- cost_estimate matched (1610.0).
- load_id: `38fc356d-fee5-4b02-9cc7-219a51c339f6`
...
- cost_estimate matched (1610.0).
- load_id: `6a440985-9c7c-4dc9-a8df-01c035dd27ba`
...
- cost_estimate matched (245.0).
- load_id: `0f7582f7-9b39-4847-b4b0-1629b370f79f`
...
- load_id: `64191c31-7552-479b-bdac-2b05a251d5f9`
...
- load_id: `f36927a6-6705-4115-baa2-d00754c4254e`
...
- load_id: `dd5e285d-24e1-4411-bcce-804868ff7a1a`
...
- load_id: `a072a544-af4f-4f90-bcfe-7089b144a205`
...
- load_id: `7ba0dc2e-9950-4700-bc94-1c1a8e0f971f`
...
- load_id: `8de649be-86b9-48cf-8e25-dd840341e894`
...
- No graded predictions; document-only.
- load_id: `ccafbe1e-bf87-4ed1-ae5d-c40e939f5f0b`
