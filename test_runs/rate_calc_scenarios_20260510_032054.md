# Rate Calculator Scenarios -- 20260510_032054

**Run ID:** `2d78198b-9cf6-4157-8f27-49059f20bae1`
**Total scenarios:** 45
...
- load_id: `e5eb9243-1072-479f-95af-fb80e9da33d3`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `a6e21356-7b34-464f-a939-a28505b1f2cf`
...
- load_id: `ae3306c5-acd9-4573-a26f-2cfb26d504ee`
...
- load_id: `b4910390-64e5-4a0e-a059-e27e7581458f`
...
- load_id: `8846c433-3244-4bcc-b5f0-a049ba679d8d`
...
- load_id: `c31694b6-62ab-4d70-8c86-ceb158d16671`
...
- cost_estimate matched (1610.0).
- load_id: `9394df3b-31b2-4d6e-b041-015ff26a740e`
...
- load_id: `5b19e197-8d3f-4f46-9127-77ef75186083`
...
- load_id: `bbf2a989-b023-4038-ac8a-cb7e25031c5a`
...
- load_id: `05632e83-799c-424f-bf56-8453732c56a6`
...
- load_id: `d635ded1-d00e-42b4-b4f2-40815bc399e5`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `0bd7ddb1-d7b0-42ab-83b6-7791a0053db5`
...
- load_id: `43eee6e6-7da7-4d08-b438-3bd479f9416a`
...
- load_id: `dce6a2cc-7d8f-4ad5-8b64-a462730f22be`
...
- load_id: `8868f1bb-1569-44f3-bee3-541d2ad3f72c`
...
- cost_estimate matched (1610.0).
- load_id: `197e68a3-cd9f-4160-9cf7-8d1c42823e51`
...
- cost_estimate matched (1610.0).
- load_id: `73e3436b-684d-438e-9895-ab0c640f1af0`
...
- cost_estimate matched (1610.0).
- load_id: `d79d86cf-5703-4a61-b155-2bc72fe5d816`
...
- cost_estimate matched (1610.0).
- load_id: `87b79eb8-3799-4655-98a9-e3e94a9d8c6d`
...
- cost_estimate matched (1610.0).
- load_id: `e91b0f3e-fc94-4084-95dc-e0c4d0bd7d0f`
...
- cost_estimate matched (1610.0).
- load_id: `ec0cfd4d-c03c-4492-916f-56cdc8cabbd6`
...
- cost_estimate matched (1610.0).
- load_id: `ab507d15-7954-4f3d-9b60-ddf8e51a511a`
...
- cost_estimate matched (1610.0).
- load_id: `ed45fa48-e949-4949-87f7-ddddfac671ec`
...
- cost_estimate matched (1610.0).
- load_id: `f27808bb-0c74-41d2-835d-c99151b55fda`
...
- cost_estimate matched (1610.0).
- load_id: `3991f1bc-4dfc-4246-887a-0c43a5226785`
...
- cost_estimate matched (1610.0).
- load_id: `96ca3d96-71f5-4369-ad82-45cb97c35d13`
...
- cost_estimate matched (1610.0).
- load_id: `3b31e477-08fb-47bd-984d-e973312529b5`
...
- cost_estimate matched (1610.0).
- load_id: `c00fc19f-d6ee-45e6-8d2d-c735bc725e05`
...
- cost_estimate matched (245.0).
- load_id: `145ebf95-e864-4f3b-b43b-754a6a831188`
...
- load_id: `814b2609-e650-449b-a837-5355d648ad7b`
...
- load_id: `a8826c2f-5fc2-45de-bfb1-8580b45dc798`
...
- load_id: `4c8f25e8-e6ad-4bcc-a2d8-f745ed918c18`
...
- load_id: `236c8b03-dd97-4363-931c-66375394212a`
...
- load_id: `b5f0ef25-d9c6-43b3-afd5-ceb4b4a2bb2b`
...
- load_id: `f010c772-8567-42ac-b96c-e5499d86875a`
...
- No graded predictions; document-only.
- load_id: `8ca95ee1-07a6-46f7-a80d-595dbe98b35e`
