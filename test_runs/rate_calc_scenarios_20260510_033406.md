# Rate Calculator Scenarios -- 20260510_033406

**Run ID:** `2987d300-0288-4303-8dee-4f98e086185e`
**Total scenarios:** 45
...
- load_id: `7922709d-f625-4fa6-beee-519d1424fb5b`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `07f57c8b-6aae-429c-a5b9-a4d9471c1897`
...
- load_id: `5c0d1aa6-a7b1-490a-80d2-2844ba5883c2`
...
- load_id: `834ceded-0d28-4f0f-b797-bce14fd5a6ac`
...
- load_id: `b3e1ee12-ad67-4eae-b3ab-28e8293e3c7f`
...
- load_id: `9d3917d2-4afe-4efa-8dd3-66df42704930`
...
- cost_estimate matched (1610.0).
- load_id: `14967578-e2d8-4ec8-8525-2363c2f7326f`
...
- load_id: `e35d2a75-a9d8-4c90-9cc1-aa9d2a331260`
...
- load_id: `20488341-cae4-4413-b0f2-5768d3a7e78c`
...
- load_id: `f68637fe-7a62-4395-b859-b85ba797cd6c`
...
- load_id: `d7e0e055-01b1-4fb2-b275-8b6e62ffc463`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `de249519-39a3-47cf-8a04-d683d21fc2b5`
...
- load_id: `6028c19c-35e5-4f5b-b068-1c821dd6a35e`
...
- load_id: `ccdfcb14-f90e-4a53-a558-3e32194c0837`
...
- load_id: `504b52f8-38bf-41ac-ac79-627eb6fd79ab`
...
- cost_estimate matched (1610.0).
- load_id: `97ad9499-6035-4f6e-b0a1-017c17d8bc6a`
...
- cost_estimate matched (1610.0).
- load_id: `87258b7b-ca2c-4bba-b1f1-28db2494b9b8`
...
- cost_estimate matched (1610.0).
- load_id: `71136abb-285e-4506-8c8b-08919eae87ed`
...
- cost_estimate matched (1610.0).
- load_id: `9463eecc-95f0-40bd-b2fd-cc5dc7ff47e8`
...
- cost_estimate matched (1610.0).
- load_id: `a56b74ca-a825-4be4-81cc-7b5574b9c83c`
...
- cost_estimate matched (1610.0).
- load_id: `2a76d446-8b04-4b63-87f8-212d305f091d`
...
- cost_estimate matched (1610.0).
- load_id: `7e1e4441-3434-4436-9f2d-5703a7f10bf8`
...
- cost_estimate matched (1610.0).
- load_id: `b9ad2ddc-b008-4f0e-a052-a543ee9fa99d`
...
- cost_estimate matched (1610.0).
- load_id: `95634e31-31f8-4980-9b1c-77765181f608`
...
- cost_estimate matched (1610.0).
- load_id: `5f00449f-4d75-4159-9019-519564343dc9`
...
- cost_estimate matched (1610.0).
- load_id: `c6ad11a4-c812-432f-a3fe-16c0c4b646dd`
...
- cost_estimate matched (1610.0).
- load_id: `47271d2d-d4d2-42d4-a100-3b02fb325cce`
...
- cost_estimate matched (1610.0).
- load_id: `d896398f-1b0d-441a-b272-b762f0fee1ce`
...
- cost_estimate matched (245.0).
- load_id: `dcdbd75a-6b87-4812-a8e7-b6e79ce30ca2`
...
- load_id: `b0bd42be-86bc-4709-9caa-4bc97985a8ae`
...
- load_id: `45a8a913-7ceb-45d0-b48a-54c5272eec82`
...
- load_id: `48dba8ea-f348-420d-ae5b-53749fdee832`
...
- load_id: `587928eb-2c3b-4577-a887-98ed5520ba59`
...
- load_id: `d4929b07-1bf5-4240-ad68-0eec58cadc27`
...
- load_id: `9a26dde6-580c-4af1-aa82-ecd0f1a1a17b`
...
- No graded predictions; document-only.
- load_id: `fe81c8a6-e32c-4c4f-af46-cf727aee8576`
