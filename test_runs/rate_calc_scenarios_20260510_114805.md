# Rate Calculator Scenarios -- 20260510_114805

**Run ID:** `55fd3c56-660b-41bd-a77c-75bb0217816f`
**Total scenarios:** 45
...
- load_id: `4800412d-4f56-4800-a0a3-8b1d08e9ca7a`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `dddbd06f-bfc9-414a-b376-a1fad894a60e`
...
- load_id: `4371f1c4-a9b7-4307-bae2-eee6e3d290db`
...
- load_id: `a2292169-c6d2-47af-a5fd-bad2c1fbe3fb`
...
- load_id: `990d6b14-35a0-4895-8769-03e2ac78c2dc`
...
- load_id: `e1424473-5029-4a42-af7c-7857e75e9373`
...
- cost_estimate matched (1610.0).
- load_id: `066262e0-23e6-4c2a-93f7-477b3811930f`
...
- load_id: `ef109e76-8267-4761-8738-1c60c5a77810`
...
- load_id: `26a24043-6a25-48f4-8de2-9d1b830b8aaf`
...
- load_id: `3d4a7c0a-3a84-4c60-ae25-326e12cdfa5b`
...
- load_id: `47826a94-00f3-4644-91eb-f0cd0a773ada`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `37132cfc-a4e7-47da-b098-e7ef25890164`
...
- load_id: `9605e51a-0557-45dc-b7b5-3c3f26890f7d`
...
- load_id: `1d105349-c23d-45d8-b516-072e2f95587b`
...
- load_id: `458a39fe-64f2-4d6b-a87d-c5182273f2dc`
...
- cost_estimate matched (1610.0).
- load_id: `2da6b8f1-83ff-4b65-92b2-db980ab272fb`
...
- cost_estimate matched (1610.0).
- load_id: `06da5a5c-2d37-4602-b46e-cecc771e83df`
...
- cost_estimate matched (1610.0).
- load_id: `bb6399ac-5007-4acb-b0c1-e0355c76f077`
...
- cost_estimate matched (1610.0).
- load_id: `0cfffbe2-78fc-4109-b23d-f84f358405a6`
...
- cost_estimate matched (1610.0).
- load_id: `e7ea3995-d74b-4cec-96cd-8561d0d7e5d7`
...
- cost_estimate matched (1610.0).
- load_id: `9c6238f3-1ac7-4002-9019-7a99ab64e54a`
...
- cost_estimate matched (1610.0).
- load_id: `c421f40a-507b-4fa6-ab88-8f2f9b74a979`
...
- cost_estimate matched (1610.0).
- load_id: `9f417834-de5c-4370-b859-8d1822e77724`
...
- cost_estimate matched (1610.0).
- load_id: `05180092-9345-4134-9897-0a80ab6de8df`
...
- cost_estimate matched (1610.0).
- load_id: `b5207abc-2dad-483c-818f-89b8f73cc145`
...
- cost_estimate matched (1610.0).
- load_id: `2b495a8c-3f35-4c34-a5e6-5c4e90b35204`
...
- cost_estimate matched (1610.0).
- load_id: `89fc11c2-e2fe-4537-822d-3bde3285a498`
...
- cost_estimate matched (1610.0).
- load_id: `d710e3ba-b565-41f9-a14b-20619b6cf72a`
...
- cost_estimate matched (245.0).
- load_id: `7b65daee-3148-49ad-af5e-d6aba4cf5544`
...
- load_id: `91444446-df2c-47e3-be70-adddf4615ef4`
...
- load_id: `f65d4e23-eec1-44f5-9819-6140f99139a3`
...
- load_id: `0f144851-7865-4b22-a94d-9ccb70d71606`
...
- load_id: `142e4b50-6fdd-46d6-878e-91a25e6406e4`
...
- load_id: `1c7bee43-2308-46d1-a1fe-0cdc100b0b2d`
...
- load_id: `fb6fa0e3-097a-4f00-92fc-c84bde42f702`
...
- No graded predictions; document-only.
- load_id: `ed4005e6-3d15-453a-bc1a-fb1e2c26c98b`
