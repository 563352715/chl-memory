# Rate Calculator Scenarios -- 20260510_034012

**Run ID:** `310f1d71-8425-461e-8084-dcc74af18ff6`
**Total scenarios:** 45
...
- load_id: `eb933258-f071-4c20-b33e-46857ccc0edf`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `a9674605-051f-4045-8f5c-4b20dc054a3a`
...
- load_id: `096d96c0-3e60-47da-850c-d182f37e698f`
...
- load_id: `e92e5f17-c450-409b-8025-8f26987f0aa7`
...
- load_id: `5e525c31-ff31-43f9-a573-1969e3299d8c`
...
- load_id: `a41c4bbd-3fd7-472d-9a00-f7a3fc41fbef`
...
- cost_estimate matched (1610.0).
- load_id: `a2ab42a9-9e31-49f7-bc05-fc6ca97967c1`
...
- load_id: `e47a2375-65c5-45d7-a21c-cba11b22629c`
...
- load_id: `348bf96b-18ea-435b-b925-264831260ac8`
...
- load_id: `5981220c-b44e-4c70-b1af-2f71784522ae`
...
- load_id: `62a6bdd7-5e9a-4fd3-9f0c-e9d2915c3d0a`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `cb0170a9-a790-496f-bf59-ff3ed302d7e3`
...
- load_id: `838aef60-cf11-44d6-afcc-c9452fb07bc6`
...
- load_id: `f642b519-bc47-455c-b40e-e2f09d50744e`
...
- load_id: `28683921-32a6-417d-af82-dae96a70a2cd`
...
- cost_estimate matched (1610.0).
- load_id: `5bba5222-7ade-41f8-a58f-aff640a88c17`
...
- cost_estimate matched (1610.0).
- load_id: `d827156e-cf19-4e1c-b877-84990b321e0b`
...
- cost_estimate matched (1610.0).
- load_id: `5d362341-4a7f-4802-bcf7-61b7070e15e0`
...
- cost_estimate matched (1610.0).
- load_id: `4f5f5892-78a9-46d9-a308-11544154049c`
...
- cost_estimate matched (1610.0).
- load_id: `aa43c592-fdbd-4d04-a695-b140caacd178`
...
- cost_estimate matched (1610.0).
- load_id: `8aa4f3cd-d760-455f-b3d7-8fb2fa7d1c37`
...
- cost_estimate matched (1610.0).
- load_id: `0b6ab54c-2184-4679-94d6-8fa3e786982b`
...
- cost_estimate matched (1610.0).
- load_id: `25c34435-87b4-4484-84a1-aba57088c1be`
...
- cost_estimate matched (1610.0).
- load_id: `1545fd82-d3dd-45e5-bd02-6dd2a550aa3a`
...
- cost_estimate matched (1610.0).
- load_id: `8bdffe0c-c7d3-4cfb-916b-22ecc7c9d852`
...
- cost_estimate matched (1610.0).
- load_id: `9ad0f885-a391-4618-8990-5b1836b02a95`
...
- cost_estimate matched (1610.0).
- load_id: `5d50ebd6-c35d-409f-bcb6-bafc6f1b5098`
...
- cost_estimate matched (1610.0).
- load_id: `cd64a70a-179b-46fd-9607-28846a3037e0`
...
- cost_estimate matched (245.0).
- load_id: `ac71404d-3455-4c18-af61-c079e3753ad1`
...
- load_id: `6e14011e-d023-49a9-ac77-fc8fb399e8f6`
...
- load_id: `7774b679-96d1-496c-808d-594f2d31668d`
...
- load_id: `4a865d60-1014-49fd-b0bd-f39120c55fc5`
...
- load_id: `2e6f40d3-542d-41f3-b0a2-687a0d83b1ca`
...
- load_id: `8485f6c6-62ed-442a-904a-2b30ff29c0d2`
...
- load_id: `442086b4-8cbc-4276-986f-b802a8bc588a`
...
- No graded predictions; document-only.
- load_id: `c6af2375-7c7a-4212-b96a-bff1be00bd92`
