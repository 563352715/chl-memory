# Rate Calculator Scenarios -- 20260510_025026

**Run ID:** `358154ec-8224-4ea1-8bf4-d9dbf081ef30`
**Total scenarios:** 45
...
- load_id: `288e81f7-2388-4ca3-9cc8-8c41a4575b78`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `1f283712-f9fc-49c8-84f5-9ecbd1b1c436`
...
- load_id: `6d6b50e4-06c3-41fd-9e58-05cc8a9f945d`
...
- load_id: `999738a0-2e3e-4fc2-a77a-9c01036da7eb`
...
- load_id: `cad811a5-9b6e-48be-848c-fab7cf9afb96`
...
- load_id: `82c2d442-3aa3-45af-9059-30fee834d405`
...
- cost_estimate matched (1610.0).
- load_id: `c0a0bd77-d3b2-475e-b1bc-769eea4eac71`
...
- load_id: `be042f4b-7196-4979-9e4b-859be14b10e5`
...
- load_id: `368e18fa-a66a-4d6a-baf1-dfa5c1d96e58`
...
- load_id: `74ec5db5-34da-473f-a4c2-d726eb3d9189`
...
- load_id: `7f690bc0-7b7d-4051-a7f2-1385584a8e72`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `771cd01b-c265-4d83-88d1-282e513ff656`
...
- load_id: `1c75a57a-924e-4f1a-9d5c-7439891b539a`
...
- load_id: `13645900-8483-4dbe-af7b-910cf1d65fab`
...
- load_id: `b131dc55-2695-4910-89c3-38d3d41c7411`
...
- cost_estimate matched (1610.0).
- load_id: `a818f1a3-3cc9-47fe-bf35-84300737792f`
...
- cost_estimate matched (1610.0).
- load_id: `b3af71c6-6fc7-435d-a239-775623901078`
...
- cost_estimate matched (1610.0).
- load_id: `0baa115c-dc82-4249-b396-d12be93fdc11`
...
- cost_estimate matched (1610.0).
- load_id: `1866930a-f173-447b-b0ca-b0dd58ef770f`
...
- cost_estimate matched (1610.0).
- load_id: `64280cf4-8f68-45af-b9e9-2642413dea0d`
...
- cost_estimate matched (1610.0).
- load_id: `9e750243-7aa8-4d0a-92b8-cfe5f1eefb1a`
...
- cost_estimate matched (1610.0).
- load_id: `4d464945-3ce9-4d5d-903f-f9b65fd042bd`
...
- cost_estimate matched (1610.0).
- load_id: `34a4a12a-2fcf-4636-99c5-11aed59c5e27`
...
- cost_estimate matched (1610.0).
- load_id: `6d9b1f09-21fd-4142-a97a-1fd6c690ea41`
...
- cost_estimate matched (1610.0).
- load_id: `071e6f29-1e8a-42ca-b50b-b9aa0584a342`
...
- cost_estimate matched (1610.0).
- load_id: `d3b77238-8de5-4e03-aa98-4c6b8254b369`
...
- cost_estimate matched (1610.0).
- load_id: `2bb2234a-19b0-4f44-b44c-6513023179c4`
...
- cost_estimate matched (1610.0).
- load_id: `735b2440-a329-434b-816f-f6ac60cb52b2`
...
- cost_estimate matched (245.0).
- load_id: `4994568c-67f6-4722-9cdb-239cc1d2058c`
...
- load_id: `5e776a8d-9978-4a93-b996-0b3163d2be3a`
...
- load_id: `ba9bd3b5-3496-4287-abbe-2ccf87750ef9`
...
- load_id: `12284713-30fc-4d55-ac58-d7a75d936ca2`
...
- load_id: `06263155-73e3-4e3e-bf84-c679cca214e8`
...
- load_id: `b50dd626-853d-44bd-842a-017265f6ce62`
...
- load_id: `ab5a694b-561e-4f81-8ba9-9377ec097779`
...
- No graded predictions; document-only.
- load_id: `85738088-928b-418c-a928-2a7777e2ae07`
