# Rate Calculator Scenarios -- 20260510_040333

**Run ID:** `31e0dd09-e1c8-4efd-95b9-3c254835aaf3`
**Total scenarios:** 45
...
- load_id: `0f4b7183-472b-43dd-8400-a3206a1820be`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `7efd94fe-bf39-47f8-983f-ae99ea60983d`
...
- load_id: `a0fe326f-6955-417a-a762-8cec2c7d5852`
...
- load_id: `00448751-48bd-4b1f-ae21-0bc618694aff`
...
- load_id: `65ea86b4-45bd-45e3-8c1c-fd5aeebca584`
...
- load_id: `fade67da-3368-4522-9c9a-631c77b37d5c`
...
- cost_estimate matched (1610.0).
- load_id: `58bf27c4-b77b-4e68-9023-76d56b21a0a0`
...
- load_id: `7c0fb6ff-7e74-4b99-89d7-1ef52662a773`
...
- load_id: `7e29128f-f05c-43b1-bc10-27fd1cd997ea`
...
- load_id: `4e5ce9a4-b250-4cac-9496-9044c65c8942`
...
- load_id: `257a358f-7bfa-493f-8246-bb8498c018a9`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `8c9ce186-cfd3-4833-987e-dcb8ee43f3de`
...
- load_id: `4918697b-083b-49e0-8a45-14f4ec5925b0`
...
- load_id: `2d34248b-3e1f-448d-a1b2-fb3d7a9f3335`
...
- load_id: `ea95acfd-f535-4c14-a68c-b5171772afa4`
...
- cost_estimate matched (1610.0).
- load_id: `266fc4d1-ff65-4c76-aaec-6d9135c2d79d`
...
- cost_estimate matched (1610.0).
- load_id: `aefb50d2-53f3-4652-8ac7-9df1c7928de1`
...
- cost_estimate matched (1610.0).
- load_id: `34d5836f-e1e1-494d-98ad-2377b727e9f5`
...
- cost_estimate matched (1610.0).
- load_id: `715a818d-28bd-4305-b52a-653018cd2532`
...
- cost_estimate matched (1610.0).
- load_id: `fd611afb-62a4-460c-a73a-362ba887f827`
...
- cost_estimate matched (1610.0).
- load_id: `caefbbe4-5ce6-4894-a2a1-ebd16dd6d5d4`
...
- cost_estimate matched (1610.0).
- load_id: `f394094b-f14b-463c-97f2-874102f49fa6`
...
- cost_estimate matched (1610.0).
- load_id: `2b2126a0-53ed-4344-a99d-4f2192e89c61`
...
- cost_estimate matched (1610.0).
- load_id: `171a50b0-0f3e-4788-8610-46ee1cfe44d9`
...
- cost_estimate matched (1610.0).
- load_id: `f19ab2d8-1d11-484b-b5d3-827baf98f2e7`
...
- cost_estimate matched (1610.0).
- load_id: `69283724-e287-4622-9e88-4a3ef15b2bbe`
...
- cost_estimate matched (1610.0).
- load_id: `9d3df377-c5e0-42a6-b7e4-8947ff5382e2`
...
- cost_estimate matched (1610.0).
- load_id: `0cca805b-dca6-4dde-b712-80092a47cb94`
...
- cost_estimate matched (245.0).
- load_id: `f191a262-7b65-46a3-93e0-96f4e8f90b1a`
...
- load_id: `90f9c475-b52b-409c-9e99-2788b50fbb6a`
...
- load_id: `3268961d-4cac-4cd8-994a-c2d8c647f2df`
...
- load_id: `c1bb3f09-79ed-4e9d-9d10-7cbf72e87ebb`
...
- load_id: `d17d404b-364d-465a-bd0e-279a6b67c7b4`
...
- load_id: `6c2e4a70-2bce-42af-b9ec-56f45caa84a1`
...
- load_id: `8357be4e-1e96-42c8-bc3a-f2f1a300e632`
...
- No graded predictions; document-only.
- load_id: `8abe2dd3-753c-42a1-a120-4bbd9fb89323`
