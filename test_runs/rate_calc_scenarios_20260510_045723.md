# Rate Calculator Scenarios -- 20260510_045723

**Run ID:** `f43819ba-47cc-4bf6-adbf-9799ce13e315`
**Total scenarios:** 45
...
- load_id: `9671c408-f5b4-4a97-b389-2f8f07ad72d9`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `a737a4fc-678c-407a-9f24-346c7b01f9d3`
...
- load_id: `025300e8-f24c-4c91-93a2-e91de826a396`
...
- load_id: `a88d120d-2d34-41f1-8744-91a223cfc2f2`
...
- load_id: `657032f7-73fd-477c-add8-07a71af84880`
...
- load_id: `880f03f1-ef3f-4b63-b528-62ad76dadfde`
...
- cost_estimate matched (1610.0).
- load_id: `5a29f1df-d742-42c8-8510-eb690e8335e4`
...
- load_id: `376d13c1-4fca-42c0-a850-e25d1c03db99`
...
- load_id: `0448af8f-cd9c-4f75-9a83-3f692499aa00`
...
- load_id: `ba0e722b-42cb-4061-b09b-b5261d3297ed`
...
- load_id: `01c6b5cb-7f6c-483a-be77-cf3d8ac9c17a`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `fac44012-abcb-4448-8bf2-17bdf8a11960`
...
- load_id: `935584e4-7a0c-45ac-842b-7fdcfb6a7bac`
...
- load_id: `5f3d86d5-533a-4036-9fcc-63dd982ff470`
...
- load_id: `74bba8d4-3e83-49df-87df-4770a5ca737e`
...
- cost_estimate matched (1610.0).
- load_id: `f5fad4c0-0327-4b2a-87ef-2498ab1d90be`
...
- cost_estimate matched (1610.0).
- load_id: `864f0a59-5d63-4d0a-9928-68805fefd398`
...
- cost_estimate matched (1610.0).
- load_id: `38131553-23b8-4692-bec9-4d2d175ef273`
...
- cost_estimate matched (1610.0).
- load_id: `bc6c0184-975e-4e37-84c7-80d69c7746b1`
...
- cost_estimate matched (1610.0).
- load_id: `c7b62474-4fef-40a4-9707-c7644961b75c`
...
- cost_estimate matched (1610.0).
- load_id: `bbc87170-b8b4-4698-bd79-4e46536b5737`
...
- cost_estimate matched (1610.0).
- load_id: `7ddbdbc7-4018-4ab9-b4cc-8b8c5be3d36f`
...
- cost_estimate matched (1610.0).
- load_id: `97bb1f00-f6e8-4e86-b4a9-6115973dd0d6`
...
- cost_estimate matched (1610.0).
- load_id: `20477a02-c7c2-4b5c-a00e-fb5b9336e531`
...
- cost_estimate matched (1610.0).
- load_id: `81ae1829-4062-4875-9537-9e868ffe51cc`
...
- cost_estimate matched (1610.0).
- load_id: `78661471-5bdb-4b55-9a5b-df9b833b1392`
...
- cost_estimate matched (1610.0).
- load_id: `dda6a9ca-719c-49a5-b2cc-551b924270da`
...
- cost_estimate matched (1610.0).
- load_id: `c7522407-9aa1-486f-8420-0c097aadbd82`
...
- cost_estimate matched (245.0).
- load_id: `717a31de-db2c-4beb-8f99-503364325080`
...
- load_id: `13965ac5-c486-403a-9c0e-9ecfa02140c1`
...
- load_id: `d954afcf-8467-435b-b878-0c77dd1cf23d`
...
- load_id: `92a0dcac-5326-450c-b878-1b7921b1bc73`
...
- load_id: `daa4185a-0ca6-4df2-8d23-0e4a19395c2c`
...
- load_id: `c046df7d-5e9f-483a-abba-754969eeebb1`
...
- load_id: `0e3e3e10-3d92-4bf1-95ad-9a1e23e310a2`
...
- No graded predictions; document-only.
- load_id: `bef3791e-04f7-4dee-b943-5e4170f58304`
