# Rate Calculator Scenarios -- 20260510_020237

**Run ID:** `4c608434-52be-46bc-b9ed-d740868d22b4`
**Total scenarios:** 45
...
- load_id: `699d445f-a0e7-469b-804c-b571ad752cab`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `16326888-d299-4194-9a73-974434866898`
...
- load_id: `bbe3535b-88af-4c1a-b8e1-38a03add716d`
...
- load_id: `8264dce0-c9ab-4710-a539-27de218afcb4`
...
- load_id: `75fd9793-3987-4c0a-b374-fa1ec9537be3`
...
- load_id: `e3553cf3-b7bc-4561-b01f-d5d4e36a2859`
...
- cost_estimate matched (1610.0).
- load_id: `9bc6b2f7-40a7-4903-96f2-52d66f863372`
...
- load_id: `109e800e-2fb5-45f1-b776-aeb2f415b480`
...
- load_id: `a7a433c7-fbd0-4d6d-9487-a3403da891c0`
...
- load_id: `80851b87-f51a-46e4-8b89-b8a4d8751347`
...
- load_id: `562a6f34-3372-4cf1-a41b-03f88923a129`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `005fb238-a273-452a-803c-6650b1c9c286`
...
- load_id: `fa7a2ef7-bd90-4d2a-99fb-5eb4bb78f6e8`
...
- load_id: `533dadf5-3f1f-4131-a50d-7d94680e6184`
...
- load_id: `4c124928-03b4-4ea1-84e3-36f5f99c3650`
...
- cost_estimate matched (1610.0).
- load_id: `78a85016-da83-42fa-b13e-a6d0af62ba11`
...
- cost_estimate matched (1610.0).
- load_id: `6538418c-438a-49e4-a7ca-e66459a8648e`
...
- cost_estimate matched (1610.0).
- load_id: `06f29d98-26ed-4e94-a239-641133724697`
...
- cost_estimate matched (1610.0).
- load_id: `50d166c0-eb3a-4972-8f85-0cf114676a7a`
...
- cost_estimate matched (1610.0).
- load_id: `15ea2dca-d1df-43dd-aa90-dde706699ae1`
...
- cost_estimate matched (1610.0).
- load_id: `1789ca28-9e79-461e-94b7-8f85ea550c59`
...
- cost_estimate matched (1610.0).
- load_id: `36d5fa65-51f8-4cad-a8da-5f73a518f095`
...
- cost_estimate matched (1610.0).
- load_id: `984e3b8f-e876-482b-a946-fb725db61a1b`
...
- cost_estimate matched (1610.0).
- load_id: `ba17189e-53d3-41b8-88ed-5de550e2f304`
...
- cost_estimate matched (1610.0).
- load_id: `af328349-9894-4d94-8d45-91524e790ecc`
...
- cost_estimate matched (1610.0).
- load_id: `3673641d-72f8-4a58-83ec-f164ec34d343`
...
- cost_estimate matched (1610.0).
- load_id: `74e9f594-1bf5-4266-a05c-917ac4e4fe40`
...
- cost_estimate matched (1610.0).
- load_id: `dfa7aaec-035d-4561-ab1b-e18aab5dece1`
...
- cost_estimate matched (245.0).
- load_id: `5db24ea8-9f81-4f4b-a9af-176312363896`
...
- load_id: `32721a0e-cf12-4af0-a1f1-2c3a07b89a6d`
...
- load_id: `29a56a69-ab1b-456e-a820-55e075a01ffe`
...
- load_id: `0aa9e129-f8d0-469a-8a70-1234be16319c`
...
- load_id: `d10f6da1-3b9f-4013-bb9c-ebbe98a0cec6`
...
- load_id: `331e85f0-c14b-44dd-baad-8c6733a78fa5`
...
- load_id: `c1a722fb-706d-484a-afec-0ef7c73eb06e`
...
- No graded predictions; document-only.
- load_id: `86cb1644-1a0c-488d-8dae-a3979633caf6`
