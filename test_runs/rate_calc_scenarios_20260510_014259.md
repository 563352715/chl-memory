# Rate Calculator Scenarios -- 20260510_014259

**Run ID:** `ac0a1fac-9346-4368-bb6e-38d2f726b3ce`
**Total scenarios:** 45
...
- load_id: `b0a097c8-6585-4f36-ae53-94612105bd2e`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `a5139775-b816-4aad-92c3-2a09d707afc5`
...
- load_id: `8ffb184d-b2f0-41e4-877e-320431d9e5fe`
...
- load_id: `79263285-4f35-41a0-afa7-34a2c7555ed9`
...
- load_id: `a5c31d35-1147-43fa-9cc5-71fda8a4787e`
...
- load_id: `27f6a538-0fe2-46e2-81a6-a9a2e2d4e3d6`
...
- cost_estimate matched (1610.0).
- load_id: `5264eb06-11a5-480a-964a-7a82ff4bf226`
...
- load_id: `d1c6f8c9-debe-48b0-967a-597bfc766b8b`
...
- load_id: `8c860c6a-4ddd-4872-a1ed-3173cb14c724`
...
- load_id: `871459d3-094b-4b82-b4df-5d7a11f5e3fb`
...
- load_id: `e7e34779-f8a2-4fae-a21f-9dde283b5402`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `ad067e13-c15e-40f2-8820-8596d80b2462`
...
- load_id: `add01d28-00ba-4d26-982c-ea4942340522`
...
- load_id: `32fdfc5e-c4c1-4c67-b754-f6773f72681b`
...
- load_id: `59483cd5-8e0c-4979-8e0b-d634f287aa52`
...
- cost_estimate matched (1610.0).
- load_id: `26144880-05c4-4783-9597-e9741347232e`
...
- cost_estimate matched (1610.0).
- load_id: `43c91fb3-0835-47fe-a0da-52e8d49eb1e7`
...
- cost_estimate matched (1610.0).
- load_id: `dc4529d9-7c1e-4bed-b22a-ff34270d5498`
...
- cost_estimate matched (1610.0).
- load_id: `b7c36649-2684-48cc-8425-ff1601af711e`
...
- cost_estimate matched (1610.0).
- load_id: `32a65f2a-ee8a-4fc4-a2d9-ef23e7680402`
...
- cost_estimate matched (1610.0).
- load_id: `4e638d64-b834-4d15-8e2d-0fddb1506d33`
...
- cost_estimate matched (1610.0).
- load_id: `16bad79c-f02a-4b24-8ad6-af6bda6219f1`
...
- cost_estimate matched (1610.0).
- load_id: `a0bf5449-bfbb-4ae3-ab0f-969cefd1aed0`
...
- cost_estimate matched (1610.0).
- load_id: `47a292c3-51b2-4902-aa71-6ee0924b3de5`
...
- cost_estimate matched (1610.0).
- load_id: `36a4b730-660b-46d0-ad3b-04323508ac6a`
...
- cost_estimate matched (1610.0).
- load_id: `02561b35-0e60-43df-acb0-0ce7a898a8e1`
...
- cost_estimate matched (1610.0).
- load_id: `743e733e-210b-4d74-afaf-1ab22e718a30`
...
- cost_estimate matched (1610.0).
- load_id: `a6ee03c5-fe98-424c-92b3-5864db20c98f`
...
- cost_estimate matched (245.0).
- load_id: `02f90685-5b35-4b4a-9204-fa742aab24f0`
...
- load_id: `f0ea9e6a-8760-42c2-9547-b1a90e654084`
...
- load_id: `377c192f-c5d0-48b5-bfb7-fd56c01d8663`
...
- load_id: `2d83bfc5-763a-444a-aea5-3c264b5e6d04`
...
- load_id: `7462f6a4-c76b-4d0b-ae57-5cbe60c5a9cb`
...
- load_id: `b56242e3-a925-4a52-aafb-17450d22b5bb`
...
- load_id: `19411505-5422-4982-bf4e-bfd8f59725b5`
...
- No graded predictions; document-only.
- load_id: `af4f5431-32ec-4805-80ad-d681249a335d`
