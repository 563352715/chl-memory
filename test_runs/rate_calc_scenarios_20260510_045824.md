# Rate Calculator Scenarios -- 20260510_045824

**Run ID:** `653b07f7-03e4-4cfe-919f-fcc66f1b6e8f`
**Total scenarios:** 45
...
- load_id: `082869cd-6666-4592-879f-72f61971dd8b`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `7cc26cb6-9385-4beb-8fd6-860f09cda5ce`
...
- load_id: `0fd31451-ca32-4337-9afa-ad7e96eefb7c`
...
- load_id: `d5958043-7438-47d0-a471-e958220116dd`
...
- load_id: `4a8f7092-39ff-4d2e-8d19-0fee14fde9b6`
...
- load_id: `eaee93fb-50ba-4d77-8851-e145363b8c24`
...
- cost_estimate matched (1610.0).
- load_id: `ae76580a-8f5e-43bf-a6ac-344ddd4b83a9`
...
- load_id: `90d1f232-7d79-47f0-a693-636cb33a2304`
...
- load_id: `95ccd59d-d966-496c-9a0c-54a623cca9fc`
...
- load_id: `53fa4386-5ff3-4ad2-a006-f6b14bbbd16d`
...
- load_id: `3f50d696-b675-43f6-b505-999c45d2fa2a`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `54b75db4-f4aa-45b3-88f3-7776eb8a82df`
...
- load_id: `3268ed5b-c32d-43ce-9996-f6ff51a2581e`
...
- load_id: `b5144b23-1707-4398-b031-6f0d92b7515c`
...
- load_id: `c617e2a4-90cf-4223-8e2b-8f04c9be61b3`
...
- cost_estimate matched (1610.0).
- load_id: `53457c4b-be76-4cd7-8f95-9abb82b502da`
...
- cost_estimate matched (1610.0).
- load_id: `fdb9ef00-e8a2-4317-8ec7-3c32b08b7b8d`
...
- cost_estimate matched (1610.0).
- load_id: `7d802869-ae80-43e5-8403-eaf5bfeb3f77`
...
- cost_estimate matched (1610.0).
- load_id: `d4ede7fa-801d-4db6-aa89-860d0bdf6c96`
...
- cost_estimate matched (1610.0).
- load_id: `8bbb28c1-dc5f-47e0-8cd7-6b238b6a68e1`
...
- cost_estimate matched (1610.0).
- load_id: `21dcfdde-66cc-4c47-a5d9-a1fc7810aa7a`
...
- cost_estimate matched (1610.0).
- load_id: `38f1caed-8c41-4841-91b8-66f880f3a0bc`
...
- cost_estimate matched (1610.0).
- load_id: `a738f1be-f204-4a0c-8e48-5cf9f3ad0d42`
...
- cost_estimate matched (1610.0).
- load_id: `e2e1efe9-8d01-42b5-aa87-26710d1dcdb3`
...
- cost_estimate matched (1610.0).
- load_id: `f23ec89d-7d00-4e67-8873-5d57c012101f`
...
- cost_estimate matched (1610.0).
- load_id: `68934e45-85ff-4a02-a718-903216b2e24a`
...
- cost_estimate matched (1610.0).
- load_id: `d931b7a1-3a49-490f-ad41-2938dd153bb5`
...
- cost_estimate matched (1610.0).
- load_id: `9342d8c6-e6c0-4c77-a4ea-0856fb7ed104`
...
- cost_estimate matched (245.0).
- load_id: `fe7943e4-9fe6-4175-9a22-1372d29813b0`
...
- load_id: `f4a8d82a-b87c-4308-894d-2490a29a6a15`
...
- load_id: `6cd8a898-f902-4b8a-ab9f-c64f0114a8b9`
...
- load_id: `33a2d43f-f95e-4fb3-9e32-781917ad2ef8`
...
- load_id: `8a712a10-dac2-419d-8cdb-42f19c2859a8`
...
- load_id: `68ba600f-1ecf-42d8-acc3-520c7e8cc322`
...
- load_id: `e826e829-6f6e-4e16-8810-a805a3c646a1`
...
- No graded predictions; document-only.
- load_id: `046fc164-6abb-4ddf-81ce-d6fc59ad43cb`
