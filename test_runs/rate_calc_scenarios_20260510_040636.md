# Rate Calculator Scenarios -- 20260510_040636

**Run ID:** `46e4ba54-5e1e-4d97-9e40-dbfcc944d0fb`
**Total scenarios:** 45
...
- load_id: `55ff3e7a-46ef-4a6f-b349-a66f3315f60c`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `4722e1a2-7c7f-44cf-a072-39b43611cd62`
...
- load_id: `5c442fb6-09fd-48d3-9e61-5e001f049b40`
...
- load_id: `f056880d-cf6b-4cdb-9e30-5e9713a40296`
...
- load_id: `902432a2-2c2c-4e34-8df7-eb5c828e5a8c`
...
- load_id: `b2fdda6a-120e-4908-b42e-f5c863e35131`
...
- cost_estimate matched (1610.0).
- load_id: `6820b9b1-defa-4c6c-b321-893af1fc9f37`
...
- load_id: `31485693-d05b-493d-8eaf-2f2bf9fcafe3`
...
- load_id: `b6991642-78c4-48d6-9ed2-271eedef345d`
...
- load_id: `dcfc9b30-a745-4c21-8f12-5760d06eccd5`
...
- load_id: `0dcef225-fe9f-4aff-afde-304736712c7d`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `233edc92-aa5b-499a-89c5-1269ed32222f`
...
- load_id: `77fd283d-1fd5-4f91-998b-130148191aea`
...
- load_id: `7e7911c4-1b8a-480d-9c1a-ab838abb1c8e`
...
- load_id: `76db10d9-84ba-4eb7-9737-7711d33d7e1b`
...
- cost_estimate matched (1610.0).
- load_id: `d5c6a389-a502-491a-ad50-9231e9c8517a`
...
- cost_estimate matched (1610.0).
- load_id: `d4f9c002-3047-4974-81fb-eb3c5ebcc33c`
...
- cost_estimate matched (1610.0).
- load_id: `f79c86c6-a59a-4e57-9357-f35003c416b8`
...
- cost_estimate matched (1610.0).
- load_id: `9b3a604f-34de-4915-816e-91b5ba7d6a0b`
...
- cost_estimate matched (1610.0).
- load_id: `b7328341-031b-4f24-942a-95620d9921ee`
...
- cost_estimate matched (1610.0).
- load_id: `f6dec127-0775-4622-a99a-c24a266c1a44`
...
- cost_estimate matched (1610.0).
- load_id: `068ffc71-917b-49f3-a8f1-f62662c2bbc6`
...
- cost_estimate matched (1610.0).
- load_id: `dee8fb29-e504-49db-b249-519fec273b55`
...
- cost_estimate matched (1610.0).
- load_id: `4040d9a1-6232-481f-b88e-6d7d6131ea76`
...
- cost_estimate matched (1610.0).
- load_id: `14c70a5a-115a-4d34-9842-c26a172b642e`
...
- cost_estimate matched (1610.0).
- load_id: `d4aa4d2e-05fd-406d-b914-b82992422785`
...
- cost_estimate matched (1610.0).
- load_id: `43c3af38-261f-456d-a88d-6830050d2a69`
...
- cost_estimate matched (1610.0).
- load_id: `d95ba72b-d48a-45f8-a939-d04338ecaede`
...
- cost_estimate matched (245.0).
- load_id: `72b26a7c-3fa1-4960-88c1-5c3dca799460`
...
- load_id: `adbf5cc0-d89a-4110-a31a-81a49b76f603`
...
- load_id: `5c3c0e07-dabe-4c24-9d7f-edd82570abe1`
...
- load_id: `2d86bbda-8689-4328-a113-3e32b5631378`
...
- load_id: `0920a86f-c2b1-4091-aa9b-ed6b9ba4fab6`
...
- load_id: `012f71e8-eb7c-4323-9708-b32787e55213`
...
- load_id: `7a622124-624d-4105-8fef-8a03cd04b109`
...
- No graded predictions; document-only.
- load_id: `de43ca9c-a4fc-491f-8afa-aa1fde917a99`
