# Rate Calculator Scenarios -- 20260510_031852

**Run ID:** `7f471a5d-0eb4-46c6-b4f4-8c5e59a5a548`
**Total scenarios:** 45
...
- load_id: `8fbd93bd-4add-42a4-932a-f72bde3f4f3a`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `d82ac1f1-7b22-4938-9ada-b0e1e10ed978`
...
- load_id: `5b60ea21-5361-4c76-a366-89bfb94877cd`
...
- load_id: `7abf6cfe-bf20-459f-9528-bcc9d1de9f08`
...
- load_id: `bb42ea33-b514-4198-85c7-38fa88dab5af`
...
- load_id: `59eff4d0-89d4-43a7-b231-71b96fa2ab28`
...
- cost_estimate matched (1610.0).
- load_id: `1a99da10-f4ba-49d6-b78e-039ccc178256`
...
- load_id: `24062e06-ff3b-4b33-bb83-a501faf025b6`
...
- load_id: `cab25df0-bba6-48e4-815e-79f3bbf78ce2`
...
- load_id: `9c5bb1e8-6498-446f-b6c1-32452386913e`
...
- load_id: `f32189a0-1cc2-4600-9603-d9561a7f70e4`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `48093d34-9159-4087-a164-98520a821b92`
...
- load_id: `6e62217e-803a-4636-a47d-87d3836a1933`
...
- load_id: `25e80b2f-3313-4b54-b4e1-18f1ee274537`
...
- load_id: `81b07f1d-73d6-436a-9146-2e862c26f3f1`
...
- cost_estimate matched (1610.0).
- load_id: `108d1f8c-7a65-406e-b018-228bf267f2cc`
...
- cost_estimate matched (1610.0).
- load_id: `437937bf-e512-4216-b544-499e0b3b8bb5`
...
- cost_estimate matched (1610.0).
- load_id: `cfac4180-158d-41a7-ad52-8a4136957901`
...
- cost_estimate matched (1610.0).
- load_id: `658a6238-6842-46c3-926d-7b6998d04c3e`
...
- cost_estimate matched (1610.0).
- load_id: `59fdbdfc-ac32-4044-9ae2-b0495ef2ae22`
...
- cost_estimate matched (1610.0).
- load_id: `b6220cee-be65-4e77-a413-eea443e8e924`
...
- cost_estimate matched (1610.0).
- load_id: `ae921951-923a-4c95-901d-01e0d85b47b5`
...
- cost_estimate matched (1610.0).
- load_id: `2970fa9e-1de8-44f2-ae0a-efeed964a1ad`
...
- cost_estimate matched (1610.0).
- load_id: `2a82053f-9e0f-4a3b-b068-d66eb8dd824b`
...
- cost_estimate matched (1610.0).
- load_id: `770294e7-fe35-4f23-a455-80c02e06d511`
...
- cost_estimate matched (1610.0).
- load_id: `5b3ec61c-8b3e-4c26-9d2f-13cc16ed51ea`
...
- cost_estimate matched (1610.0).
- load_id: `b3c80bd2-73ea-488e-ac5b-b9afe0a3e7d7`
...
- cost_estimate matched (1610.0).
- load_id: `c4e5edf8-c895-4fe3-9be1-dd4ad3a3bc5c`
...
- cost_estimate matched (245.0).
- load_id: `189eec4b-25b0-4f8d-a770-081ec0113fb0`
...
- load_id: `23810543-7839-4452-8d46-a9dbe0b33898`
...
- load_id: `a999130c-741e-4c10-80b2-d1d767105218`
...
- load_id: `df3dabb0-087f-472b-9456-c125586d6401`
...
- load_id: `59c96795-d2f5-4ebf-812b-e079e925d062`
...
- load_id: `c0ab3679-194c-4169-9ba2-1abf8070edc4`
...
- load_id: `e5e1f924-7f12-4a14-a8ab-dec0bff9aca4`
...
- No graded predictions; document-only.
- load_id: `6e9dc341-68d8-4bdc-81e8-5bec06d9a294`
