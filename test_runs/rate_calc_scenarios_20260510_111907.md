# Rate Calculator Scenarios -- 20260510_111907

**Run ID:** `b48a7137-c2d7-496f-be96-fb5b392597ac`
**Total scenarios:** 45
...
- load_id: `48e47999-2a17-46bd-8c18-ab7fde9c8168`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `c9bf52d6-a33f-491d-ad6a-4163d0e8c397`
...
- load_id: `e72b1599-845a-47af-a50b-1929146acd08`
...
- load_id: `0b909174-07b9-41f2-8523-ba95da66efda`
...
- load_id: `3e9d2525-0b44-4dc9-a424-dc4c685272f0`
...
- load_id: `1b640610-2bcb-4247-aa04-a8374cf8f025`
...
- cost_estimate matched (1610.0).
- load_id: `e7e5c067-95fe-451f-b4f0-d47251e5c1e2`
...
- load_id: `b0d0d5c6-1dc9-47ee-8565-15bfabbd3297`
...
- load_id: `1abf848b-889d-4091-abcd-221c548c15fe`
...
- load_id: `a381bc68-80c2-48d1-91f5-b77a70ca60d5`
...
- load_id: `bce198eb-2f0d-4438-acfe-fcb9a324e46f`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `c94686d0-7491-449e-a148-c45fa25a31e3`
...
- load_id: `1c7632db-d221-417c-ad12-78982027cea0`
...
- load_id: `4cb3106a-8578-4e18-aede-c2c5b0c70dc6`
...
- load_id: `096718d5-1929-4833-815a-bfff466f6c4b`
...
- cost_estimate matched (1610.0).
- load_id: `68f45873-316a-4dca-87db-9df4483f3332`
...
- cost_estimate matched (1610.0).
- load_id: `7795d3b7-0bd2-4f71-ac2b-3d6e6b71fa9b`
...
- cost_estimate matched (1610.0).
- load_id: `828764c9-148d-4486-9582-7ec3d808afc9`
...
- cost_estimate matched (1610.0).
- load_id: `054253fa-766e-4513-b5d2-29fc26839349`
...
- cost_estimate matched (1610.0).
- load_id: `15a52376-1a4f-4485-bc51-8703b339e695`
...
- cost_estimate matched (1610.0).
- load_id: `60277e13-49a4-44fd-84df-0c857f21a9ee`
...
- cost_estimate matched (1610.0).
- load_id: `ed5e0936-9eb0-4755-97cd-4bd9306fd79a`
...
- cost_estimate matched (1610.0).
- load_id: `50f16ecf-95dc-4a7d-bd06-2de8f06916d5`
...
- cost_estimate matched (1610.0).
- load_id: `1a3bec9d-9690-4e0c-b028-1d8a950db30e`
...
- cost_estimate matched (1610.0).
- load_id: `af9386b9-1636-4423-b659-9bea22f869f5`
...
- cost_estimate matched (1610.0).
- load_id: `f6c32e40-77de-47ae-af7a-372a15a5f8ed`
...
- cost_estimate matched (1610.0).
- load_id: `3c933b8a-6096-47f9-aff6-d8ef515bba33`
...
- cost_estimate matched (1610.0).
- load_id: `c83b81ec-3fc4-4a60-98a2-494ca34e6cc4`
...
- cost_estimate matched (245.0).
- load_id: `2baa3144-bfc6-4cb6-a106-ebf238f9cc7b`
...
- load_id: `22addf35-9d01-4258-9cac-8d0663935de2`
...
- load_id: `5b4a9a75-dd8b-46f5-9d0f-1faf70c58e37`
...
- load_id: `829903a0-59d1-40fb-8f10-1bb254bc45ef`
...
- load_id: `985fa04e-c7c9-4976-b201-413ff9d08b09`
...
- load_id: `b2ef8eba-641c-4abb-8720-93bfb7f802f1`
...
- load_id: `82feea5d-ca09-46eb-920b-292cdd241732`
...
- No graded predictions; document-only.
- load_id: `18f81db8-f8c3-4af0-bfbb-841c2629e54b`
