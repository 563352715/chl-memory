# Rate Calculator Scenarios -- 20260510_034112

**Run ID:** `d9a87ed5-3d44-4f30-adeb-074519573d2c`
**Total scenarios:** 45
...
- load_id: `a94b0efd-d268-4b61-81e1-c1be68efb5e2`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `935229d7-0d02-4d4b-8088-8c3830c1827b`
...
- load_id: `b80d4d81-b3d1-47c0-ac8d-ac6d45c0e1b2`
...
- load_id: `7c644871-8bd2-4386-9b36-31e6d15bfa2e`
...
- load_id: `90e8dc36-1ed1-437c-81b9-b9632fc23c20`
...
- load_id: `65297632-b0fe-4277-b363-661712cbf69f`
...
- cost_estimate matched (1610.0).
- load_id: `2576395d-d7de-4e68-9087-f97fa3e3fb3b`
...
- load_id: `9126bfe2-ab66-4749-b13b-7d061a11ba60`
...
- load_id: `25aeadd5-210c-47c0-b9f9-93bfccec8136`
...
- load_id: `04e55739-a7f9-4090-ab3d-a2080796e1a0`
...
- load_id: `2dd494fc-53b6-43dd-9c1b-bda408dd1971`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `26100259-1114-4faa-925c-c18d70c1351e`
...
- load_id: `a3bdc421-cbed-47a1-ac96-db0381716d6d`
...
- load_id: `901ad371-1ed3-4a5d-98f8-3973d42caea2`
...
- load_id: `0ecfeb33-be86-4bfc-8902-bd2ed40320f1`
...
- cost_estimate matched (1610.0).
- load_id: `7042cf74-dae9-41f7-be35-78f2f74e9c18`
...
- cost_estimate matched (1610.0).
- load_id: `e2036db4-c09e-42c6-a7e8-e028202d5f23`
...
- cost_estimate matched (1610.0).
- load_id: `40991278-bbcf-4914-95ca-82c7c3bea39a`
...
- cost_estimate matched (1610.0).
- load_id: `7771cb0e-7a19-4488-8610-b0fdd4ea1dd4`
...
- cost_estimate matched (1610.0).
- load_id: `e71b604d-35f1-4724-98a9-3dca089a211a`
...
- cost_estimate matched (1610.0).
- load_id: `b14d6ff1-2f88-4d24-aceb-93142043ec5d`
...
- cost_estimate matched (1610.0).
- load_id: `80a0631c-a450-4f4b-b466-b9200e339274`
...
- cost_estimate matched (1610.0).
- load_id: `28ed484c-c88f-49b2-be7d-d6ca994fb356`
...
- cost_estimate matched (1610.0).
- load_id: `9c4b53f7-5b95-4b89-8b0e-43534afee04d`
...
- cost_estimate matched (1610.0).
- load_id: `fffb9d26-f381-4106-94eb-d2ea32c68402`
...
- cost_estimate matched (1610.0).
- load_id: `a3e6a9ba-b6fa-4a5c-80b7-37317a822c4e`
...
- cost_estimate matched (1610.0).
- load_id: `1d859f27-afd4-4a97-b107-399db158a671`
...
- cost_estimate matched (1610.0).
- load_id: `01535a91-0d7e-47ba-845c-4a12c7cb8a5a`
...
- cost_estimate matched (245.0).
- load_id: `18321c12-d0e2-4186-a488-3020513283df`
...
- load_id: `9b4d0740-b366-421d-bd5e-24a71fa08382`
...
- load_id: `44c509dd-7d54-4e49-ba81-ded331f299a1`
...
- load_id: `8fc0db8f-53d7-47da-b398-2922f4b1de49`
...
- load_id: `508d2f15-f392-4b43-93ff-2c650c657191`
...
- load_id: `404a4f02-c518-4ec4-9258-8c0051232787`
...
- load_id: `e182a43f-b70f-47fd-8fea-aa5a49b337da`
...
- No graded predictions; document-only.
- load_id: `6bd36dc1-e079-4cd0-9c93-a71a910e8d4a`
