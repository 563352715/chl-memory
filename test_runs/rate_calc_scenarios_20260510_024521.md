# Rate Calculator Scenarios -- 20260510_024521

**Run ID:** `ad8d3a3c-11c4-4b1a-abd8-a48c91a76e8f`
**Total scenarios:** 45
...
- load_id: `af162e36-a7fb-41ff-b107-f589afcdeed8`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `beed2baa-92cd-4508-9667-a3e93af82421`
...
- load_id: `82b8a983-7e3c-44fe-8caf-4fb0113101d2`
...
- load_id: `1d776c07-3c12-4856-9146-501426014a33`
...
- load_id: `ad85894a-fe10-4232-8216-171a8884411f`
...
- load_id: `cf3eb95b-c6b9-4a73-9c91-7e484fc36f4f`
...
- cost_estimate matched (1610.0).
- load_id: `bc093324-5753-4192-bde5-4f01cf60a294`
...
- load_id: `63984833-6cb3-4a62-8a86-cf2cad472c03`
...
- load_id: `46630e55-9b75-45bb-b4a2-a8eb1cc04a39`
...
- load_id: `e0ee5566-b81b-4b3d-a724-52e8c10458f4`
...
- load_id: `2b0b1271-9514-43b6-8da6-f6cf81a9bc02`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `8ae98cb7-1489-4356-8f47-e43442184b91`
...
- load_id: `e71fe320-4e06-436d-92e7-7c9217bc4548`
...
- load_id: `7afe421a-b5ba-470a-a1fa-6bf5f55506b4`
...
- load_id: `a56e73da-bf00-4ad5-8fc6-9d0ee237716e`
...
- cost_estimate matched (1610.0).
- load_id: `cd6b21d6-4e84-4810-9e40-020a8be25904`
...
- cost_estimate matched (1610.0).
- load_id: `18854e7b-e0ac-4f4e-bc26-894919e0ce98`
...
- cost_estimate matched (1610.0).
- load_id: `98808966-a351-4e81-a69c-c6f5f17e4c1f`
...
- cost_estimate matched (1610.0).
- load_id: `3006d0bd-f8ea-4342-81a6-8bf6dd9baa4a`
...
- cost_estimate matched (1610.0).
- load_id: `d2331f32-96b9-4b1d-8a31-e65f491efab6`
...
- cost_estimate matched (1610.0).
- load_id: `bbd6c9c8-f8d2-40b6-bbb8-7ed3733a1bd6`
...
- cost_estimate matched (1610.0).
- load_id: `a1de68a5-d031-4af4-ba00-a5167f6f7f24`
...
- cost_estimate matched (1610.0).
- load_id: `5f4d0e78-369f-4b46-a923-607501cd3131`
...
- cost_estimate matched (1610.0).
- load_id: `a548885a-34a9-4d2b-942d-92b80d42522c`
...
- cost_estimate matched (1610.0).
- load_id: `44b35249-6ec8-4b61-92c3-b5475919a110`
...
- cost_estimate matched (1610.0).
- load_id: `5b5d9192-c8f9-4c82-a691-4b5106a838cc`
...
- cost_estimate matched (1610.0).
- load_id: `68d5dbc0-29a8-44b3-aa25-68114157562e`
...
- cost_estimate matched (1610.0).
- load_id: `dcb65859-faed-4e5c-aac7-9815ea249ea5`
...
- cost_estimate matched (245.0).
- load_id: `8aec310c-a422-4832-905e-80df633ff618`
...
- load_id: `a6fd4b57-831b-49fb-abeb-9c653a41773c`
...
- load_id: `f86e66da-86cc-48b9-977e-5e8b889ab864`
...
- load_id: `95130dd4-efcc-4895-83ab-458e086cf60f`
...
- load_id: `803b87c7-c4f8-4d19-a6f9-7f228b9235b6`
...
- load_id: `f02563d1-b347-4638-8897-990d2cfaa621`
...
- load_id: `f7f9ab3d-5fbb-436c-9e90-8adf8f80b68a`
...
- No graded predictions; document-only.
- load_id: `83557afa-4b5d-4756-9c91-2dcf93b56554`
