# Rate Calculator Scenarios -- 20260510_042655

**Run ID:** `331e8232-a5e9-4c69-84b6-bcb81077847e`
**Total scenarios:** 45
...
- load_id: `02189a21-6dd9-439d-a2fb-6bceb4dcd097`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `15e69c27-42d6-4171-9a54-5415912ff8fe`
...
- load_id: `4666e3d7-8f8d-4edb-b6b6-57d45acc467e`
...
- load_id: `d0e3b8b9-d8f7-49a4-a1ec-93255b0a2126`
...
- load_id: `afbc8a92-0a19-4af6-a86a-b154998bf336`
...
- load_id: `f55f8526-eb02-4f99-840b-b3ed9e58be24`
...
- cost_estimate matched (1610.0).
- load_id: `a2e0a6a1-a773-4108-87e6-75ff55a1fb89`
...
- load_id: `bf5920f1-21d5-49ff-887f-1c61bfcd462c`
...
- load_id: `b47388aa-550d-4e9f-be4e-ed0161d673c1`
...
- load_id: `47a35463-46ec-4b38-8074-cb4a6e635211`
...
- load_id: `7fbe0bdb-f914-439e-bf36-953e2cf95234`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `751299de-af3a-463f-849f-e337df0538db`
...
- load_id: `99958543-7f8f-4bb0-a0ab-06f32c3fad39`
...
- load_id: `b5680f25-0fcd-4b70-810f-6196031fccee`
...
- load_id: `2eb3da52-c95b-4c73-9d01-b17c2aebe895`
...
- cost_estimate matched (1610.0).
- load_id: `3198e182-5bb9-4578-ba4e-2f9b3c6de5e2`
...
- cost_estimate matched (1610.0).
- load_id: `86e72f40-d7f8-452b-95f8-c0d7abfc03d4`
...
- cost_estimate matched (1610.0).
- load_id: `b92a218e-bf18-4182-ab31-83f1c3376f3a`
...
- cost_estimate matched (1610.0).
- load_id: `76532ec0-5071-498c-9871-224589b051bf`
...
- cost_estimate matched (1610.0).
- load_id: `3be9e454-8845-41d7-8ef0-a5a0a4abaa9f`
...
- cost_estimate matched (1610.0).
- load_id: `d22019a5-30db-42b6-9769-1e59238add44`
...
- cost_estimate matched (1610.0).
- load_id: `eff47e96-75e6-4d96-a6e0-232c24105980`
...
- cost_estimate matched (1610.0).
- load_id: `a8320439-65c9-43a0-b40a-86e977981306`
...
- cost_estimate matched (1610.0).
- load_id: `3a6d166b-fd11-465e-b5e9-068f5a8badf0`
...
- cost_estimate matched (1610.0).
- load_id: `61e52885-adf7-4db9-8805-d4962b977a24`
...
- cost_estimate matched (1610.0).
- load_id: `74904ce3-e4b2-4dbb-9b44-4d13c1f64719`
...
- cost_estimate matched (1610.0).
- load_id: `005e688c-f8a5-4d9a-93f4-ff8c820c7d82`
...
- cost_estimate matched (1610.0).
- load_id: `765060e6-f9f4-49db-961e-35382c9179f5`
...
- cost_estimate matched (245.0).
- load_id: `7fd6f591-6617-4e24-953c-9bbfb3bb25a7`
...
- load_id: `b03f5535-6eca-4364-9594-ad175d3414a9`
...
- load_id: `d22efd07-510e-4350-8b57-d71b48ac0196`
...
- load_id: `7e574c3c-b742-4cba-ae1b-7b0c3dd99ce4`
...
- load_id: `52433989-040d-4263-9d01-b568fac6ab41`
...
- load_id: `1e3f5387-1487-4004-bcc5-487d67f46a27`
...
- load_id: `0180fcd5-6943-42b7-b898-ecf35abb884b`
...
- No graded predictions; document-only.
- load_id: `ff503b7f-ac21-4b4c-9373-0f4cc7a8915e`
