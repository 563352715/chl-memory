# Rate Calculator Scenarios -- 20260510_042251

**Run ID:** `0b4b3486-9842-402d-a34e-766e8a97c582`
**Total scenarios:** 45
...
- load_id: `c2157b1d-f42e-4a47-a25d-a584e295eef1`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `60c717d6-994b-4e6e-a753-7e7f7eeea69f`
...
- load_id: `28298a90-7c57-4199-b249-b68db275bc87`
...
- load_id: `850ed4e7-4c09-42f3-8acc-c40f444b4c02`
...
- load_id: `e0ed5565-c25f-41e3-b46a-360bc013fc16`
...
- load_id: `1edfb821-024a-4aa0-b351-49433835bfbe`
...
- cost_estimate matched (1610.0).
- load_id: `c47c8237-5533-4fd9-90ff-2972ee255ded`
...
- load_id: `7ee53c83-e194-4716-a767-c88b8c49192d`
...
- load_id: `bf3b342b-949b-4a83-b47a-acee3f271b18`
...
- load_id: `168ea65d-6bd1-4e4c-bae5-3e8e20f4e7f2`
...
- load_id: `e2f30458-d264-4d36-b547-d870f5eeaf5e`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `47a1d196-9e3a-4557-873e-2b0bba1b7b02`
...
- load_id: `185d577d-612c-4abb-8331-1e255011845e`
...
- load_id: `62436ce5-6bc0-4a57-a8e2-e74cf0759d53`
...
- load_id: `5d82e846-c391-40d7-8185-42d8ffba6834`
...
- cost_estimate matched (1610.0).
- load_id: `8c3f0afd-d9f1-4699-b083-a0e1913a1a34`
...
- cost_estimate matched (1610.0).
- load_id: `6a5c9e1a-fb6c-4036-ad40-fac97dfcb19d`
...
- cost_estimate matched (1610.0).
- load_id: `70cb1f5c-2709-444f-a896-9bb82126673b`
...
- cost_estimate matched (1610.0).
- load_id: `feb38fd2-f00d-481c-94c9-f19e7d293d84`
...
- cost_estimate matched (1610.0).
- load_id: `75b0d73f-344b-478d-b806-50ea5d2e610e`
...
- cost_estimate matched (1610.0).
- load_id: `e4c7d484-3c6f-48d8-b4fe-32db78178e61`
...
- cost_estimate matched (1610.0).
- load_id: `663a49e1-82ac-497b-8237-3388444c6066`
...
- cost_estimate matched (1610.0).
- load_id: `2d4d379a-2935-4d3f-ac38-136895b44bb3`
...
- cost_estimate matched (1610.0).
- load_id: `68abe959-6a5f-4d55-9f19-35b7b39dfab8`
...
- cost_estimate matched (1610.0).
- load_id: `6a2b338a-7cba-4a11-972a-3e37420def20`
...
- cost_estimate matched (1610.0).
- load_id: `baed71b6-aa2e-4b9f-aef2-64e2234ffcd2`
...
- cost_estimate matched (1610.0).
- load_id: `b2dd4cc8-5027-4319-9eb1-c7fa7453b12f`
...
- cost_estimate matched (1610.0).
- load_id: `9a47336b-fef0-42cc-a1fd-727a214cf76d`
...
- cost_estimate matched (245.0).
- load_id: `33bbc79a-3806-4186-bc35-358be5ebb8ab`
...
- load_id: `2c66cf94-e15d-4f35-b6c4-680aa513b6c8`
...
- load_id: `86582b56-12fa-4dfb-8cfd-acc2f0b36762`
...
- load_id: `bf410a9a-df4c-42b9-b5c1-c392b368e155`
...
- load_id: `9a82262a-ce2d-43ed-8477-d97d68c52620`
...
- load_id: `79af936a-5512-4492-be48-05c0cab833d0`
...
- load_id: `e111e691-ed73-49c5-af97-c680b0dfd409`
...
- No graded predictions; document-only.
- load_id: `c3e5287e-5816-48b8-8951-303bb9a89f33`
