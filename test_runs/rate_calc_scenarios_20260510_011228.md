# Rate Calculator Scenarios -- 20260510_011228

**Run ID:** `a313b16e-4a36-4ee2-acc4-8a5a248b8098`
**Total scenarios:** 45
...
- load_id: `2e39fd2b-9e19-44dc-98c5-9e4351c14865`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `b2ba43b3-e634-4c30-8fba-27c302711158`
...
- load_id: `042c1a62-ed3b-426d-9598-1822d78b23a4`
...
- load_id: `a77b04dd-923b-447f-9e97-7068b144ce4e`
...
- load_id: `0e624bd7-303f-43bc-8989-232630d54df1`
...
- load_id: `f6ed5b7f-3b7f-46d8-8a88-a92e89114af7`
...
- cost_estimate matched (1610.0).
- load_id: `e7921820-f570-471d-854e-fb02bd8c830c`
...
- load_id: `d093f872-3fa1-4227-b12f-75c3ad44853f`
...
- load_id: `30053588-4341-41d4-be65-66547ea02779`
...
- load_id: `f5eb20f3-d681-48ea-87c5-aa103589c4d5`
...
- load_id: `337656de-c12e-41d7-8b21-14459a728e04`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `ad3fc8bd-2391-4a50-9d79-07f534322e0c`
...
- load_id: `85c562f2-7c58-43bb-9ec3-5be218e9ac56`
...
- load_id: `fd0bfcb0-f8ce-4664-89cb-203e9faa9e2a`
...
- load_id: `b59ac522-755e-41cc-9b8b-46b7375b4310`
...
- cost_estimate matched (1610.0).
- load_id: `32658222-ca1a-4b31-8c5f-d7c6ddd0662d`
...
- cost_estimate matched (1610.0).
- load_id: `138e8ffe-ea4b-4da0-a5b7-bd7c30a4bb80`
...
- cost_estimate matched (1610.0).
- load_id: `041a3ba3-e242-4323-9a76-0906f2d496db`
...
- cost_estimate matched (1610.0).
- load_id: `cc9e5d85-1901-48dc-baf9-747a8b6a3f09`
...
- cost_estimate matched (1610.0).
- load_id: `726e3d47-50c2-4867-9692-d4b84188e141`
...
- cost_estimate matched (1610.0).
- load_id: `2e9a49ce-ea36-4e84-adb9-3b8d2c68a216`
...
- cost_estimate matched (1610.0).
- load_id: `f37a9fc0-773f-46a6-ad9e-12486a8d9278`
...
- cost_estimate matched (1610.0).
- load_id: `3c82da46-a548-4807-b346-1ab9de8de578`
...
- cost_estimate matched (1610.0).
- load_id: `63cd282f-88c8-4cc2-923a-87b4fc52d42d`
...
- cost_estimate matched (1610.0).
- load_id: `9d1441fd-ff7a-4f28-ae6a-d0c4769dc8da`
...
- cost_estimate matched (1610.0).
- load_id: `784d7857-54a9-4b6f-93ad-4e3b90d5b561`
...
- cost_estimate matched (1610.0).
- load_id: `d7873506-7efb-430f-aa07-4b2af52f7f3e`
...
- cost_estimate matched (1610.0).
- load_id: `fd89d05c-c54c-4f5d-b049-ffa542963bee`
...
- cost_estimate matched (245.0).
- load_id: `7f329488-0041-4056-9ce7-3b75626d94da`
...
- load_id: `8473dcbc-63b3-4d24-aa90-21e763f1ba1b`
...
- load_id: `41cf7483-ff59-4323-8da9-6f782b77879c`
...
- load_id: `c2066b63-3244-4b03-ab6a-44e8fcb42aa4`
...
- load_id: `f3494a49-4789-428f-8fe2-c61119596d02`
...
- load_id: `5395dde8-65e8-44ff-8d52-8003df86a572`
...
- load_id: `95059dc9-de14-431d-ab9a-0df43262b740`
...
- No graded predictions; document-only.
- load_id: `010b65b1-75ec-4150-bb11-6493fae63830`
