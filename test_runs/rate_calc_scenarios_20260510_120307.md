# Rate Calculator Scenarios -- 20260510_120307

**Run ID:** `283e415e-083e-4228-8c0e-8bffe6187967`
**Total scenarios:** 45
...
- load_id: `ea82c3df-981a-45db-9f05-9e61be97f23d`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `46abe5fa-c489-4447-b221-bbf2da4deacd`
...
- load_id: `63cebbb1-6819-4d1c-8a4f-3f11f2b6a787`
...
- load_id: `5eef26e2-132b-4d3d-8d8c-fa199c6e1d87`
...
- load_id: `6ef66193-58b7-40c4-9ddd-196522898f52`
...
- load_id: `e300cf9b-65ed-4168-a6c9-7cd99acc43b8`
...
- cost_estimate matched (1610.0).
- load_id: `e9a968d5-eb1a-4590-93b0-3d4e4ef593d0`
...
- load_id: `6284bffc-eec5-48e5-9695-dd912230e67e`
...
- load_id: `0ad1be07-27ef-4290-98cb-c7022462242b`
...
- load_id: `29248fe8-64fb-41ac-a001-08e45acff0ad`
...
- load_id: `c25a42b5-90f4-48bd-998a-f6bbeeff6d47`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `b955405a-f2ef-4f7a-aff4-379ebbae7aa4`
...
- load_id: `044edca0-13bb-412b-bb08-defce226d2d8`
...
- load_id: `2b9593b0-bcfb-46be-bcc5-159d0f7bfeea`
...
- load_id: `2f7253ec-44f5-4697-8198-3de752b432dc`
...
- cost_estimate matched (1610.0).
- load_id: `719c2427-eca6-4392-a58e-a71a9a45d9cd`
...
- cost_estimate matched (1610.0).
- load_id: `24956b29-b6e8-4ff5-b87e-b8cf8ffc3e95`
...
- cost_estimate matched (1610.0).
- load_id: `157111ab-1915-4182-884d-8be13c6927cd`
...
- cost_estimate matched (1610.0).
- load_id: `e09f1dd0-9c04-4fce-a4bb-34c12b0d3831`
...
- cost_estimate matched (1610.0).
- load_id: `4b19bb6c-c95b-40d4-a71f-0153aa36cfc2`
...
- cost_estimate matched (1610.0).
- load_id: `a870a326-684a-4302-9754-7731b26bcaf1`
...
- cost_estimate matched (1610.0).
- load_id: `8090bd08-c632-412e-93ff-ca18897d7a78`
...
- cost_estimate matched (1610.0).
- load_id: `a1e08f1f-2f22-4ad2-a849-32cf86ce0ea7`
...
- cost_estimate matched (1610.0).
- load_id: `6024ce71-fc19-4cab-99c4-692867582edc`
...
- cost_estimate matched (1610.0).
- load_id: `58144d81-4ac5-424c-aabb-d897008f1499`
...
- cost_estimate matched (1610.0).
- load_id: `200f1134-39ca-4e20-98a0-bf8edf63616e`
...
- cost_estimate matched (1610.0).
- load_id: `7f8202d4-0361-498a-b16b-ff177e3f2e7e`
...
- cost_estimate matched (1610.0).
- load_id: `cd621f3a-4a20-486a-a162-5a5d69b64749`
...
- cost_estimate matched (245.0).
- load_id: `53752c49-234c-48db-b90e-204382df43a7`
...
- load_id: `85f76999-cce6-4a96-9abb-2afb1e72b0eb`
...
- load_id: `5822d90e-7010-4fad-97a8-6224d107fa99`
...
- load_id: `b387cc8f-b00e-4084-b225-85abb7561d0b`
...
- load_id: `c96de144-0268-4355-a8f2-f1e9b3b21a59`
...
- load_id: `10ccbf86-0b4e-4775-9eb1-e5eea9b9a4b6`
...
- load_id: `6374e70f-2357-4a08-9b8d-5b93eb02e0d7`
...
- No graded predictions; document-only.
- load_id: `80ac6f13-fe58-474d-bb11-edd30252ec9c`
