# Rate Calculator Scenarios -- 20260510_042755

**Run ID:** `1057a9ba-f19c-4ee8-9a7e-505a19e5acaa`
**Total scenarios:** 45
...
- load_id: `cb753d83-7c3e-46ad-b201-73a5f21e66dd`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `906c6ba7-e71f-49c9-9575-ebdde43ee564`
...
- load_id: `dc91ebc2-167b-4702-b537-8df6a86f3d83`
...
- load_id: `63f43946-ef56-4555-8d50-33f54f112120`
...
- load_id: `3e1974ef-7a08-4ff5-9d42-54b29355704c`
...
- load_id: `e4bf6f29-debe-42f0-9efd-f44fc4e43801`
...
- cost_estimate matched (1610.0).
- load_id: `0bdf87f0-54b2-48ff-9b94-224a71028e7b`
...
- load_id: `a2a11a86-92f7-47c1-ad69-441767bf3af6`
...
- load_id: `454cf605-c497-4d97-9cf3-f35959b15011`
...
- load_id: `0d23c28a-f9b3-49d2-9093-eedc33533144`
...
- load_id: `5d364fdc-e2bb-460c-be22-41eb4b401a32`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `9dcb67de-23be-4ca8-9e24-8226a0e45b36`
...
- load_id: `51f0567e-9a09-4763-b612-a6b166c76e71`
...
- load_id: `fd923153-d668-4d30-adbf-b76d593c04a6`
...
- load_id: `cf9fc19f-05d5-415a-a0c2-336c61a3ef60`
...
- cost_estimate matched (1610.0).
- load_id: `a8986d58-65c1-458c-8e37-5b1ebaea5dcc`
...
- cost_estimate matched (1610.0).
- load_id: `736e2694-e5b3-41e3-b998-a0ae2886424c`
...
- cost_estimate matched (1610.0).
- load_id: `d0309768-2e08-4813-9527-1c404d735b2d`
...
- cost_estimate matched (1610.0).
- load_id: `554d2110-7c00-4725-95db-da14cbe2fd79`
...
- cost_estimate matched (1610.0).
- load_id: `45b97c0b-c945-4ede-b294-6a0d21a0a154`
...
- cost_estimate matched (1610.0).
- load_id: `04f0406b-8338-45aa-8c1f-a6c2d27bd03d`
...
- cost_estimate matched (1610.0).
- load_id: `a4e24e14-d728-42d2-8968-410ee18ab122`
...
- cost_estimate matched (1610.0).
- load_id: `c1cb2af5-11e6-49a5-9eac-5900207478f3`
...
- cost_estimate matched (1610.0).
- load_id: `03fbaea1-85d0-4765-94c7-6a6162799ab0`
...
- cost_estimate matched (1610.0).
- load_id: `d6fb64c2-caba-4ab1-b758-d14cf0267eb8`
...
- cost_estimate matched (1610.0).
- load_id: `6e7dd07b-04b2-471e-87f7-9ef89a07a55e`
...
- cost_estimate matched (1610.0).
- load_id: `2d7d5d71-b87c-46ee-81bb-7afc28d4c9d5`
...
- cost_estimate matched (1610.0).
- load_id: `e72935d6-3cd7-4363-8d11-9c246ab86a8e`
...
- cost_estimate matched (245.0).
- load_id: `736f7ad1-4509-4a76-958f-ccbbf775ec4d`
...
- load_id: `e994b550-52c7-4f6f-ad6c-7185079ecd3b`
...
- load_id: `4374931a-6a85-486f-a268-6da3fa67c8ae`
...
- load_id: `b937aee2-886a-485e-a56a-cdc8b22ec8d0`
...
- load_id: `edd629b5-b4a8-4cc8-8af9-612c6ec78037`
...
- load_id: `9c17546f-69c8-4884-a1c8-a541cf7deaa1`
...
- load_id: `3c0a65ab-d6e9-496c-84e4-db9d4ecd668e`
...
- No graded predictions; document-only.
- load_id: `cc6dfae3-385b-47b4-9ce4-f91ebc348000`
