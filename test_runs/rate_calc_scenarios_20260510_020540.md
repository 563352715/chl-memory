# Rate Calculator Scenarios -- 20260510_020540

**Run ID:** `d120d6a0-e003-4fbe-9cd5-14e7f5d27e83`
**Total scenarios:** 45
...
- load_id: `399aca27-509a-41de-b9c0-e53fc47fec79`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `99f98b08-de8e-40ab-bf94-44ccd560538d`
...
- load_id: `8c0e395e-b956-4338-8fba-ffbd97b32286`
...
- load_id: `6f621850-f30b-46a1-a1bc-67babf03f701`
...
- load_id: `79891d5d-c75a-4e8e-ae6e-7a5d54e5a1b9`
...
- load_id: `90ce95c5-284b-407e-bc43-e77c1abaa90a`
...
- cost_estimate matched (1610.0).
- load_id: `3549eed8-05e6-46a1-8432-3199e173a93b`
...
- load_id: `0285407f-0180-4e44-9c2b-bcf673b9d92b`
...
- load_id: `6eee3353-66f0-4e52-8473-853027508850`
...
- load_id: `6494566a-2457-4ca8-b42e-77f634e9c75b`
...
- load_id: `ce2eb936-0bcd-425f-a305-b12f718e5a7e`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `c3bb09c5-a166-420d-824b-5ae0fb710590`
...
- load_id: `3a0a9785-252d-430f-b43c-d21aead7c847`
...
- load_id: `f42e3f87-c97a-45cb-acfe-3c858a2de556`
...
- load_id: `86e70dd4-d510-4c3a-bce7-143fa9f0110e`
...
- cost_estimate matched (1610.0).
- load_id: `b0c627ef-f1cc-4dc4-9f32-75f322bc4777`
...
- cost_estimate matched (1610.0).
- load_id: `247c76bf-2c5d-4bb9-b3d1-67922d201c9b`
...
- cost_estimate matched (1610.0).
- load_id: `24dc9837-fe7d-4bb3-a050-0f2b962b5831`
...
- cost_estimate matched (1610.0).
- load_id: `a40a5c32-9f5c-46a8-8d81-10c50f3d8acd`
...
- cost_estimate matched (1610.0).
- load_id: `1e4bc51f-a99e-469e-8a52-ae7cf3bbc028`
...
- cost_estimate matched (1610.0).
- load_id: `f04f5061-5e10-4fec-9c88-b160e99fabdf`
...
- cost_estimate matched (1610.0).
- load_id: `f4840614-f94c-4ae9-9609-3213d077fb21`
...
- cost_estimate matched (1610.0).
- load_id: `5215b8b7-85e0-4cbb-9989-100437fd9fce`
...
- cost_estimate matched (1610.0).
- load_id: `e1aa4ff2-7b86-4049-81bb-58266e7ce175`
...
- cost_estimate matched (1610.0).
- load_id: `53744840-4ad1-4fc8-af27-f6fcac56a4c9`
...
- cost_estimate matched (1610.0).
- load_id: `60475aa6-9db7-4234-a2a2-066eb0b7dd3b`
...
- cost_estimate matched (1610.0).
- load_id: `0c10d168-91d9-4e64-b431-a76e2fc2c9c8`
...
- cost_estimate matched (1610.0).
- load_id: `48027ce9-18bf-4b31-8fa8-294807bec944`
...
- cost_estimate matched (245.0).
- load_id: `e46f0470-78db-44ce-9ebb-56d679fe679f`
...
- load_id: `126bc9fc-3607-4941-8e97-086b5d29d405`
...
- load_id: `d8108679-060f-4e4e-9a88-b3a2d1d09e1e`
...
- load_id: `813d4c63-da22-4d2f-9a92-443520682ecb`
...
- load_id: `d05e5e64-bb3f-44a4-9b6b-cbd021bc6411`
...
- load_id: `a057ab2b-7b29-4dbf-9593-89d1fbfbaa98`
...
- load_id: `efd5ae6d-e694-4a5d-ae95-d49bf86f2239`
...
- No graded predictions; document-only.
- load_id: `9781bab2-b015-4cb3-a511-d5fd794212e4`
