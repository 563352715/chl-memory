# Rate Calculator Scenarios -- 20260510_044511

**Run ID:** `1deddfa5-29d0-423d-9933-9c92d1534da9`
**Total scenarios:** 45
...
- load_id: `f106e012-54f3-4670-ac51-f768b3271a37`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `685fe34c-f789-4032-9361-2652fb75652a`
...
- load_id: `00ac56fb-4e1c-40a3-9bb1-f450db7d405f`
...
- load_id: `8368a050-a96d-483d-9760-0180ddd8aa2d`
...
- load_id: `9ce6870e-c61c-46da-b2d6-67945a3d58a8`
...
- load_id: `f3fffcfe-9680-4c51-858a-fec55501052b`
...
- cost_estimate matched (1610.0).
- load_id: `ad4cfb78-f29d-4afc-9d10-607be145a4d1`
...
- load_id: `605d0318-dbae-4610-b967-c30a599c9bc7`
...
- load_id: `b7ca7a32-8174-4270-98cb-1d77c5364943`
...
- load_id: `af3feffa-70bf-4d94-ada7-44b602a7acad`
...
- load_id: `3ccf053f-91f2-42f6-bba9-59210d2a5b07`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `39474025-b8ed-48ad-a841-e08d9f90ab05`
...
- load_id: `f9a51f54-30da-4a83-9353-1ac69bfc9503`
...
- load_id: `d9821116-4447-4b15-8ecf-d8438cc7f008`
...
- load_id: `eb5993f2-c8ff-43b6-9cfc-4e81241c6d3d`
...
- cost_estimate matched (1610.0).
- load_id: `d4e737c2-4144-4625-b0bb-54f9e58c494e`
...
- cost_estimate matched (1610.0).
- load_id: `28e6342f-ae4d-4976-a847-b0c90324c571`
...
- cost_estimate matched (1610.0).
- load_id: `3c2bb052-3b60-4666-95c6-fa3b577a93dd`
...
- cost_estimate matched (1610.0).
- load_id: `7859b7d7-be83-4807-91de-595d508e9c1a`
...
- cost_estimate matched (1610.0).
- load_id: `478ca9cd-8767-4f70-ac64-53d661a37bac`
...
- cost_estimate matched (1610.0).
- load_id: `f132c8d6-a786-44a3-9073-69bbdc4cbf67`
...
- cost_estimate matched (1610.0).
- load_id: `b3652c97-6e22-4217-bac5-3a53ca377e74`
...
- cost_estimate matched (1610.0).
- load_id: `38512251-1c77-482e-9f00-245a63ce7ea8`
...
- cost_estimate matched (1610.0).
- load_id: `349206ef-9201-4a46-a5a8-599ab1f9ea10`
...
- cost_estimate matched (1610.0).
- load_id: `139ea43b-917c-4280-a57f-b7c3b35c98ab`
...
- cost_estimate matched (1610.0).
- load_id: `b5f00275-9698-45ce-8109-83f47d340f7c`
...
- cost_estimate matched (1610.0).
- load_id: `5fa76c8b-d231-42ac-880e-08be0ba5a37d`
...
- cost_estimate matched (1610.0).
- load_id: `8a58cd96-60a4-492d-a7d9-7e5bb2b75a65`
...
- cost_estimate matched (245.0).
- load_id: `0fe7e3fb-e13d-40ef-a99e-0e860bbf6748`
...
- load_id: `9da5261e-ca19-454a-bf23-4f5a05fa6531`
...
- load_id: `7bb4d437-2f56-4907-b00b-441411f84392`
...
- load_id: `62ce9ecd-f4a4-45a1-8c20-ade5bfd0734a`
...
- load_id: `5f9605a0-5294-442b-8f1b-8718067409be`
...
- load_id: `8e251aea-2797-4562-bc29-db857b39405c`
...
- load_id: `1fe42b98-7ddb-4995-b7ab-d7745195fe7c`
...
- No graded predictions; document-only.
- load_id: `6c495b55-4a1c-4982-89e4-a0055fe52987`
