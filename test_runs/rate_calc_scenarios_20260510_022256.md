# Rate Calculator Scenarios -- 20260510_022256

**Run ID:** `78dbe3dd-8956-4f77-92a3-48b344db46e9`
**Total scenarios:** 45
...
- load_id: `6a2d9bb2-f5dc-4367-90d8-7b7fb3e42667`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `7fe90e19-58f5-498a-9d8e-a7f8096fdadf`
...
- load_id: `ec636169-e0c9-486f-a574-a911af302569`
...
- load_id: `c4f21cae-ef2b-450d-accd-22dcb839a1eb`
...
- load_id: `5213ad3a-d2ec-4589-91d0-667572c55d22`
...
- load_id: `052fd70f-50fc-4aed-b8b4-8b7b2fc3d28c`
...
- cost_estimate matched (1610.0).
- load_id: `45368cf9-25f4-4035-b046-9bd232e9113f`
...
- load_id: `37c06c7e-fcf8-4f73-952d-c46b28a1a001`
...
- load_id: `964dfe2e-4481-4bb9-9418-098f38ae341e`
...
- load_id: `84d5f6e4-50c1-4420-befe-7ac2797a57c2`
...
- load_id: `1992500e-0325-4a41-9c9d-bcac1ea40d69`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `e0ac7cca-0a06-4b38-ae4e-30881e6577b8`
...
- load_id: `ea5ec54e-f112-42c5-a826-b59f34330335`
...
- load_id: `e6c5cf33-f562-4ba5-a98e-9d4f84273f88`
...
- load_id: `8bb3e7d7-0d74-47e7-b398-b83c0265f00c`
...
- cost_estimate matched (1610.0).
- load_id: `76781472-eb71-4da3-b9b5-893c9ec3ae50`
...
- cost_estimate matched (1610.0).
- load_id: `864a820a-ea60-4a8b-844b-7b53b25ed712`
...
- cost_estimate matched (1610.0).
- load_id: `41bb03e4-1096-4541-b378-94de2eb59f72`
...
- cost_estimate matched (1610.0).
- load_id: `89ed71f9-4a5f-4dd0-b5b6-83c8278c3c84`
...
- cost_estimate matched (1610.0).
- load_id: `34dc032f-1cd4-4138-b3ef-2e27b3a42a00`
...
- cost_estimate matched (1610.0).
- load_id: `040bad5e-b345-4ebb-ae65-cfc8f037dd9c`
...
- cost_estimate matched (1610.0).
- load_id: `7e6a6918-d527-4d50-91d9-eee653c07243`
...
- cost_estimate matched (1610.0).
- load_id: `ef48c1e8-31bb-46d2-a3ac-f25bd26f8e44`
...
- cost_estimate matched (1610.0).
- load_id: `26d6abe7-83a6-434d-a44e-f9dd8e54511d`
...
- cost_estimate matched (1610.0).
- load_id: `00027413-0f14-4207-8220-fc08646735d3`
...
- cost_estimate matched (1610.0).
- load_id: `327ef5ec-b53e-42e0-a159-422cdf5a3a93`
...
- cost_estimate matched (1610.0).
- load_id: `3adf67e4-b9ff-438f-8029-0f3b061d4710`
...
- cost_estimate matched (1610.0).
- load_id: `c10f8999-793f-4928-9a10-04cffa99ce66`
...
- cost_estimate matched (245.0).
- load_id: `1a136298-8c09-45c8-9e94-7065c9bd5d7d`
...
- load_id: `4eb05c08-fcd4-4491-b51c-d4274a7ce49f`
...
- load_id: `0a472f67-2966-4f74-912f-198f5dd3ddac`
...
- load_id: `01ce2f8d-54cc-4b42-8c38-3dae181250c2`
...
- load_id: `04a8eceb-e53f-48bc-9d6f-1fb53013ce37`
...
- load_id: `9825a51a-9a98-4822-9df9-d77ea08629a2`
...
- load_id: `77363b76-481a-4d9d-bdc0-5e78f2de5ced`
...
- No graded predictions; document-only.
- load_id: `c8589a93-3ce6-40e1-89bf-034b94c937c3`
