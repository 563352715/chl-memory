# Rate Calculator Scenarios -- 20260510_012641

**Run ID:** `a40808a0-dab7-4a8c-b410-a94cd998b89a`
**Total scenarios:** 45
...
- load_id: `84c28707-e11b-45a5-99c6-0ff24d18932b`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `826553e5-cbfe-48e9-8956-e72579c35aba`
...
- load_id: `3affce2a-27a1-4906-9dca-7c0ab4cace33`
...
- load_id: `481dde1f-c060-4e00-91a0-c2dffc67242b`
...
- load_id: `090ae5f4-1126-4df5-8899-ba7b958093ef`
...
- load_id: `c5c56cd7-3723-4ae4-8371-4ace21bd5aef`
...
- cost_estimate matched (1610.0).
- load_id: `9ac8fb18-14ef-43f5-b311-ff70b49fad4f`
...
- load_id: `381e493e-c32d-4b3a-89ce-c999bfba2ae8`
...
- load_id: `fc83bda3-de52-4386-9913-cc39e4476277`
...
- load_id: `ee9ad6bb-907c-4921-a9d1-2effb292a935`
...
- load_id: `78d929e8-51ae-416b-b461-b9caf4dedab5`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `6eb452b0-dfa5-4f98-919f-81749c23b5a8`
...
- load_id: `d631bbcf-045a-4e2f-b124-17e0556bb441`
...
- load_id: `c5a86ca4-265a-4a58-849d-d4bd48a397fe`
...
- load_id: `9452e827-9fe7-4543-84ad-29a12a878372`
...
- cost_estimate matched (1610.0).
- load_id: `a986e114-3133-4302-8465-45fda5a98d64`
...
- cost_estimate matched (1610.0).
- load_id: `b84b8e38-9a17-47bf-bb6b-b86516cf2617`
...
- cost_estimate matched (1610.0).
- load_id: `9b92757a-de8a-4112-8f11-41b036b0d01b`
...
- cost_estimate matched (1610.0).
- load_id: `c0b9cdbf-98b1-4cb8-b432-444a56b1b0aa`
...
- cost_estimate matched (1610.0).
- load_id: `62ebfc41-0b34-4a09-bd7d-0560a75f5b74`
...
- cost_estimate matched (1610.0).
- load_id: `0d038f9b-a1bc-49d1-bf2c-a7336370ecaa`
...
- cost_estimate matched (1610.0).
- load_id: `3291937a-810f-4c0e-9912-026e405ab72a`
...
- cost_estimate matched (1610.0).
- load_id: `841ce5ff-49e6-421a-843d-de25bd6b0a04`
...
- cost_estimate matched (1610.0).
- load_id: `96aaace5-7560-4860-b0d2-c24878f8120f`
...
- cost_estimate matched (1610.0).
- load_id: `61ea51d4-263f-4e2c-b413-349966d411d0`
...
- cost_estimate matched (1610.0).
- load_id: `d588cb6e-4065-444a-96d7-d1846c5bfb35`
...
- cost_estimate matched (1610.0).
- load_id: `93ef296b-d594-4dd2-aa12-b144f096c661`
...
- cost_estimate matched (1610.0).
- load_id: `238b2e67-6a04-4002-87ce-877d9e4940d7`
...
- cost_estimate matched (245.0).
- load_id: `8b21031f-2a17-4236-867f-8e198d22e1b5`
...
- load_id: `a8030ae8-9110-455e-81f3-7af3f00b0947`
...
- load_id: `eddd8617-d121-42a2-b390-725baa02eed3`
...
- load_id: `c191ac3e-402e-4dc3-affd-e4e45fd0318c`
...
- load_id: `1880f4d0-8e3e-4d04-827d-fadf68f006d3`
...
- load_id: `1f0914db-f697-4c9b-b606-80d9b6783304`
...
- load_id: `d52ab5f0-0ed0-4e30-9b30-16e3ae14a4a0`
...
- No graded predictions; document-only.
- load_id: `6128cbe4-a2ce-4651-85f1-c90cd6ad9053`
