# Rate Calculator Scenarios -- 20260510_023912

**Run ID:** `dd483ab6-bc58-4a9e-8efa-31094b2446f8`
**Total scenarios:** 45
...
- load_id: `f1e76e25-0f57-4e44-8baf-2e5eb1ac7e3b`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `63acf7a0-4592-4b2d-ae8f-7b6cc22304cd`
...
- load_id: `6e361568-7e8a-4f6c-8e6c-e3f3ba957d8a`
...
- load_id: `c04935ae-d9a8-40d6-aa8a-3b338670b6a7`
...
- load_id: `8f5cf958-804d-4b85-a369-8748172bb0cd`
...
- load_id: `7c5c1edc-fdd7-44d5-a1c7-b79246ce113e`
...
- cost_estimate matched (1610.0).
- load_id: `b3ba1245-9b69-4c41-b919-bf54f9866500`
...
- load_id: `7d00df32-ba6f-4b53-8030-652512f24ad1`
...
- load_id: `50493631-02e5-4162-ae3f-ec3a2a233163`
...
- load_id: `df183db2-9699-4c90-ac64-3f3671332439`
...
- load_id: `2e913b68-e7f1-477c-847e-46e0648c87d1`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `a24c7c35-c77f-4d29-b49c-52509e7e5e6d`
...
- load_id: `96767d18-312a-4308-9e40-2d1fb8206b03`
...
- load_id: `e2be9488-e3b9-45f9-9dae-d580e68f0a47`
...
- load_id: `733a52bf-bcfe-4757-a898-8b4147fe53cf`
...
- cost_estimate matched (1610.0).
- load_id: `6ef200c4-8740-42a8-9c58-c7654bfbb369`
...
- cost_estimate matched (1610.0).
- load_id: `ee6c930e-7973-4b56-a84b-81f464b8689a`
...
- cost_estimate matched (1610.0).
- load_id: `13283edb-8b4b-4106-a4e9-fef8d6885f35`
...
- cost_estimate matched (1610.0).
- load_id: `8e98db07-eb7a-40c0-a942-ea056acdf45c`
...
- cost_estimate matched (1610.0).
- load_id: `57212512-994b-4852-993e-c0eae9dad7e7`
...
- cost_estimate matched (1610.0).
- load_id: `664464cc-7660-4b07-9141-5905926dec21`
...
- cost_estimate matched (1610.0).
- load_id: `2ad893ad-4698-4b62-bfd6-b625ce5d1053`
...
- cost_estimate matched (1610.0).
- load_id: `8db4b3bb-c45a-4e80-8dff-644adc3f2c3a`
...
- cost_estimate matched (1610.0).
- load_id: `c47b1bc7-7001-48ad-aa67-eb220643800c`
...
- cost_estimate matched (1610.0).
- load_id: `db9196dd-dd76-4554-be64-066fa35c3616`
...
- cost_estimate matched (1610.0).
- load_id: `864d54e1-1e7a-4472-bace-d9af6363bbfd`
...
- cost_estimate matched (1610.0).
- load_id: `6b459f89-713c-460d-9f53-ac2abca2a7e3`
...
- cost_estimate matched (1610.0).
- load_id: `c673267a-b25b-45db-a203-6035db997288`
...
- cost_estimate matched (245.0).
- load_id: `3c176bc8-d83d-45a9-9aa3-517b9cc13f12`
...
- load_id: `64608d4f-51d7-4db0-b8f6-664bdf203804`
...
- load_id: `f42e578f-1fb7-4216-b179-c7fc9e7d2ea6`
...
- load_id: `a3dc4a03-9e9e-4fd7-a832-baa64cdcf7ba`
...
- load_id: `4a1fac28-68d6-44df-960f-faaeefd94b76`
...
- load_id: `f1501445-a4b3-46f5-9e0b-5a35121de36d`
...
- load_id: `5b7f595b-12a0-4893-97e7-cc1ddd7ea470`
...
- No graded predictions; document-only.
- load_id: `fa43a1e3-05a0-43c0-aa17-3e91296dfdd4`
