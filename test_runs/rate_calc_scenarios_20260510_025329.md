# Rate Calculator Scenarios -- 20260510_025329

**Run ID:** `ee656b4c-8bab-46dc-a100-67080d71fffc`
**Total scenarios:** 45
...
- load_id: `e04af311-0c36-41cf-940c-4a6b0d778dab`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `e1ea591a-a01a-4282-b937-5161a32688ea`
...
- load_id: `7431d60a-51ce-435f-abb4-89acb812cc68`
...
- load_id: `3e8bc5b6-120d-4efd-bee4-11fe43a5cfff`
...
- load_id: `abee39ca-305f-4d19-afd3-56e6537b2605`
...
- load_id: `368a2932-f3e2-453d-a991-8f9f675edc5b`
...
- cost_estimate matched (1610.0).
- load_id: `95902557-7348-47c4-b6b5-f4a4ae2d2645`
...
- load_id: `5c19a479-25c3-446f-8f05-f6925135189c`
...
- load_id: `c5848141-987a-4a16-a349-b3c3ae9bac0b`
...
- load_id: `a2616e46-a1e2-47f8-ae3d-096ede0df34a`
...
- load_id: `62853659-8373-4308-b0ba-19b3dc22928c`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `0c992003-149a-4a3f-9ede-10d911981d5b`
...
- load_id: `709203d5-01fa-4b6f-858f-efe48a84a8eb`
...
- load_id: `d12225e8-4ed4-4418-8e52-d1104c8c9ab9`
...
- load_id: `1eeaae2a-c73d-4be3-a6ac-8a0ed6ce7e05`
...
- cost_estimate matched (1610.0).
- load_id: `c3028afd-0059-48cd-a135-ee7240b55b6f`
...
- cost_estimate matched (1610.0).
- load_id: `117cb1af-057b-4276-9c49-9235eca1cd65`
...
- cost_estimate matched (1610.0).
- load_id: `9a745fd8-7938-4bc3-b4f5-ed43188da9c5`
...
- cost_estimate matched (1610.0).
- load_id: `193017ad-6b9b-4ca7-a3f1-6b185f275a2a`
...
- cost_estimate matched (1610.0).
- load_id: `e25496e5-293a-40f4-b0cb-8c6887397813`
...
- cost_estimate matched (1610.0).
- load_id: `39679f17-c6c1-4832-9c86-5511b818dd45`
...
- cost_estimate matched (1610.0).
- load_id: `9d0b0223-6c14-4832-9897-8d2acf750f13`
...
- cost_estimate matched (1610.0).
- load_id: `025b0f38-0d07-4027-8e66-93f45025f8cf`
...
- cost_estimate matched (1610.0).
- load_id: `ccb92d86-56a0-42f1-8853-30b81f739ec6`
...
- cost_estimate matched (1610.0).
- load_id: `321e1fab-27a9-4440-ba3c-2304ff66c117`
...
- cost_estimate matched (1610.0).
- load_id: `f7e3194d-0d38-4139-ad56-c29fd93a3651`
...
- cost_estimate matched (1610.0).
- load_id: `946f0a40-4af3-4927-b23c-11717eca8d8a`
...
- cost_estimate matched (1610.0).
- load_id: `5896ddde-8c14-4de0-81c7-9d1a4767441c`
...
- cost_estimate matched (245.0).
- load_id: `adc8c5ab-1465-4d11-8262-1a49227abfdb`
...
- load_id: `cc42a8ca-1f35-41aa-8b62-57b45211f41b`
...
- load_id: `6d33fb4b-b72c-468b-87c4-be7b0288e886`
...
- load_id: `7bd68712-3e8d-4ca2-bce7-d70cef1dd45f`
...
- load_id: `5a29e77a-e552-4e03-88bf-27c3275dd27c`
...
- load_id: `2ec85b80-a7b1-44bc-acd6-cac46674ce5f`
...
- load_id: `890e1c30-29fa-40d6-ad61-624563182a13`
...
- No graded predictions; document-only.
- load_id: `a97af2ff-7656-462c-b331-d124bf9696ac`
