# Rate Calculator Scenarios -- 20260510_010421

**Run ID:** `35a38d55-95dd-41bd-b0e6-ad5511fe5e97`
**Total scenarios:** 45
...
- load_id: `494f5d9c-4458-476f-99db-d3c0d3e5d4e3`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `498a98d0-9080-4e08-9586-e5dbfc413d36`
...
- load_id: `b717a29d-7d47-44e3-80f9-7890290d632c`
...
- load_id: `c11bdd24-9211-4d98-8f70-cb37afcab79c`
...
- load_id: `52bbb9f1-b8be-4e5a-a81e-620ba1d6b572`
...
- load_id: `bf1dbfd3-2690-499d-91cb-f0a21e1284a0`
...
- cost_estimate matched (1610.0).
- load_id: `76878b67-0441-43a6-b86d-b43b04510435`
...
- load_id: `c59f5b6b-9b96-4fa3-b4dc-20f4cb3e3508`
...
- load_id: `8816b1ca-704e-43be-82cd-8360d46d4879`
...
- load_id: `827c6047-19da-435e-9981-1b7142f6ee7b`
...
- load_id: `1e16ce99-4f92-4936-9da9-41abc3bfbb46`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `b0d38b43-a01a-477c-883e-3ee38ae77465`
...
- load_id: `bb18302b-6be6-4998-b332-682ba0b818a4`
...
- load_id: `780b945e-5022-4264-b383-6e85a6665971`
...
- load_id: `4c4d6ec1-6f90-4b47-8695-13c61185fb7a`
...
- cost_estimate matched (1610.0).
- load_id: `40a5cf46-d79b-43d6-80f6-ee1a65bc4f7d`
...
- cost_estimate matched (1610.0).
- load_id: `9c60bdbd-2574-4fc3-8c17-c50beeab8f98`
...
- cost_estimate matched (1610.0).
- load_id: `55c0ea20-381e-4e0b-b184-3d173c3fc759`
...
- cost_estimate matched (1610.0).
- load_id: `395b11f7-0a4c-4f76-9cf6-75343915c591`
...
- cost_estimate matched (1610.0).
- load_id: `c5335fa2-5500-4dbd-96c8-ea1c64c91a2a`
...
- cost_estimate matched (1610.0).
- load_id: `7dc54d60-968c-4757-be65-7f8bb7a45363`
...
- cost_estimate matched (1610.0).
- load_id: `5bae3216-76ba-4967-aa8f-e61076a45081`
...
- cost_estimate matched (1610.0).
- load_id: `e03d02cf-11ce-4fbe-9640-1e4c59863da3`
...
- cost_estimate matched (1610.0).
- load_id: `bbabb6e3-5331-464d-bf84-aee9f98f5558`
...
- cost_estimate matched (1610.0).
- load_id: `24b03db3-3a87-4cfe-be90-3043ce3db9c9`
...
- cost_estimate matched (1610.0).
- load_id: `5be53955-d1c0-4865-881d-869021ec70dc`
...
- cost_estimate matched (1610.0).
- load_id: `f2f18b8d-5b45-42f0-a336-177383622a98`
...
- cost_estimate matched (1610.0).
- load_id: `4db9f234-3482-46d2-9434-5ad1da400e7e`
...
- cost_estimate matched (245.0).
- load_id: `10a5ba21-1e7f-4be6-bf6c-e22ade234a54`
...
- load_id: `1f15ede5-7a41-42b4-bde5-fd7dd7202b61`
...
- load_id: `28498ed4-4128-4ed8-8356-114aa778262e`
...
- load_id: `ba2951d2-4515-4e0d-95b7-8c3f6130e332`
...
- load_id: `6fdcdbbe-26d6-4d0e-9fa2-3ba38cd61916`
...
- load_id: `120c568a-9515-4e19-83a9-c15d04922b72`
...
- load_id: `19a49f2d-1f17-49af-ad9a-1c9fcf1ca893`
...
- No graded predictions; document-only.
- load_id: `369c2523-562b-4c90-88cb-a5e9a20cc1b7`
