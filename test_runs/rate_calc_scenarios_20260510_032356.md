# Rate Calculator Scenarios -- 20260510_032356

**Run ID:** `ae37a16f-ad06-4de8-b1af-85fb7b6723e7`
**Total scenarios:** 45
...
- load_id: `ab93fb8a-52b9-4aa0-bc32-63e1e242052a`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `26502521-f2b3-4894-a152-5ac6705bc907`
...
- load_id: `e50037de-1fab-4755-81bb-99afe8d41c77`
...
- load_id: `ae97f7bd-52ba-466c-9980-8c71dc390115`
...
- load_id: `cc3b9d25-9e3e-4cc3-aa22-f76d8f264759`
...
- load_id: `434a255f-0943-45d7-bc36-8487b27a0bad`
...
- cost_estimate matched (1610.0).
- load_id: `69dec87c-cbd6-4632-8ba3-c82aaa6d152a`
...
- load_id: `012538c5-7a39-4f37-831a-4fbd855b9a5a`
...
- load_id: `f2a21555-9d39-4dc4-b57e-a3e33bfed5c5`
...
- load_id: `63d589d2-99ac-4ab1-a3bd-90dda2cb10ef`
...
- load_id: `7ad8cf98-f665-4917-a43f-9590b0a2aa16`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `68a99219-48bd-46ea-a201-194b97a084c1`
...
- load_id: `a3aabe7d-3c20-4cba-b859-755c23c58193`
...
- load_id: `2041af22-5329-4223-bc62-c929810af2a5`
...
- load_id: `a77edc15-faed-419e-a6b4-f2d424d64f88`
...
- cost_estimate matched (1610.0).
- load_id: `efe94e4b-fe45-4ba1-bb42-b09a7805b626`
...
- cost_estimate matched (1610.0).
- load_id: `01136c9e-af78-43b6-80c9-36128a7ee48a`
...
- cost_estimate matched (1610.0).
- load_id: `415cb4cd-491a-4fab-8056-71b620a642cf`
...
- cost_estimate matched (1610.0).
- load_id: `49fa4bf3-d907-4222-8e69-453b473fe6ce`
...
- cost_estimate matched (1610.0).
- load_id: `1a07673a-9512-415c-8e5d-9346474db3b6`
...
- cost_estimate matched (1610.0).
- load_id: `9ac6da39-b2e0-4194-81ee-b535be256e3d`
...
- cost_estimate matched (1610.0).
- load_id: `26710712-b948-40ad-98d8-d668cb4bfad3`
...
- cost_estimate matched (1610.0).
- load_id: `50ffbbf8-c078-499c-a19b-c17a3c1bebf4`
...
- cost_estimate matched (1610.0).
- load_id: `3470da5c-1ff1-47f5-b8e6-554da5bae80a`
...
- cost_estimate matched (1610.0).
- load_id: `8e8bdf08-7176-4da0-a9be-3fee00a12ea9`
...
- cost_estimate matched (1610.0).
- load_id: `699b8632-fe0f-41c6-bba8-627ea16706ca`
...
- cost_estimate matched (1610.0).
- load_id: `b006dd45-a58f-4887-a677-4554197adc7b`
...
- cost_estimate matched (1610.0).
- load_id: `3005cbab-7a23-4b0e-beaf-5c6132a0ccf5`
...
- cost_estimate matched (245.0).
- load_id: `26194b48-54b1-4eb0-902c-8ff480eda4a7`
...
- load_id: `b595273f-3a9a-4378-9a9e-00741d4733f5`
...
- load_id: `8396382f-8653-4da0-ac8f-934a33916682`
...
- load_id: `919bebc4-a7d4-4b84-bab7-13e42f0cdad8`
...
- load_id: `a9ab0ec0-b5a3-4b3e-bd60-95e4c0579264`
...
- load_id: `52119f8b-a03b-4579-9064-170cfb397de6`
...
- load_id: `221e119b-55c3-42cd-be25-fcd6783b2dd4`
...
- No graded predictions; document-only.
- load_id: `ebdf91ec-99e6-4330-bd2d-606f64a41da5`
