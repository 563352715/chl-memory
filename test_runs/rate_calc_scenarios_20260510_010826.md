# Rate Calculator Scenarios -- 20260510_010826

**Run ID:** `81a9b658-4765-4d11-b768-4635a9e3acde`
**Total scenarios:** 45
...
- load_id: `c1720bd9-dac0-44a3-b22a-aac9d7e6688d`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `6d4ab799-748c-4416-944e-884c2301dd92`
...
- load_id: `2fda0602-d574-4453-bc66-34fd7a26a957`
...
- load_id: `68910854-8e9b-4007-8ca9-cbab8532e918`
...
- load_id: `9283d6c7-a9ee-4ac0-b169-6707332d54dc`
...
- load_id: `df225ae6-b3cb-4a41-aa67-c234dec97b9e`
...
- cost_estimate matched (1610.0).
- load_id: `c5911d60-9ef2-454f-bf8c-3ef9bea4066d`
...
- load_id: `213984e6-5972-407d-b1a7-783a804d8536`
...
- load_id: `f8117752-ac4f-4682-934a-8aa5305d6897`
...
- load_id: `f49137c8-e399-4cf0-9bf6-5a7228867d54`
...
- load_id: `0ee63438-eb8c-4f52-8c8c-e4bde33d7b04`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `8e9ad3a3-35cd-4b7d-a342-2f9d9c91e15e`
...
- load_id: `7755d90f-d774-45c1-88fe-d603b7383b6a`
...
- load_id: `083fc945-6565-4e40-855e-0cd5a4166288`
...
- load_id: `7beea27d-1503-424b-958c-46d198b4c9ee`
...
- cost_estimate matched (1610.0).
- load_id: `8243f3fc-7dd9-442c-9765-5b5bf63bc298`
...
- cost_estimate matched (1610.0).
- load_id: `1d3d89a7-4b4d-437c-96f8-b30b55573dc3`
...
- cost_estimate matched (1610.0).
- load_id: `7a76b173-7da1-44fb-91aa-1ffae18139dd`
...
- cost_estimate matched (1610.0).
- load_id: `10d48475-7506-4bbc-ab69-099353a5ba63`
...
- cost_estimate matched (1610.0).
- load_id: `81ef8829-13dd-4912-b849-9db69c5da758`
...
- cost_estimate matched (1610.0).
- load_id: `9701014b-fc62-42b7-8c83-e2beaf3638cb`
...
- cost_estimate matched (1610.0).
- load_id: `adfc186a-8a88-4198-ba43-2f4ab35cc5ac`
...
- cost_estimate matched (1610.0).
- load_id: `33e030c2-8a16-441f-a471-8ba848b02921`
...
- cost_estimate matched (1610.0).
- load_id: `958ded5f-c11b-457b-a709-c19844e481cd`
...
- cost_estimate matched (1610.0).
- load_id: `65fd85c6-7938-4c33-a293-ba584f3da894`
...
- cost_estimate matched (1610.0).
- load_id: `676330be-d27d-43be-9384-0a9d77909382`
...
- cost_estimate matched (1610.0).
- load_id: `66da7ada-b20d-4d73-b523-9d04292eb12b`
...
- cost_estimate matched (1610.0).
- load_id: `ac34bde1-6f43-409a-945e-a0734951eb69`
...
- cost_estimate matched (245.0).
- load_id: `1b27d579-b47d-43b0-8802-9edd6afe32c2`
...
- load_id: `1f32398c-1c68-47c4-9574-0d98a8ac70a6`
...
- load_id: `c8eff845-7e01-4f2e-a698-4dc44a54951c`
...
- load_id: `928d860a-f463-4591-b76a-2cfe8cffac53`
...
- load_id: `410c28d9-f7ab-4fa2-bf51-0b759fe73031`
...
- load_id: `35d47e2f-7d1f-4ff1-965b-1c898b32f23f`
...
- load_id: `077788ac-31f9-4684-9f43-86ee574e5353`
...
- No graded predictions; document-only.
- load_id: `201abdea-d9f3-483d-bb4c-eff0542f2d2d`
