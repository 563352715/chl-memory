# Rate Calculator Scenarios -- 20260510_042352

**Run ID:** `79126e06-895f-48d9-a90a-fb2c49dd4cff`
**Total scenarios:** 45
...
- load_id: `9a779612-1e47-4f57-bff5-7d284a2c5f11`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `6262e5d2-9d98-4e7d-8c4a-4b3e8a54b02e`
...
- load_id: `cda096d6-d9b1-4d05-805b-fbe3202af4ba`
...
- load_id: `678e2a4b-3dc8-47ec-b038-c4241ca60558`
...
- load_id: `d9455c8e-fd46-447f-a2fb-4d2346af62de`
...
- load_id: `1124ca0d-37d1-4759-802e-a1f3ae5ba359`
...
- cost_estimate matched (1610.0).
- load_id: `52d889ea-76fb-4653-af57-1e0869902961`
...
- load_id: `08902db7-6a54-4df9-9937-c04029d0b114`
...
- load_id: `5591ec41-2a1f-45f9-ab5d-4ac436c93452`
...
- load_id: `10eba66b-ff0a-46f2-b214-f6be2a27ade6`
...
- load_id: `62bec6f6-2f42-449d-bd53-ab20f11fa3c2`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `f0878e99-a2fe-429d-87e8-bc1be18b62aa`
...
- load_id: `b94f0e2d-5998-40a1-b76a-2a30fdc56b6e`
...
- load_id: `e079e8fd-8ef6-47d8-8a8d-1764564372f7`
...
- load_id: `8f3214c4-d46d-4e62-97d3-84850959b9a2`
...
- cost_estimate matched (1610.0).
- load_id: `84c209da-abdc-4bb1-83e8-a46001bfcc65`
...
- cost_estimate matched (1610.0).
- load_id: `07a1d39c-740a-4186-8340-6580e712a2ac`
...
- cost_estimate matched (1610.0).
- load_id: `7c2a6d29-256a-4b15-b939-caaf5b392b19`
...
- cost_estimate matched (1610.0).
- load_id: `8743380f-22bf-4d6e-b4a2-20a23ccebc4e`
...
- cost_estimate matched (1610.0).
- load_id: `ccd2bbc5-1135-4ceb-b9cb-345d421ad32e`
...
- cost_estimate matched (1610.0).
- load_id: `8340dd8e-b8f4-48b7-a03c-61bdd43ff378`
...
- cost_estimate matched (1610.0).
- load_id: `0e7df158-77f0-46cd-b5da-1a628475876c`
...
- cost_estimate matched (1610.0).
- load_id: `bf269ae7-dd35-4435-956b-ec474b259ebd`
...
- cost_estimate matched (1610.0).
- load_id: `e14073d0-9640-4ae3-b1b9-22054631ffc3`
...
- cost_estimate matched (1610.0).
- load_id: `1a58258c-beba-449f-90cc-3835789d474a`
...
- cost_estimate matched (1610.0).
- load_id: `289ceca2-33e9-4321-a679-ec383dbf91c4`
...
- cost_estimate matched (1610.0).
- load_id: `fb9e7249-132f-4fc1-b156-e696f073bbce`
...
- cost_estimate matched (1610.0).
- load_id: `4aea3de8-04ea-486c-8f1e-19f240a33b75`
...
- cost_estimate matched (245.0).
- load_id: `f9704285-8cc4-48de-b2ed-bf4e6aed4bff`
...
- load_id: `dfef1977-022d-4468-8a8f-9195a1697c70`
...
- load_id: `349bf23c-a66c-4ba7-ae59-385888121a23`
...
- load_id: `e9e8ef73-f880-4b2a-b224-5da3f4886cf7`
...
- load_id: `3b36deb6-c6fa-4f4b-a76c-7fd90ec9c9b0`
...
- load_id: `dc7cb0ea-7a0d-4596-9fe6-0c2f406ba185`
...
- load_id: `da99d4d1-4a84-4b87-996d-ce46f1dd312f`
...
- No graded predictions; document-only.
- load_id: `5726c4e1-fbf7-4bd2-a8b5-0e7e71589587`
