# Rate Calculator Scenarios -- 20260510_041847

**Run ID:** `75c41f0e-fab0-4319-b2ec-e7e4a5ad825a`
**Total scenarios:** 45
...
- load_id: `02c33e21-2486-46ed-a753-d969a3e44a04`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `99edb9fc-79ee-4ace-963e-29e94d48cad4`
...
- load_id: `237296ec-df98-47b3-9dfc-c5e2f8ad5046`
...
- load_id: `24ee1280-7f4d-4cec-9d4e-4cd4acc8bbee`
...
- load_id: `50206bd7-ffa0-424f-ad1f-d7ffc5bd5f3a`
...
- load_id: `93273f14-7a86-4181-a47e-6c7fdfba7290`
...
- cost_estimate matched (1610.0).
- load_id: `545c13ef-929f-4bcb-82fb-0891292fce3c`
...
- load_id: `fc7e5d99-82c8-43c9-8545-7effc1476a3a`
...
- load_id: `9be830b5-72a3-4a40-86e4-71660f0f96dc`
...
- load_id: `4b0aa0e4-ac70-4f93-ab41-1628d3db592c`
...
- load_id: `a0fe59c0-94fc-4d42-9865-b02729fa8a46`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `d6d993e1-c7cd-46de-a72c-c22fa26edf59`
...
- load_id: `7b05127c-5123-4916-afb0-cc64a5ccd225`
...
- load_id: `d02735eb-da7f-418f-969b-c789b0c39ab2`
...
- load_id: `40549171-6577-4bf2-b8af-2ea1ee16ccfd`
...
- cost_estimate matched (1610.0).
- load_id: `0ab95b76-aa46-4529-8789-614fd0cdff24`
...
- cost_estimate matched (1610.0).
- load_id: `89f1c354-e1ec-4cbf-8f88-b41c27077528`
...
- cost_estimate matched (1610.0).
- load_id: `e0c13356-b5ec-4960-b18e-a6686a71e8fd`
...
- cost_estimate matched (1610.0).
- load_id: `fd1544c3-685a-4f40-a88e-9c71215f0ed9`
...
- cost_estimate matched (1610.0).
- load_id: `6cf39d52-5cc6-4955-8003-e47e2b4106ba`
...
- cost_estimate matched (1610.0).
- load_id: `ab02f9dd-356f-46e2-8c4c-bceb7d484943`
...
- cost_estimate matched (1610.0).
- load_id: `c2eef083-7fec-4d36-bd92-c835787c501d`
...
- cost_estimate matched (1610.0).
- load_id: `5a89edc7-9252-46fa-8ae9-c1ef251ecf76`
...
- cost_estimate matched (1610.0).
- load_id: `7587460a-9eb5-4b84-b548-5ef3312aa406`
...
- cost_estimate matched (1610.0).
- load_id: `ca0929c2-7ec2-43a7-9fcf-2b7d4a174157`
...
- cost_estimate matched (1610.0).
- load_id: `30ef9edb-91bf-4bb9-8a50-cf0b3a04805f`
...
- cost_estimate matched (1610.0).
- load_id: `1fa6341f-0f72-4f0f-b3ce-28e93daab1c2`
...
- cost_estimate matched (1610.0).
- load_id: `17b1dd73-d0a4-4263-b0bf-c24dc5055a53`
...
- cost_estimate matched (245.0).
- load_id: `7a6bc1e0-9d0e-4a6e-a0d5-7d0442f261d2`
...
- load_id: `f71db11f-9d5b-43ef-93a6-0a72b2baf74f`
...
- load_id: `ce1569cb-3e10-42ec-861e-512aeeb9a2fe`
...
- load_id: `ff1f0a02-9dd0-478e-86d3-3fd153d6a9bf`
...
- load_id: `ddc56f26-cbc8-454d-85db-a6ca777a1606`
...
- load_id: `809e48b0-ea12-4782-b589-4a236bb77bcc`
...
- load_id: `6273618b-6cf4-42be-b8fd-ade9245529a1`
...
- No graded predictions; document-only.
- load_id: `c7cb3ecb-8852-4b1b-ac05-acf3c24c30cc`
