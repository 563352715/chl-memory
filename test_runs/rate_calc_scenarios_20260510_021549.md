# Rate Calculator Scenarios -- 20260510_021549

**Run ID:** `f16b0cc7-a280-496e-a6b3-3b4b25834a3b`
**Total scenarios:** 45
...
- load_id: `0f610158-6c7d-481c-84a6-9277e1fe2f31`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `3971644e-1a91-4663-96b6-cec4bc075c35`
...
- load_id: `4b6f1cee-eb93-405a-9ba2-f40dfae8f765`
...
- load_id: `a21bea8f-8b9a-45e4-8f6a-9cc03b10cbe4`
...
- load_id: `030fdf7d-9da5-406c-bd02-5db5323c7c1e`
...
- load_id: `f3cba3ad-b487-4b5e-b9c7-53d71b3c9947`
...
- cost_estimate matched (1610.0).
- load_id: `e06b1dc7-440a-4f78-9b3f-80b0717bf243`
...
- load_id: `496aab9a-85bd-4aa2-a212-eb3214deb29a`
...
- load_id: `48a0b086-76ac-44bd-930c-872f9caabcea`
...
- load_id: `fc016fed-d92d-46dc-868c-1120819f38f7`
...
- load_id: `3c453550-50ce-404d-b03c-33ab4dbaf020`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `4a65881d-3563-43ab-8d2e-3aebdaac87d9`
...
- load_id: `ae330059-95ba-40be-8a45-ca90b98cd4b8`
...
- load_id: `ad7b826c-f43d-4747-89e7-3bc1e7868e03`
...
- load_id: `40a431f1-fd44-4867-9f41-a6d0fba3667b`
...
- cost_estimate matched (1610.0).
- load_id: `04bebf88-0a5d-4da2-8a8f-7ae430dd0c2d`
...
- cost_estimate matched (1610.0).
- load_id: `40da6c73-d0d4-4fe4-a483-b67bc021dc05`
...
- cost_estimate matched (1610.0).
- load_id: `1e165c87-d418-42d3-8646-c591ce732d99`
...
- cost_estimate matched (1610.0).
- load_id: `cbf61048-d4b1-473c-8668-206efe2bd2f9`
...
- cost_estimate matched (1610.0).
- load_id: `57350f3e-f631-4b91-964e-bf550b63b330`
...
- cost_estimate matched (1610.0).
- load_id: `51e7afe5-a283-43bb-9935-960578ba8dae`
...
- cost_estimate matched (1610.0).
- load_id: `4c1e4f3b-8ade-4fa4-abc3-377546945837`
...
- cost_estimate matched (1610.0).
- load_id: `d6d983b9-5892-417f-9591-b8bba09f7dc6`
...
- cost_estimate matched (1610.0).
- load_id: `0e0bfde7-efa4-483f-8930-876a714fecb9`
...
- cost_estimate matched (1610.0).
- load_id: `aafd00ee-e2d2-43d6-9a96-e64781f38e9c`
...
- cost_estimate matched (1610.0).
- load_id: `d664b0b5-ad95-44ee-b535-f0db39723b1b`
...
- cost_estimate matched (1610.0).
- load_id: `32748b52-1512-4d37-9b8a-b808b0b95ea9`
...
- cost_estimate matched (1610.0).
- load_id: `f530d0b7-0d37-4f55-b4ee-7d7990cca203`
...
- cost_estimate matched (245.0).
- load_id: `4345c6bd-ec8a-4356-b610-29fd7e81263d`
...
- load_id: `07557fab-ed1b-443c-b143-0576ea58966a`
...
- load_id: `43058573-fc7c-493b-bf5f-c2c1f465afe2`
...
- load_id: `01adef47-58e6-4f7b-9815-80139e3ad009`
...
- load_id: `b4cc1204-a0cc-493a-add9-98fa0686898c`
...
- load_id: `69905b4b-5d07-473f-ad6e-e99de0f3ace7`
...
- load_id: `5f7df593-0f0c-473d-b590-e6e3777c7993`
...
- No graded predictions; document-only.
- load_id: `0254b67f-60c5-4b96-973c-23ca8c0cbad9`
