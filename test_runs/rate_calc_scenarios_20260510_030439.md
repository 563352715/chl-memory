# Rate Calculator Scenarios -- 20260510_030439

**Run ID:** `00636add-7cf4-4f53-8e38-7f35ff6e288b`
**Total scenarios:** 45
...
- load_id: `df374baa-0b8f-4999-9e1b-d4ae678bce46`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `5143bb63-f85a-4012-b593-7525414d3aa5`
...
- load_id: `245193c7-ed52-4650-8988-12a13ad9d3de`
...
- load_id: `d9ce7e6e-3693-4cfd-9fb4-edf43f1efdc1`
...
- load_id: `563c695a-9d7e-4032-9cd3-e05dd7ce5f8f`
...
- load_id: `ddd907a2-b18f-4d9c-9037-39cf6a30b064`
...
- cost_estimate matched (1610.0).
- load_id: `baf86848-47a1-4b12-b88b-830273b7dc57`
...
- load_id: `d2b70c88-74da-491e-8fd8-5a25ef605385`
...
- load_id: `9afa2f14-ebed-441c-80b6-c2b542e7cc78`
...
- load_id: `479a6484-b32b-46ac-9be3-c7f7b01d576a`
...
- load_id: `915818f9-cabd-4177-8616-6f0dd409e265`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `e8c88165-f17a-4238-b5fe-3eee972d7042`
...
- load_id: `d6b2d4cd-2bdc-438a-8814-89383196b0a8`
...
- load_id: `67bcaf54-dc10-4ba0-a8b7-dfa583a17d79`
...
- load_id: `48f5ef88-61b0-4a51-989b-4c0ba0f521e0`
...
- cost_estimate matched (1610.0).
- load_id: `98ac29ad-9fb2-48a3-b454-7976873322bc`
...
- cost_estimate matched (1610.0).
- load_id: `fa804a46-d1aa-40b7-b4db-1a4a28cdfd12`
...
- cost_estimate matched (1610.0).
- load_id: `9913a815-c419-4346-a8d0-4903520a44b4`
...
- cost_estimate matched (1610.0).
- load_id: `db955b20-9839-4497-bfdf-fbee4489c847`
...
- cost_estimate matched (1610.0).
- load_id: `26698302-f35d-4d38-91ea-1342c782132c`
...
- cost_estimate matched (1610.0).
- load_id: `2d023a7d-c736-4363-ae2c-2d07368a7b0e`
...
- cost_estimate matched (1610.0).
- load_id: `24a0b53d-dc93-491e-99b1-821bb35bd660`
...
- cost_estimate matched (1610.0).
- load_id: `1d0e91e3-f983-4ba2-a71a-033bd84525fa`
...
- cost_estimate matched (1610.0).
- load_id: `ee44489c-2bae-4003-bfeb-f3f06c37158f`
...
- cost_estimate matched (1610.0).
- load_id: `30fd2f63-d2d2-4ddd-af8a-f2d92c3c4f05`
...
- cost_estimate matched (1610.0).
- load_id: `351591f6-88c3-41e5-a0b5-f4cfb9ee9f4e`
...
- cost_estimate matched (1610.0).
- load_id: `01a1979b-dd11-4b9f-a157-fc89499f897e`
...
- cost_estimate matched (1610.0).
- load_id: `0397df02-5209-4353-97d9-92bf3cedb0cc`
...
- cost_estimate matched (245.0).
- load_id: `3fed645f-f83d-4f1f-a822-febddf14ccb8`
...
- load_id: `186d7353-6f8e-4a28-b253-24bd04c6c975`
...
- load_id: `fcc75ae7-913e-4a3c-a8cf-b2a82c985544`
...
- load_id: `bb8f99e0-0344-489e-bff8-02b0d9029f74`
...
- load_id: `2962a84a-5dea-48cf-b275-3a44a703b2d7`
...
- load_id: `fc9524d1-f5d4-40fa-ac5a-49825cef0cd3`
...
- load_id: `1117678b-91df-4160-b663-bef2a764077f`
...
- No graded predictions; document-only.
- load_id: `0eca6070-c1ee-4cb9-9433-8dec3f8a004a`
