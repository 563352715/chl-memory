# Rate Calculator Scenarios -- 20260510_115849

**Run ID:** `ecf8351d-f60b-43df-a0f2-890aa42ab3ac`
**Total scenarios:** 45
...
- load_id: `9dc1f033-bdbc-4007-aacf-23dc30ee57d6`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `e678672b-b79f-4af0-867b-28275e2070e4`
...
- load_id: `d63df55a-0ebb-43b9-9b08-07fae2471af1`
...
- load_id: `d91386b4-c98b-44df-9ee0-5bbe2909e687`
...
- load_id: `d00ad1c7-c72f-46a5-ad6c-7ba4b3c24c71`
...
- load_id: `edba51be-a6fd-4c27-b519-3c471dde7628`
...
- cost_estimate matched (1610.0).
- load_id: `c4526b6a-c760-4e20-9de8-12cdd560b8d8`
...
- load_id: `4759efd8-c5d8-4181-9083-210d88d2edcf`
...
- load_id: `83558c23-b85c-4a7a-8a0b-328cef5589c2`
...
- load_id: `5f930bea-c28c-4654-b064-dbd40ed407cd`
...
- load_id: `98d0bd8b-dbce-4231-9deb-b64b7507127b`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `c2c6be6b-bd95-4b56-bac9-739134f9b7e8`
...
- load_id: `11de1d3c-32d0-4a14-a4eb-44530c2d6748`
...
- load_id: `968f0f13-1da7-4b84-875a-273cd1012d84`
...
- load_id: `e8e1413f-e5e8-4326-af0b-53f4fcaff4ad`
...
- cost_estimate matched (1610.0).
- load_id: `297024d8-3581-454c-b701-f3780e058b76`
...
- cost_estimate matched (1610.0).
- load_id: `db0fd677-5df8-4c2a-90b5-f09e149e8ef1`
...
- cost_estimate matched (1610.0).
- load_id: `414110e5-e912-4894-91d7-3de42447bc60`
...
- cost_estimate matched (1610.0).
- load_id: `5cd36327-bc90-4127-bfae-6381067a6ced`
...
- cost_estimate matched (1610.0).
- load_id: `0bf2ba45-cce3-488b-bbbe-d77d1ee2d3a0`
...
- cost_estimate matched (1610.0).
- load_id: `c4fa24d9-9773-49f5-993e-96e9d1579d0a`
...
- cost_estimate matched (1610.0).
- load_id: `d30093eb-a495-49ff-82f2-3590ed83c5c8`
...
- cost_estimate matched (1610.0).
- load_id: `0ba637a9-145c-4ad6-b201-5256f3d7f839`
...
- cost_estimate matched (1610.0).
- load_id: `f8fa53fc-f43c-4181-b10e-c9a00ababcfa`
...
- cost_estimate matched (1610.0).
- load_id: `b49140d3-5b18-46b8-b03a-fbfa40e8f7d6`
...
- cost_estimate matched (1610.0).
- load_id: `13370993-94c1-4ee0-8309-b307ffdbe07f`
...
- cost_estimate matched (1610.0).
- load_id: `e605228b-5276-4e36-a055-ca99544dc6c1`
...
- cost_estimate matched (1610.0).
- load_id: `70b28a99-358e-4a7f-9be2-59b9d46ec09a`
...
- cost_estimate matched (245.0).
- load_id: `a2c9380d-bbf6-4bca-83c6-c1cdb23ea78a`
...
- load_id: `86a54d3b-19bf-4874-a2c0-66a8d2c39e9f`
...
- load_id: `c3edf9db-f710-43c7-a6cf-de0f7b3fb186`
...
- load_id: `87fa450f-f078-4f32-afce-61b3b74559d0`
...
- load_id: `f2c865a5-b6d7-4211-b228-bd9540815c13`
...
- load_id: `ae1526a6-d8f7-410c-8a0b-999a333257cc`
...
- load_id: `8234aa38-fb3f-4e22-b480-cae90a84af5e`
...
- No graded predictions; document-only.
- load_id: `fb4827c1-2547-4822-b8aa-1bbf805b995a`
