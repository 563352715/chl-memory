# Rate Calculator Scenarios -- 20260510_111052

**Run ID:** `d9e19485-2aa7-44f4-9419-c7e318c8c939`
**Total scenarios:** 45
...
- load_id: `b203c6d1-ee44-45c7-8e8b-4f17a9e4c9b4`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `39f92246-0275-4cdb-8488-2a8cdf214c9d`
...
- load_id: `b5c28af5-6df1-4b0e-aef1-863ef8ab23c1`
...
- load_id: `8ab65a00-2d17-410a-81a5-24346728d850`
...
- load_id: `3ea800f4-b47a-40d9-a12c-e55beeb68504`
...
- load_id: `5ad09bd9-12c2-4200-8022-5a0969a82b53`
...
- cost_estimate matched (1610.0).
- load_id: `302c55ab-cfae-4457-8c84-fc2bcf6115c9`
...
- load_id: `09539547-60ff-47f7-9644-44fba539e29f`
...
- load_id: `440c1c36-afca-49bf-adcc-f2aaeeea941a`
...
- load_id: `39b0e92f-547b-497b-82ec-6a27fb2948f4`
...
- load_id: `50f1eac9-6526-4268-a20c-adcc511fe43c`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `da9d918e-8a46-46eb-84c4-b1e8220f1a26`
...
- load_id: `89ce6f7a-a616-4906-aa39-88c3734614f4`
...
- load_id: `20b15ae5-7148-49c7-aa7c-06b72c2dff70`
...
- load_id: `d2ae88ad-20df-4954-9a28-40d7b8fe249d`
...
- cost_estimate matched (1610.0).
- load_id: `36068657-afa4-40f5-abe9-6912279a3a6a`
...
- cost_estimate matched (1610.0).
- load_id: `ff2bcc6b-263f-4a8a-98fb-3c3dae6b1ae0`
...
- cost_estimate matched (1610.0).
- load_id: `0e5aac75-29d2-42c5-b70e-785534228bdc`
...
- cost_estimate matched (1610.0).
- load_id: `383ffd8c-ba62-43fe-a0f4-2c388c5b36db`
...
- cost_estimate matched (1610.0).
- load_id: `481fdfce-888c-419e-ae67-d54c710ab547`
...
- cost_estimate matched (1610.0).
- load_id: `ad4ed961-59b4-4a84-a57f-80b95add96a6`
...
- cost_estimate matched (1610.0).
- load_id: `0b950f39-1da7-4a46-8264-99205aadab4a`
...
- cost_estimate matched (1610.0).
- load_id: `9e052391-f2e6-4100-b79f-e165cafe610f`
...
- cost_estimate matched (1610.0).
- load_id: `2f7a1feb-3515-41e6-a2f4-9bed8d3e806e`
...
- cost_estimate matched (1610.0).
- load_id: `3e3f7bdd-59dd-4f81-9e4f-67ffea45cc60`
...
- cost_estimate matched (1610.0).
- load_id: `ce09a0f0-7591-4b6e-a41c-4fdd34cf2291`
...
- cost_estimate matched (1610.0).
- load_id: `12385d70-e0aa-471c-b5df-b0ddab81adcd`
...
- cost_estimate matched (1610.0).
- load_id: `7a49518d-49ca-4cf8-830a-0905fef32471`
...
- cost_estimate matched (245.0).
- load_id: `72119042-56e2-4ac9-88f7-b8a74e956616`
...
- load_id: `22de42d1-cb02-4994-af1a-30ad2ea418a5`
...
- load_id: `c0cb8dd5-115d-4d0f-b820-309df0aaf467`
...
- load_id: `cdfba49e-9338-49bf-acde-9ec7f08dfbc3`
...
- load_id: `3e913318-bafc-48f2-9eb4-6949756c6411`
...
- load_id: `73bf0141-7470-461e-a567-20f250f19977`
...
- load_id: `705319be-b8b2-453c-81e0-74c0fb293c7b`
...
- No graded predictions; document-only.
- load_id: `3a567102-6e4d-4a91-93fb-1501bc1a6ee4`
