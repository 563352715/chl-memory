# Rate Calculator Scenarios -- 20260510_045218

**Run ID:** `eb39c25e-c01e-4360-b9af-629eaa744c1e`
**Total scenarios:** 45
...
- load_id: `7982342f-aeba-48fd-b194-a43dcdcca99b`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `62ebbacc-d4e0-4dc8-9513-2a3f1a54ea3b`
...
- load_id: `33c38af6-e267-41eb-96b9-56252b2a146b`
...
- load_id: `b6159f4c-668b-4d51-a3be-e812f2179258`
...
- load_id: `dbf34caf-01a1-46d7-be92-e0acf2f78539`
...
- load_id: `0b3655c2-67eb-4007-b0ba-d51b363844a6`
...
- cost_estimate matched (1610.0).
- load_id: `ff25fbc2-c0f9-4bfa-8b7a-703f53bb326c`
...
- load_id: `af7729eb-1d68-42df-845b-19193ffd1079`
...
- load_id: `02263a7a-713e-4774-a5f6-3132216b3efc`
...
- load_id: `285bf397-31a0-4d3a-b189-240149107569`
...
- load_id: `c90cbc66-7e8b-4c3c-9aee-07d57f6bfcfb`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `e3ddb9bb-0652-45ad-bf3a-aa5b3aac77c2`
...
- load_id: `95dd9bff-d436-46d9-98c2-fa0289b015ff`
...
- load_id: `322f69a0-2279-4c42-b343-d07353ff9ddf`
...
- load_id: `2199d089-2653-46f2-9f22-621cdf00dae0`
...
- cost_estimate matched (1610.0).
- load_id: `b39084b7-32c4-422b-b0e8-83667d167408`
...
- cost_estimate matched (1610.0).
- load_id: `0cfde747-6774-422c-b89c-27270df79296`
...
- cost_estimate matched (1610.0).
- load_id: `678e641e-5b9f-4ebc-a224-b273dacb9023`
...
- cost_estimate matched (1610.0).
- load_id: `59261a1b-57b0-49d7-8c85-cef6e7e90155`
...
- cost_estimate matched (1610.0).
- load_id: `15d4b49c-2228-4bb2-9728-4c5fe89683d3`
...
- cost_estimate matched (1610.0).
- load_id: `23356e18-a093-4c00-a478-7b01ed30307c`
...
- cost_estimate matched (1610.0).
- load_id: `ede8879b-24d2-481f-ad6a-05fcc72cb2bb`
...
- cost_estimate matched (1610.0).
- load_id: `5ae00780-5b78-4694-9291-a96e9a82781d`
...
- cost_estimate matched (1610.0).
- load_id: `cc83fb5e-df9a-452a-9a7c-58cd618431fe`
...
- cost_estimate matched (1610.0).
- load_id: `e90f1a67-313a-4c0c-a0bc-f8ce0bb99f14`
...
- cost_estimate matched (1610.0).
- load_id: `f3e59bc8-a213-4bf7-b4a6-0571f1cdb473`
...
- cost_estimate matched (1610.0).
- load_id: `bf1d4337-6284-4efa-9216-18a71245daa6`
...
- cost_estimate matched (1610.0).
- load_id: `13bf612f-c1ee-4388-b8a6-f978ff5bb9e3`
...
- cost_estimate matched (245.0).
- load_id: `9ad7b63a-cb04-4b48-86ee-305a847bbb19`
...
- load_id: `822c06ca-e053-4bfd-b894-c9f30c70d2ee`
...
- load_id: `92f26661-6952-4895-bb3d-1003e95c72d3`
...
- load_id: `fcb5da61-f52e-4014-b218-2e73e9047bf1`
...
- load_id: `2b1393bd-5337-493d-bc53-159330bb4e38`
...
- load_id: `53dbb94c-9fca-4343-bb79-cc5eaee83ced`
...
- load_id: `1407c001-6850-455c-a648-2cfb3cf22900`
...
- No graded predictions; document-only.
- load_id: `8cc21add-6d0b-43b4-9c13-4524b9b4bbea`
