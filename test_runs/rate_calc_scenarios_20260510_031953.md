# Rate Calculator Scenarios -- 20260510_031953

**Run ID:** `e70ace85-bef9-49a8-be62-67ad255759e6`
**Total scenarios:** 45
...
- load_id: `1f2f1e99-8fbd-4038-a58a-2797793c38c0`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `11ceb039-cb53-43a8-a6c5-6ed5b610f178`
...
- load_id: `b6e1ec85-b3f7-47e7-bf0b-ce55be81947c`
...
- load_id: `d4ba2a1a-79bb-4088-b67f-4201e78e18a0`
...
- load_id: `0834c28c-7361-46a5-a01e-4a2eb5f1ce5d`
...
- load_id: `81a47ad2-f71a-4f2f-ab9c-dc51722468fb`
...
- cost_estimate matched (1610.0).
- load_id: `c4884294-6085-4c61-b787-cd241de07ee5`
...
- load_id: `fd603e03-519b-4672-a303-dddd43c46693`
...
- load_id: `a65b3203-6c7c-4ecb-a58d-45bc4bbb60a5`
...
- load_id: `b73932c9-c9e1-480d-8d17-5b0ab2427a70`
...
- load_id: `6a05739b-47e3-4068-86f8-fd0d12f98049`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `4cf94638-6dac-4592-8c13-f41617a975b9`
...
- load_id: `1a9c69d3-2abb-4755-949b-adeb92abc06b`
...
- load_id: `c0e56f25-aabb-4f26-b154-f3fb0092cdab`
...
- load_id: `4428145f-cdd3-4b91-9687-e103c4bbc2a4`
...
- cost_estimate matched (1610.0).
- load_id: `4f21a945-7176-468c-ad48-d4b07c480bac`
...
- cost_estimate matched (1610.0).
- load_id: `c1c4d773-199b-4eeb-910e-7fa7dd2bc6a6`
...
- cost_estimate matched (1610.0).
- load_id: `f947deff-2c16-47ed-ab05-cce0ad5738ee`
...
- cost_estimate matched (1610.0).
- load_id: `32d40d57-672f-4ecf-9782-2ca560b22591`
...
- cost_estimate matched (1610.0).
- load_id: `fef92993-4595-4864-b7b4-3ceea3f86622`
...
- cost_estimate matched (1610.0).
- load_id: `d3caa36c-5757-43bd-bcca-bdfb5255712d`
...
- cost_estimate matched (1610.0).
- load_id: `dc227147-7532-4f9c-ab2a-5169b1c0184b`
...
- cost_estimate matched (1610.0).
- load_id: `55b2db23-1275-400b-84d8-d6935543f4ef`
...
- cost_estimate matched (1610.0).
- load_id: `4c7bcb8e-3e6d-4115-92fb-da428416a0d0`
...
- cost_estimate matched (1610.0).
- load_id: `b4de099e-9f74-4c1e-833a-08f530570d0b`
...
- cost_estimate matched (1610.0).
- load_id: `4edef701-7920-48ff-a0bf-a6f8247f8a25`
...
- cost_estimate matched (1610.0).
- load_id: `c9473d82-4a7e-48c1-85e8-9f5d0cd211b7`
...
- cost_estimate matched (1610.0).
- load_id: `02a782ed-d3db-4bfe-99d2-db9beadc529a`
...
- cost_estimate matched (245.0).
- load_id: `4ff07855-abb5-430c-abb4-d6dfca47a98e`
...
- load_id: `6e5090b1-8476-4d38-9af0-b74d3d3a4fec`
...
- load_id: `3d2d0160-ebff-4082-88f4-f9ab476325ad`
...
- load_id: `87c09ba3-cd3a-4bb4-b424-597ba9091fb1`
...
- load_id: `cb953be7-c662-40e3-b8fb-d4146fa633be`
...
- load_id: `0634f378-7690-4be2-b499-ef0c48400228`
...
- load_id: `a1d62a51-7fa8-428d-8b52-796fc2f75c7f`
...
- No graded predictions; document-only.
- load_id: `9312bf8b-14a1-4411-8685-d41176696b9d`
