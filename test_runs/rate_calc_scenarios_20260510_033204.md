# Rate Calculator Scenarios -- 20260510_033204

**Run ID:** `1cc43c5c-5c25-4046-8322-7db937810fe2`
**Total scenarios:** 45
...
- load_id: `a34454bd-f937-458f-99e2-d8e78c3321bd`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `243663fb-70d3-4ce0-bb65-104639347100`
...
- load_id: `404c36bf-e05d-4034-86ee-593001cf2421`
...
- load_id: `a7c983bb-f8af-41a0-85bd-67ed85aeeaca`
...
- load_id: `7a71cda5-735d-4eff-82f2-be7e3bcbb97a`
...
- load_id: `960afa77-3fee-4357-8d8d-e67bdcbd6752`
...
- cost_estimate matched (1610.0).
- load_id: `a5167c8a-04d0-4cfe-87aa-d509012641b6`
...
- load_id: `281a51a7-e64b-4851-b81b-f78edc993e07`
...
- load_id: `12393ca8-c79b-4e86-aa24-3b7f8ad9ae33`
...
- load_id: `cdc36f43-9a39-4dac-abe0-fbca9a1bf96d`
...
- load_id: `bde48fd3-b951-440a-a47a-8e8e3a973987`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `b5c55300-8ecc-4099-853a-0046e5ed96d5`
...
- load_id: `538ed1a0-f5d6-4af0-bab3-1d73ee611f7c`
...
- load_id: `2515c09d-8d1b-42b3-87dd-a7db115eb8a6`
...
- load_id: `a61e62ba-0763-4059-8d72-9c8eb32a9e3b`
...
- cost_estimate matched (1610.0).
- load_id: `91acca9a-f5a2-401e-8e6c-031ff94f95f8`
...
- cost_estimate matched (1610.0).
- load_id: `168fea90-9583-4fba-a668-fba722991bf9`
...
- cost_estimate matched (1610.0).
- load_id: `eb6b38a6-f87c-4808-83d8-52f51b9fa229`
...
- cost_estimate matched (1610.0).
- load_id: `532c1b30-5fbc-4f94-b784-ff90182474e8`
...
- cost_estimate matched (1610.0).
- load_id: `a3b7f63a-1a26-4cdb-918a-d99dce92ee57`
...
- cost_estimate matched (1610.0).
- load_id: `74bafdec-72c3-458a-b906-f1a9f0af7bc6`
...
- cost_estimate matched (1610.0).
- load_id: `7902547d-4b40-46e1-8b8c-213d69acc9e8`
...
- cost_estimate matched (1610.0).
- load_id: `bd4b310b-32c4-4e3a-aceb-a001134b27d9`
...
- cost_estimate matched (1610.0).
- load_id: `ce595555-3dca-4d12-b8cc-43e289add21a`
...
- cost_estimate matched (1610.0).
- load_id: `4173fe8b-dc34-4303-a6d1-8c2a5ed66dad`
...
- cost_estimate matched (1610.0).
- load_id: `73f82b02-8e28-41a6-b3a2-356dcd8c0e9e`
...
- cost_estimate matched (1610.0).
- load_id: `59ac5f88-03e3-4bc7-af73-14500a97b73c`
...
- cost_estimate matched (1610.0).
- load_id: `9cd4170d-5af2-442d-ba88-b411a9b3695b`
...
- cost_estimate matched (245.0).
- load_id: `ecce7cb0-76b1-4edd-a1d2-ede29a1ce2a3`
...
- load_id: `cb6188d0-cc36-403e-9431-bb1eea1c6ec9`
...
- load_id: `503b302c-f3b1-4ea3-9dd6-31b9b8853171`
...
- load_id: `3a435438-8e6d-4e36-934c-ff058ba5f38c`
...
- load_id: `7784783f-7528-447b-8e0e-522890e82ec2`
...
- load_id: `28502667-5bfe-4aae-b73f-89db0d3e9d56`
...
- load_id: `da0db51d-fd5e-488b-afe8-918061020497`
...
- No graded predictions; document-only.
- load_id: `53f73023-6d78-49fd-857f-84976c5f4168`
