# Rate Calculator Scenarios -- 20260510_010927

**Run ID:** `825005dd-11f2-4942-a459-b7f13cd763c0`
**Total scenarios:** 45
...
- load_id: `e9a26874-6e77-4940-87ca-d5c980dde015`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `0931d784-f2ba-4392-be16-fcbc3acc89d9`
...
- load_id: `17621d8e-3bb4-4c38-8e6c-cad16b511319`
...
- load_id: `e73cb931-a91d-4adc-bdb1-720f0a340a6e`
...
- load_id: `c94e4895-3fa1-4ee9-8970-6240dbb69933`
...
- load_id: `1aac64a6-c2db-4fde-8292-ffbadd38cb1a`
...
- cost_estimate matched (1610.0).
- load_id: `a85dc85a-1ea3-4827-a66f-9e9a72d6bb26`
...
- load_id: `acdb5572-cfab-4f14-91aa-4c05ac7d1eda`
...
- load_id: `e115b2d2-cead-434b-b01a-4995b5adb0e7`
...
- load_id: `d9627be8-e124-4a29-b2cf-762577ee1230`
...
- load_id: `65e61bc9-7315-4f31-8915-d23b65982917`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `5872c5de-72ce-4080-a8d5-896a9456d00a`
...
- load_id: `2ea40857-6a45-4418-a162-8fd7a2596237`
...
- load_id: `b52a7765-4cce-4c52-b1ac-39a29f265ef7`
...
- load_id: `198f8653-a272-4d26-81ce-ff5d27f9af33`
...
- cost_estimate matched (1610.0).
- load_id: `0ed04de2-3ae5-4542-996d-3f69d4775bac`
...
- cost_estimate matched (1610.0).
- load_id: `5d6ffb08-267e-4e7c-8192-67a4cfe3975d`
...
- cost_estimate matched (1610.0).
- load_id: `630720e7-f4c9-48ef-8df7-58660e359801`
...
- cost_estimate matched (1610.0).
- load_id: `ec7aebde-7aca-4e93-9616-8435a43919f2`
...
- cost_estimate matched (1610.0).
- load_id: `9e40b28a-d8a7-4eea-b816-3e5528af2c6d`
...
- cost_estimate matched (1610.0).
- load_id: `316b79c5-128b-4ddc-9cf5-73ad013c8753`
...
- cost_estimate matched (1610.0).
- load_id: `534fce78-2998-459e-a5eb-d88c984a030e`
...
- cost_estimate matched (1610.0).
- load_id: `9b250e4d-89c7-4ebb-9d1f-887053f9e0d1`
...
- cost_estimate matched (1610.0).
- load_id: `500f126a-fdbc-4f91-b054-a2b3ab6c7421`
...
- cost_estimate matched (1610.0).
- load_id: `15891275-3bae-48f1-b192-f460fa3212de`
...
- cost_estimate matched (1610.0).
- load_id: `f9ee4a1e-960c-4a00-bf7a-85c475d30c42`
...
- cost_estimate matched (1610.0).
- load_id: `a4a06dd7-1fe3-4152-b0f5-fb0d00756d66`
...
- cost_estimate matched (1610.0).
- load_id: `39fffca3-3d95-4e2c-b7cb-5d8bb9394987`
...
- cost_estimate matched (245.0).
- load_id: `fdeb7571-6770-477a-afa2-339076f7cfd9`
...
- load_id: `308d8814-5e3f-43d4-8447-794582c59ccb`
...
- load_id: `bd65b11c-77c9-4b47-9c1f-3bf543f45489`
...
- load_id: `f943d002-2156-4769-8765-aed18428f156`
...
- load_id: `4d7d7280-c35c-401c-bce4-c189309516ea`
...
- load_id: `8682619f-a19e-48c5-98bf-452650ee3fec`
...
- load_id: `ee8aee2e-b8b0-46a2-934d-52fb676e08c6`
...
- No graded predictions; document-only.
- load_id: `996e744a-a52c-4e3f-ab0e-4154abd45cc1`
