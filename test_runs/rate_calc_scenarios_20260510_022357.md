# Rate Calculator Scenarios -- 20260510_022357

**Run ID:** `6076118a-4476-465e-a0b1-6220194726ae`
**Total scenarios:** 45
...
- load_id: `c041925a-9f49-48f0-b74c-66c06b9f7b74`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `e6f867c0-d9cc-4d6a-b10a-282b568f35b5`
...
- load_id: `f02c9252-416b-49e5-af12-b27f6ac7a7e9`
...
- load_id: `e3e02366-ceb5-451e-8f95-157e5353663e`
...
- load_id: `f6383633-171f-45e0-b20c-7cabb0ae84bc`
...
- load_id: `768909a7-797b-4f47-94e1-edeb54b8a0c5`
...
- cost_estimate matched (1610.0).
- load_id: `cee936a5-bef0-431d-b06b-645b416b3794`
...
- load_id: `c64d496a-b625-4111-b07d-16f6b1b40128`
...
- load_id: `448c57fd-7b66-4269-9eb7-1eb12a0b6b56`
...
- load_id: `a061f0b7-2354-4773-80f2-c5a5efbbc98e`
...
- load_id: `e93d11fc-9fb1-4d17-8a2f-e1cb1445ba98`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `7687a62a-6755-4f1e-bd2f-effc62c12e8d`
...
- load_id: `5da249fe-c66c-4383-b9ee-48dcba2e0901`
...
- load_id: `6c28e318-8c4b-4707-be0a-4af2d168749a`
...
- load_id: `33760244-1a18-4b3c-b09e-4854a30e6c03`
...
- cost_estimate matched (1610.0).
- load_id: `6c9f5924-81e6-4086-a962-3007785e9992`
...
- cost_estimate matched (1610.0).
- load_id: `3502e4b7-8fb8-4c70-876a-dd0054851d8c`
...
- cost_estimate matched (1610.0).
- load_id: `0f6bc58d-eacf-4979-ae73-950ee7388e14`
...
- cost_estimate matched (1610.0).
- load_id: `7486e251-4927-416a-af98-969cf0decb10`
...
- cost_estimate matched (1610.0).
- load_id: `463f81cb-c80a-4774-bd18-7b7144e5a904`
...
- cost_estimate matched (1610.0).
- load_id: `28a65fa8-965a-464e-8229-5f94b3f68ce5`
...
- cost_estimate matched (1610.0).
- load_id: `7da5fe99-571e-478e-9f57-f6bb7e6ef0f8`
...
- cost_estimate matched (1610.0).
- load_id: `6ee10203-fd83-4f39-b775-f2aa6e4233fd`
...
- cost_estimate matched (1610.0).
- load_id: `b714830d-6227-4def-a649-a99704d1ba11`
...
- cost_estimate matched (1610.0).
- load_id: `99335a9a-ac8d-4ff9-ab49-f54241106094`
...
- cost_estimate matched (1610.0).
- load_id: `da32034b-3927-4724-b3f3-b11068679c0c`
...
- cost_estimate matched (1610.0).
- load_id: `eff968fd-bc95-4b78-83a6-5b0cf6c33ce8`
...
- cost_estimate matched (1610.0).
- load_id: `27ba263b-f309-4991-813a-c83b6170ad6d`
...
- cost_estimate matched (245.0).
- load_id: `7b539bed-1bbf-43ef-b402-142cbcfe2823`
...
- load_id: `f06ef674-0ea9-49a4-ad0c-b3daec68fe29`
...
- load_id: `c5bc313f-67d1-454f-b192-6412bf13f529`
...
- load_id: `75d9de31-3458-4589-a546-6fd0d7576d63`
...
- load_id: `27821010-1ae4-4672-909c-8e4dbc1fdd5a`
...
- load_id: `fd46d5c6-df5c-476d-b9f8-1d893ce69fce`
...
- load_id: `5947e18b-6e95-46cb-bf5d-7036c6bb1b5d`
...
- No graded predictions; document-only.
- load_id: `8a642f98-12f3-4fa4-b785-3fb288177008`
