# Rate Calculator Scenarios -- 20260510_012237

**Run ID:** `40cc9c54-e86b-46c7-af19-8ffde6e5286e`
**Total scenarios:** 45
...
- load_id: `1e6521e3-5df7-43c2-a955-a0e15ebf866f`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `090c8f0b-2af4-4375-ae9c-c890ba6dd74a`
...
- load_id: `e95e9177-913a-4d73-95aa-1638a898b83a`
...
- load_id: `f9aa19b5-f2ae-4487-8457-4b8038bc0147`
...
- load_id: `ff1c4400-2d60-4286-a355-a68e332c2f5c`
...
- load_id: `1f9afe40-66a0-48dd-b912-d9c9597daa28`
...
- cost_estimate matched (1610.0).
- load_id: `d11da8e6-3d5c-4b0f-bb67-9d506cf931be`
...
- load_id: `eb12ead2-a534-4f7d-9f04-5879f7adf487`
...
- load_id: `ec835529-60a1-4683-b0cd-da3c741530db`
...
- load_id: `be0de85b-56e5-46e5-9638-c6f1f1dc32d9`
...
- load_id: `61002b67-ce82-4e51-bb19-d802f358b977`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `e195f7cb-a8ab-43d0-9055-422cd063e37c`
...
- load_id: `8f1957fe-cbff-47ee-8841-cf51dd027ced`
...
- load_id: `f46c91fa-4f36-4321-b306-f19ecfaf2b97`
...
- load_id: `47ae7c5c-b341-4585-a15a-16cc740cbcf8`
...
- cost_estimate matched (1610.0).
- load_id: `f9eac029-e60a-4076-870a-f0ca7cfea39a`
...
- cost_estimate matched (1610.0).
- load_id: `848414e9-a36a-4ddf-a90e-077499a17957`
...
- cost_estimate matched (1610.0).
- load_id: `d7e1f046-956e-4c7c-9909-cfb085f552ae`
...
- cost_estimate matched (1610.0).
- load_id: `edd20032-a6fa-4438-a942-13e6748af98a`
...
- cost_estimate matched (1610.0).
- load_id: `06d9a68f-30f0-4c37-a5a3-a198c82c7166`
...
- cost_estimate matched (1610.0).
- load_id: `8b5c4e9c-e1a7-459c-ad76-9f251c0d301f`
...
- cost_estimate matched (1610.0).
- load_id: `d849003e-5212-4e92-8b35-60f26687ecc0`
...
- cost_estimate matched (1610.0).
- load_id: `fd8575a3-eff1-4f74-8e6b-6a250f5de019`
...
- cost_estimate matched (1610.0).
- load_id: `9e0a5e1d-d31a-436c-a730-e865c6c976ab`
...
- cost_estimate matched (1610.0).
- load_id: `d1a1a596-4b4a-4f0c-8d07-84dcf50547e3`
...
- cost_estimate matched (1610.0).
- load_id: `d98edd97-20b7-4c78-8c01-5babd9334663`
...
- cost_estimate matched (1610.0).
- load_id: `d6123373-1edb-45d7-991c-9afd2e9b5856`
...
- cost_estimate matched (1610.0).
- load_id: `a5838b10-4ebe-4f6b-80a2-7fba7d612df5`
...
- cost_estimate matched (245.0).
- load_id: `05e6f215-cd7e-4bf0-ad7d-aea840a103da`
...
- load_id: `476982a7-9013-497a-a5c3-4b07381c8291`
...
- load_id: `bb1119d1-9806-4260-89c1-cdc402f3519c`
...
- load_id: `d0fbf28b-1c90-49a3-b5e3-cae62eec1939`
...
- load_id: `d0a1ac1f-ade7-4d07-8f12-b5946351123c`
...
- load_id: `694d0c89-17a3-4f30-981e-c90744606da9`
...
- load_id: `34f6b055-9459-4339-8b6c-540bf543f354`
...
- No graded predictions; document-only.
- load_id: `858cfd27-cb0e-47c7-bc4e-da906ef1f948`
