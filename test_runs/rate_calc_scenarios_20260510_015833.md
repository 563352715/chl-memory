# Rate Calculator Scenarios -- 20260510_015833

**Run ID:** `0d4b9475-6901-4b14-8958-cb5034414acc`
**Total scenarios:** 45
...
- load_id: `7da0fe44-46e6-4664-802d-a1543fd26d2a`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `671f6abf-fc10-4414-9f73-0d444c674503`
...
- load_id: `3b22fc54-2f4a-4bf9-aef6-1b6818c35ff4`
...
- load_id: `1738ce9d-ac46-4407-b3c2-5aacc82eece4`
...
- load_id: `ad143773-54e2-4571-b35b-70527111a810`
...
- load_id: `dd1c8f9a-a06b-4f94-b3e3-0dbf69423c52`
...
- cost_estimate matched (1610.0).
- load_id: `99c24f8f-2bda-40ea-b872-de62ff3c1467`
...
- load_id: `b4fc76ff-d719-4985-9d60-fa67b64d3a5d`
...
- load_id: `be38fdd6-3d08-42c2-a58e-d343699e79c0`
...
- load_id: `c67cc5d9-5eeb-4063-853d-0d2302c45b0f`
...
- load_id: `a9bd09c5-b821-4af8-b500-3466fcc13283`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `13036d71-f2b1-4699-a8ab-9e383d494ae4`
...
- load_id: `742c37b8-4fb1-48c8-ad89-ea7afe6677d6`
...
- load_id: `78b3cbea-2e91-4e9f-add2-ba38d5c680e9`
...
- load_id: `35455c81-f09a-4ddb-83f0-b6e185a8fb97`
...
- cost_estimate matched (1610.0).
- load_id: `3065a96c-850b-427b-a739-1f5546bfced2`
...
- cost_estimate matched (1610.0).
- load_id: `9bfa920f-8c74-45b5-a049-038e53308b09`
...
- cost_estimate matched (1610.0).
- load_id: `e03b6e98-3e89-4519-a22f-ac435572ecd0`
...
- cost_estimate matched (1610.0).
- load_id: `bc84ca52-b8f4-4c96-aad3-9b30d3c8c29d`
...
- cost_estimate matched (1610.0).
- load_id: `21d71fca-a505-4463-9ce5-dac8c575de44`
...
- cost_estimate matched (1610.0).
- load_id: `6ad1ce16-2034-42e4-93e7-44df24635ebf`
...
- cost_estimate matched (1610.0).
- load_id: `443202bf-7cea-4a82-9a36-f8d6326cf262`
...
- cost_estimate matched (1610.0).
- load_id: `83b83c56-9bb8-4b02-baba-649e20a83e10`
...
- cost_estimate matched (1610.0).
- load_id: `648dc2cb-2181-435d-a1ad-aee5e55d13ab`
...
- cost_estimate matched (1610.0).
- load_id: `47ebeab8-1619-4494-a71a-c8f137e7c3e8`
...
- cost_estimate matched (1610.0).
- load_id: `d956b110-9e22-49bc-aa12-26a97555cb42`
...
- cost_estimate matched (1610.0).
- load_id: `d1cd81ac-b6a1-46c2-a8cb-185ba1f70047`
...
- cost_estimate matched (1610.0).
- load_id: `ebf95d1e-c67e-47b2-82f5-d0d56b17edbf`
...
- cost_estimate matched (245.0).
- load_id: `9090f822-9700-4ece-ae3b-fd1eb1dfb27b`
...
- load_id: `153bbd5f-5c23-497e-bec9-82bb8d5d4fec`
...
- load_id: `028dc628-bfdf-4fb4-9243-7e788c1e1021`
...
- load_id: `a2815b85-5396-448a-8f26-f5f9315c0cb1`
...
- load_id: `2a9ff793-2f6c-4fa4-8a94-3ccd50ea38a9`
...
- load_id: `fba5fea4-59fd-4904-a4c9-76e9853669f5`
...
- load_id: `2e3fcd78-7a81-49cd-b3ce-b12ec96d40f0`
...
- No graded predictions; document-only.
- load_id: `bc82034f-d524-437f-819e-eb69762ee8b5`
