# Rate Calculator Scenarios -- 20260510_113513

**Run ID:** `7f14fb44-40f5-427b-ba05-11d718c4bcd2`
**Total scenarios:** 45
...
- load_id: `a97293d1-12e9-4138-adf6-ff891332fb31`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `fd355c88-d502-4866-b8d1-2a502e332d94`
...
- load_id: `2aca8d80-ce9a-4cc0-8b7e-42acf51a1115`
...
- load_id: `58f7755b-d8b2-4da5-b798-61c76029081b`
...
- load_id: `40f33293-6df6-4840-b609-62ccd01c2c51`
...
- load_id: `021ab22b-c9c1-4e92-8911-b4e3f0d97cd4`
...
- cost_estimate matched (1610.0).
- load_id: `b14c81c0-0a6b-4b79-8c1e-3d021199650e`
...
- load_id: `fbb63590-35f9-4e63-8531-15c2e3d64c4a`
...
- load_id: `3c999550-91ef-4cad-a49f-b73e0fdaeab5`
...
- load_id: `4a41b749-2949-4d93-86b0-d9292532ffbf`
...
- load_id: `f50ba707-dad9-41c4-89d9-74e8a9b459ec`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `bf2a24d0-2421-4896-9803-4fe16be8202d`
...
- load_id: `61ef9691-761f-4d5a-b2ee-21321e70a51f`
...
- load_id: `e4bebff8-5473-433a-8527-08424f0e0b47`
...
- load_id: `d715a676-ab14-440d-8198-eaf53ab6743d`
...
- cost_estimate matched (1610.0).
- load_id: `952dd52c-2ded-4d1a-9b70-1b885191dae4`
...
- cost_estimate matched (1610.0).
- load_id: `c3ad2c2d-d699-4825-a232-498575f917fd`
...
- cost_estimate matched (1610.0).
- load_id: `97e784b9-eff3-4749-bbc0-c75504509ace`
...
- cost_estimate matched (1610.0).
- load_id: `061f0070-5ff6-4e43-8fbe-b4077b9d43cd`
...
- cost_estimate matched (1610.0).
- load_id: `fb535eab-3569-40df-ad66-147113f549c6`
...
- cost_estimate matched (1610.0).
- load_id: `dfa5a126-7b94-404e-9cb9-a2d281cec147`
...
- cost_estimate matched (1610.0).
- load_id: `3ed890a7-1a45-4a1f-8fb5-4af07bf36ae9`
...
- cost_estimate matched (1610.0).
- load_id: `da3a2a87-2f1a-4e85-bbbe-94498a0c9ee5`
...
- cost_estimate matched (1610.0).
- load_id: `ca3a39ab-7363-4049-97d1-f2b21cdcffb8`
...
- cost_estimate matched (1610.0).
- load_id: `9c467f43-8027-46ee-9628-81fb945cfbfa`
...
- cost_estimate matched (1610.0).
- load_id: `3c087819-b65d-4cef-9a44-0fb75440e939`
...
- cost_estimate matched (1610.0).
- load_id: `37eb7c99-d4fe-4e4d-b3be-83a25812fc5a`
...
- cost_estimate matched (1610.0).
- load_id: `4bf6d087-6369-4e23-8fda-34eaa8b7cd0f`
...
- cost_estimate matched (245.0).
- load_id: `306232d5-db28-4a4a-94a3-4fdfa7349fff`
...
- load_id: `ac600a17-c0f9-4b2a-a713-520f2c0bacc6`
...
- load_id: `f589a6dc-d83b-4b1e-84d7-05ab7f57ca50`
...
- load_id: `44dcbc90-70e3-4964-83f7-b99916a66bb4`
...
- load_id: `8f33ec57-2fe8-43ea-8551-6c132d85ac32`
...
- load_id: `6f6276b4-47ee-4db2-a802-7fb8cf82b5ce`
...
- load_id: `73619a17-15d8-47df-b7e3-4575cede13b8`
...
- No graded predictions; document-only.
- load_id: `11302d6f-cb16-4314-949e-b58ec0aeba9b`
