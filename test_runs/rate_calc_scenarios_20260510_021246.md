# Rate Calculator Scenarios -- 20260510_021246

**Run ID:** `bae855f6-f83f-494e-8662-43272b0d71ba`
**Total scenarios:** 45
...
- load_id: `d94bccbc-ab42-46a3-980c-6e840fe803b3`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `02e5d674-3b8c-49ea-8740-c6b30d3349d0`
...
- load_id: `e67e2062-7de7-4cae-9c4e-81e0a765ef6b`
...
- load_id: `922524e9-d9f5-4e5c-88d6-45d90751d0a1`
...
- load_id: `cb59132a-326c-4d21-b666-30b5e62822e3`
...
- load_id: `c1b70659-3d8b-473c-96ec-11bfb21ebf05`
...
- cost_estimate matched (1610.0).
- load_id: `07d90275-896c-4fe3-b743-243fa9eccd96`
...
- load_id: `251fc148-d349-4088-8f43-ed7be815158a`
...
- load_id: `aae4d820-d569-4545-bf9e-20cf5d8fab7f`
...
- load_id: `7f93eaa0-ba03-4129-a766-a8139c43f2fe`
...
- load_id: `76c6514f-d77a-4608-8ac3-d00b86034d8c`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `cb2b36fb-3348-4d03-9845-3ff412745b6d`
...
- load_id: `4c58e3f4-647e-4a89-a73b-441c7c9b4d8a`
...
- load_id: `14334a43-2597-4203-be4c-c47512b4abef`
...
- load_id: `aa1ec0ac-34ac-4aca-8390-2cb5251d9139`
...
- cost_estimate matched (1610.0).
- load_id: `3c418e01-95a3-433b-9e41-6ff4a5572813`
...
- cost_estimate matched (1610.0).
- load_id: `63cf8923-8f96-4f28-912f-59840d7e9e6f`
...
- cost_estimate matched (1610.0).
- load_id: `2307b7b1-3651-44ec-9916-d45c07b2a0b6`
...
- cost_estimate matched (1610.0).
- load_id: `b9868e49-ab6b-4a2f-9357-0982f857bc44`
...
- cost_estimate matched (1610.0).
- load_id: `4c84f25c-a428-4070-bafc-0ae851a8c485`
...
- cost_estimate matched (1610.0).
- load_id: `fa562e28-fe92-46a4-ab2c-48866bd65b30`
...
- cost_estimate matched (1610.0).
- load_id: `b1f82358-d685-4a7c-997a-988e229ebfb4`
...
- cost_estimate matched (1610.0).
- load_id: `2523b9d8-c343-4570-93c9-03c5fa566855`
...
- cost_estimate matched (1610.0).
- load_id: `aba11549-a9b2-4108-9d67-7a099e0bd257`
...
- cost_estimate matched (1610.0).
- load_id: `636d010b-4452-42da-b53d-6ed6e77d4bea`
...
- cost_estimate matched (1610.0).
- load_id: `04db3dac-a521-4bb6-8efd-5a15b35e71e8`
...
- cost_estimate matched (1610.0).
- load_id: `61554a75-219b-41df-b7fa-8de147d3737c`
...
- cost_estimate matched (1610.0).
- load_id: `4e5230e7-af66-46b0-a28c-1a1b31e098db`
...
- cost_estimate matched (245.0).
- load_id: `92aae46a-e4a4-4f60-87e5-91ef09d37c42`
...
- load_id: `addfd534-bbe3-43c2-a25b-46c49c027968`
...
- load_id: `90c4c263-de95-4638-b2d6-b6ff83c24e40`
...
- load_id: `fa950f9b-51cb-4bed-8589-273cabbb1ef8`
...
- load_id: `4c09ae7d-5c5b-41cc-b8e5-ab1b5080b43b`
...
- load_id: `ccc85504-8646-4613-a490-74765cff3867`
...
- load_id: `5894523c-3d89-45bc-b486-03c7c90b6332`
...
- No graded predictions; document-only.
- load_id: `9780a463-d3d7-4ade-ade7-99e678185655`
