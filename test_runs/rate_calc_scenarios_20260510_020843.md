# Rate Calculator Scenarios -- 20260510_020843

**Run ID:** `b57b5a22-0257-404c-88ee-8e940bf79dd3`
**Total scenarios:** 45
...
- load_id: `c77863b8-abeb-4d5b-a4e5-9895bfec6e0d`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `6a817b5d-9372-4e29-8e60-812530cf05df`
...
- load_id: `8d3ef471-972f-412e-aec7-04e3893939c9`
...
- load_id: `14535a00-2210-4e8d-bbcf-faa13f2ef665`
...
- load_id: `58905f8d-2808-49b2-8d61-56523917555e`
...
- load_id: `7baf0ae9-dddf-482b-8c3d-a5ed80da90da`
...
- cost_estimate matched (1610.0).
- load_id: `84b9a7f5-15cd-4768-b41d-597ce5203567`
...
- load_id: `187f8486-9f99-41c2-aa75-e4ce06bf0999`
...
- load_id: `0b6ab08f-7bd1-4f2e-a240-6565398f03d5`
...
- load_id: `a2b720e1-9164-49cc-a2f6-b10569077c7e`
...
- load_id: `a218e2c0-ff01-4c06-9a0f-709f9355a793`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `1e9842a2-7d32-46b3-8481-c6251a769e99`
...
- load_id: `b0079d50-0c8d-407a-ba56-20f76b796fed`
...
- load_id: `412a48fa-124e-4a6b-82bd-5090e30c13a4`
...
- load_id: `d6941587-c972-461e-967f-57f93597e4fb`
...
- cost_estimate matched (1610.0).
- load_id: `ad78bb5e-85c7-4123-8009-e45e92d9ed89`
...
- cost_estimate matched (1610.0).
- load_id: `c6dfecbb-22fd-4fd0-98dd-5368e3258f60`
...
- cost_estimate matched (1610.0).
- load_id: `a7ac13e2-0d16-4e94-8d08-0396a7f4f494`
...
- cost_estimate matched (1610.0).
- load_id: `c7825fc0-e158-4ccf-b926-432ecfc54b6c`
...
- cost_estimate matched (1610.0).
- load_id: `772640b5-5bce-4def-853f-c20756cc2e92`
...
- cost_estimate matched (1610.0).
- load_id: `c5f86faa-3ba1-490e-b77b-e0fa9e3868e4`
...
- cost_estimate matched (1610.0).
- load_id: `44c45b33-271b-45d9-80b3-52714bdb065e`
...
- cost_estimate matched (1610.0).
- load_id: `a00c7e7e-646b-458a-b87a-2381b329558c`
...
- cost_estimate matched (1610.0).
- load_id: `d32663b6-0a14-4fb5-9e9b-ebd63ddb2b5c`
...
- cost_estimate matched (1610.0).
- load_id: `60dbe175-f13c-47a2-8600-2004b5ce3c40`
...
- cost_estimate matched (1610.0).
- load_id: `eb0c43a0-579f-4ca8-baa0-db8bdddcc162`
...
- cost_estimate matched (1610.0).
- load_id: `fe7642bc-eac7-46d2-b633-2af3d958ff16`
...
- cost_estimate matched (1610.0).
- load_id: `c7b6bd45-bfe5-4965-ba0c-865bc679939f`
...
- cost_estimate matched (245.0).
- load_id: `5c8a11e2-052f-4440-bcc1-f116cdd9c06d`
...
- load_id: `e8c305e2-bdcb-4239-9905-f370b7f806e0`
...
- load_id: `a0a2b82f-bbc8-4253-9c94-d6f0fc906b3e`
...
- load_id: `cc770707-9d1c-41cc-a409-9905328c01ef`
...
- load_id: `d5a7b3c2-16b4-4617-957b-bdd506ba43a8`
...
- load_id: `f3254d14-3870-4a5f-8d7c-6fcb3be39844`
...
- load_id: `bcbca7bb-5d2b-4bec-a93c-328f44ff55df`
...
- No graded predictions; document-only.
- load_id: `3f2580d7-8238-4a7f-a020-26f54d837973`
