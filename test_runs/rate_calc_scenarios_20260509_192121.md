# Rate Calculator Scenarios -- 20260509_192121

**Run ID:** `1bc35c8f-c5c2-400d-a825-d3bb37bba21d`
**Total scenarios:** 45
...
- load_id: `00f3d8f2-2fe0-495d-926b-77cfe23e5319`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `a653460f-a562-4010-a4ec-c080a7a5934f`
...
- load_id: `ac7628a1-f7fb-4376-82c9-fa0edee66fe6`
...
- load_id: `1407ea2e-7210-4807-9255-348cf36555eb`
...
- load_id: `ba0d7233-2b06-472f-a9bb-1ec36fc7915e`
...
- load_id: `0547c678-dea0-4e96-ba83-688e83325eba`
...
- cost_estimate matched (1610.0).
- load_id: `7f859c93-a0f9-4114-ba55-3c2339b5651e`
...
- load_id: `60e664fd-d488-45ac-b993-ea80c89d877b`
...
- load_id: `618683a9-0f0d-42b0-b016-97e99ab8fbe1`
...
- load_id: `40391e56-1230-4eeb-a725-ba83a4379930`
...
- load_id: `83de6378-74ee-454a-a561-381b994b63d6`
...
- load_id: `f3b85b15-7b42-4a7c-90dd-1c88593a73f0`
...
- **predicted:** `{"rate_calc_base_rpm": 2.75, "cost_estimate_value": 1766.0}`
- cost_estimate matched (1766.0).
- load_id: `93bd98d9-34f0-4d0c-be96-19e25ff595a8`
...
- **predicted:** `{"rate_calc_base_rpm": 2.75, "cost_estimate_value": 1766.0}`
- cost_estimate matched (1766.0).
- load_id: `f383f596-0e1d-46a7-9f99-60e624b70a68`
...
- **predicted:** `{"rate_calc_base_rpm": 2.75, "cost_estimate_value": 1766.0}`
- cost_estimate matched (1766.0).
- load_id: `d072d4d0-e2d3-4f17-9210-dc9d20080ec0`
...
- cost_estimate matched (1610.0).
- load_id: `d0b03d4a-36e3-4432-9e7f-84306c9394e9`
...
- cost_estimate matched (1610.0).
- load_id: `14b031f5-a1ff-4244-ac0b-7131fe42feea`
...
- cost_estimate matched (1610.0).
- load_id: `551e9187-537c-4938-9697-11dd2779fc12`
...
- cost_estimate matched (1610.0).
- load_id: `6f64486d-d400-4a0d-b9bf-92eb589a104f`
...
- cost_estimate matched (1610.0).
- load_id: `9354825b-a015-4ddc-8dcc-e120337c57ca`
...
- cost_estimate matched (1610.0).
- load_id: `70186919-6250-47d5-aa55-7148dd8e55e8`
...
- cost_estimate matched (1610.0).
- load_id: `94d738a5-db70-4a4a-b0fb-c3084fb7b204`
...
- cost_estimate matched (1610.0).
- load_id: `7c586492-5384-4174-a593-f24485f425f9`
...
- cost_estimate matched (1610.0).
- load_id: `acf5c5c8-cac7-4870-b902-91986cf5ab9d`
...
- cost_estimate matched (1610.0).
- load_id: `f4170711-4fe7-4a48-95b4-8ebb0a155369`
...
- cost_estimate matched (1610.0).
- load_id: `99c5ea5c-8aab-4d11-8cff-17fb977ab2ff`
...
- cost_estimate matched (1610.0).
- load_id: `d6774402-cc38-4f5e-8bd6-09ab5717733a`
...
- cost_estimate matched (1610.0).
- load_id: `f241ec3b-10d1-491b-ba5f-5dc7646312e7`
...
- cost_estimate matched (245.0).
- load_id: `45eb15fd-2419-4efb-8a26-ebba73b3e1d2`
...
- load_id: `d8ef17bf-93de-417c-97b7-1267a2f3b7eb`
...
- No graded predictions; document-only.
- load_id: `3c10c68b-fb8a-4268-bbc2-5985ee95cbd9`
...
### ratecalc_weight_factor_45001 (rate_calc_only)  -- **FAIL**
...
- weight_factor: predicted 1.15, got 1.1
- adjusted_rate_per_mile: predicted 2.88, got 2.75
...
- load_id: `1066560e-5593-4a01-841c-c2d5a122c392`
...
- load_id: `6b52d3f2-94a9-4043-a7ad-da988fb6e8cf`
...
- load_id: `40e59fe3-1918-481c-925d-4dd76ec5b921`
...
- load_id: `85e24e82-eb93-4411-a36e-f614891be661`
...
- load_id: `ba7e1010-1f4d-442a-8d8d-4a1e80364d9c`
...
- No graded predictions; document-only.
- load_id: `bfa8779f-fdbe-4f19-b891-e5143d0ae9d4`
...
- No graded predictions; document-only.
- load_id: `eb08894a-91c1-4e85-b7c9-eaf509faf41b`
