# Rate Calculator Scenarios -- 20260510_035929

**Run ID:** `3d778c3e-d35e-4ef2-b28c-b39a8832e2c3`
**Total scenarios:** 45
...
- load_id: `95f0603f-a9ac-4e1d-a564-3647ea001e4a`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `efbfd3f2-e4fa-4c08-b910-382ee5e8c21a`
...
- load_id: `45a4c0fd-76ea-411d-b5cf-5c2151359a48`
...
- load_id: `48f00bff-cfb5-4279-a3bb-5fb32609284b`
...
- load_id: `a171af43-23bf-4c21-94f1-e8eaae4f9e24`
...
- load_id: `df8b988a-409f-4cee-b915-432389ece79d`
...
- cost_estimate matched (1610.0).
- load_id: `173abed5-0b73-43c7-808e-b1200c96d693`
...
- load_id: `3067f04f-59fe-494d-9611-84208d7bcd91`
...
- load_id: `eccfe17c-6e7b-459b-927d-2523b7d4bfc4`
...
- load_id: `4466e2d9-87e1-4f32-b765-7735a3879bfb`
...
- load_id: `70b31192-288f-471a-9fbb-05015e485698`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `29b2c8ef-0799-4bd8-b101-481b13132eda`
...
- load_id: `70624f08-3722-458e-9b1f-38cc2c2db68a`
...
- load_id: `3162d411-2ae5-4ea3-82ad-3373824794c3`
...
- load_id: `168dc2a9-db66-4d0c-a6ab-66c0286911f9`
...
- cost_estimate matched (1610.0).
- load_id: `cf86a943-5e0d-4853-b0d5-2a53db650035`
...
- cost_estimate matched (1610.0).
- load_id: `909f7b46-9420-4ec7-876b-1680c17e1184`
...
- cost_estimate matched (1610.0).
- load_id: `5bdb75a6-932c-40ee-8b2a-fa5b5fd063fa`
...
- cost_estimate matched (1610.0).
- load_id: `630ed33c-763d-476c-b420-f93f2eae1008`
...
- cost_estimate matched (1610.0).
- load_id: `cafa7b24-f9dd-43c0-b8fb-09101e370c4a`
...
- cost_estimate matched (1610.0).
- load_id: `79155fb4-dbfb-4674-9179-32b370b567af`
...
- cost_estimate matched (1610.0).
- load_id: `21c2b15b-1cd1-438c-a099-629952040932`
...
- cost_estimate matched (1610.0).
- load_id: `5b4f8a04-29fc-49e1-98bf-6ba6d4e246b2`
...
- cost_estimate matched (1610.0).
- load_id: `ba823771-ac75-4180-baff-57cbb16d03bb`
...
- cost_estimate matched (1610.0).
- load_id: `7133ed68-6409-43a2-b1e1-3d93ab5b1381`
...
- cost_estimate matched (1610.0).
- load_id: `0e8dbba5-2d80-4fb0-8587-dcc07b13a0d2`
...
- cost_estimate matched (1610.0).
- load_id: `6eefe550-406e-47de-83f9-7e5e51aca73a`
...
- cost_estimate matched (1610.0).
- load_id: `3a47642f-4821-49c5-b6c8-39088b414c20`
...
- cost_estimate matched (245.0).
- load_id: `3fc11087-512c-4541-80b1-d1ee745d2049`
...
- load_id: `d230e089-2fc9-425b-a131-72e6ef77772f`
...
- load_id: `2f9c0e6d-da01-41fe-b23c-ebed4569cd20`
...
- load_id: `20e45c6b-9050-4727-949c-c8029e8439cf`
...
- load_id: `c458e431-f323-4601-a700-422edbe446c4`
...
- load_id: `0b480676-98cc-4122-9d49-0182f1309811`
...
- load_id: `a79d2adb-d53e-49dd-919d-6b8ced87ddac`
...
- No graded predictions; document-only.
- load_id: `4fd8df11-8b41-4e1b-8e90-1914e85ae3b0`
