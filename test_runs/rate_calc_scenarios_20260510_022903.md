# Rate Calculator Scenarios -- 20260510_022903

**Run ID:** `b11da18b-3733-4644-930a-786a2f1dc161`
**Total scenarios:** 45
...
- load_id: `297fee73-e59a-4f85-a943-72158d644043`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `21c6ca47-d54e-4338-9a63-3e18e42df8a8`
...
- load_id: `07bb2f2b-6699-44bc-8362-aff80fa0301b`
...
- load_id: `e52b98a0-0115-41d3-a6c8-3ed714080e03`
...
- load_id: `d47b8034-1daa-4bda-8093-4cd19070b7aa`
...
- load_id: `65a03732-48bf-4af3-98cd-ecb5d8dbe878`
...
- cost_estimate matched (1610.0).
- load_id: `33877297-65ef-425a-aec9-6f4162cb5693`
...
- load_id: `534fb7a7-574d-448c-9849-5b475208dec4`
...
- load_id: `0aacc470-ba32-4ac0-8654-b77659de9c2f`
...
- load_id: `6ababb83-1b9d-49bd-84d9-620b8340d9b7`
...
- load_id: `3a391288-be6f-46f1-ab76-da65c87efa7b`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `6eaad399-6dc3-4d0d-9d41-b4677782a494`
...
- load_id: `3a520f05-a106-4b5c-aaa9-1728bd0675ff`
...
- load_id: `3fac73a8-4806-4444-9668-4cfcee7ab795`
...
- load_id: `f2d56e7c-d29b-41b0-9fc2-8619e3fa1126`
...
- cost_estimate matched (1610.0).
- load_id: `6ad8a8e0-779d-46d0-8107-a166eb353492`
...
- cost_estimate matched (1610.0).
- load_id: `82483e96-34d8-439e-8b40-0f5992404436`
...
- cost_estimate matched (1610.0).
- load_id: `d401aab1-cbfb-4e5a-8087-cd666636578a`
...
- cost_estimate matched (1610.0).
- load_id: `d4266599-1ab5-40c9-9b46-6630570ab748`
...
- cost_estimate matched (1610.0).
- load_id: `70d3eabc-0bc1-4c39-a479-8520489e1a83`
...
- cost_estimate matched (1610.0).
- load_id: `239303bf-a0d7-46d0-b254-711be347d495`
...
- cost_estimate matched (1610.0).
- load_id: `1cdbb91d-e055-4742-9376-233642ed001d`
...
- cost_estimate matched (1610.0).
- load_id: `907413b5-69f2-4ed3-a6d6-1ea9485db790`
...
- cost_estimate matched (1610.0).
- load_id: `49abd8c0-ecb2-4fd8-b057-9f5cd2bec7cd`
...
- cost_estimate matched (1610.0).
- load_id: `4ab6e995-a0fc-4fab-b61a-e942332d9b60`
...
- cost_estimate matched (1610.0).
- load_id: `b8537a9f-9b2a-45db-929c-6b8048ab4d93`
...
- cost_estimate matched (1610.0).
- load_id: `3c4e58ff-c2c1-4da9-9a23-400358dae90b`
...
- cost_estimate matched (1610.0).
- load_id: `bec711e1-0a0e-42b3-bcd7-43b27dc89d00`
...
- cost_estimate matched (245.0).
- load_id: `f350a2cc-8d18-4abc-a370-156e38c28701`
...
- load_id: `bc4e9422-9423-41e0-b67b-7bca945ba43d`
...
- load_id: `d3df7a54-0a18-41f6-a23d-de94b03b5abb`
...
- load_id: `af025c8e-c0a7-4173-ac4e-0e5f2ed775a0`
...
- load_id: `89dd242f-30f8-4991-9b54-efcc30000ce7`
...
- load_id: `f65576a0-e9eb-430c-bd26-0d6e42eab810`
...
- load_id: `d70e6763-715f-4c30-9ddf-749b883bcb8d`
...
- No graded predictions; document-only.
- load_id: `8595d5fa-f4e9-4c76-b28e-b1b8ab19afd9`
