# Rate Calculator Scenarios -- 20260510_025431

**Run ID:** `2d395d90-c5c7-4a62-a4ff-2299ba54767d`
**Total scenarios:** 45
...
- load_id: `43bd0a7c-3d51-4ac6-8db9-2caa910f0aad`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `dcc8cbd9-6560-4205-8bd5-b6184b5cece0`
...
- load_id: `b42185db-8ebb-44a1-971d-86d8377c9269`
...
- load_id: `e9d70c8c-da45-4fad-9f66-0455212c5111`
...
- load_id: `1b3df2f9-f6da-4aac-af7c-d3317c5a1b40`
...
- load_id: `fcc04f9a-15fe-4eb5-a396-db71141f3dda`
...
- cost_estimate matched (1610.0).
- load_id: `1bd3d1d8-146c-4fa0-8156-14a38f13e4d4`
...
- load_id: `5c9a55d9-d395-40b0-9412-c2b449c91774`
...
- load_id: `d3c84e8c-a933-46c1-ab76-bc5044adb35d`
...
- load_id: `5edbe1f0-08ac-489e-bd07-c15f5f449ddb`
...
- load_id: `e1e193a9-8cf7-4682-abdb-0e771c1d0f3d`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `1e9691d8-88d7-4f4a-bf39-4d1f4b78f730`
...
- load_id: `7077fa82-5895-4ce9-a6cc-3d0cb2ef6b06`
...
- load_id: `686b6618-e963-46f2-8a78-d3892ef782b4`
...
- load_id: `319b4094-bd80-4c8e-9546-f63121050dfb`
...
- cost_estimate matched (1610.0).
- load_id: `d383fb9e-d6a3-4097-bafc-66701fa57e1d`
...
- cost_estimate matched (1610.0).
- load_id: `d803d9e9-fa8b-48fb-a91b-4a1032099f5e`
...
- cost_estimate matched (1610.0).
- load_id: `cfb622a7-6df3-4cbf-8599-a3038a711057`
...
- cost_estimate matched (1610.0).
- load_id: `17061ca4-9c76-40f9-b1ff-f2866f862103`
...
- cost_estimate matched (1610.0).
- load_id: `34321253-ecbd-4e5a-93cf-075f123f6d07`
...
- cost_estimate matched (1610.0).
- load_id: `8bf4c108-bca7-4a45-96b0-5c84a0cb4d46`
...
- cost_estimate matched (1610.0).
- load_id: `ed938d8f-ca81-4f48-bf14-abc7340808cb`
...
- cost_estimate matched (1610.0).
- load_id: `61ead155-487b-419d-ae63-3dc4388d3add`
...
- cost_estimate matched (1610.0).
- load_id: `559a9657-0684-4c10-8eea-ad5a168a326b`
...
- cost_estimate matched (1610.0).
- load_id: `e4138aa1-6588-44ab-b038-c7e9bc0beea4`
...
- cost_estimate matched (1610.0).
- load_id: `ac94d0fc-0b3b-4daf-b891-5c4f0e8b1377`
...
- cost_estimate matched (1610.0).
- load_id: `47f22a9f-1902-4df2-a6da-20fab78f6990`
...
- cost_estimate matched (1610.0).
- load_id: `5a4c6769-5dd0-4cdb-b1bb-4556651949e6`
...
- cost_estimate matched (245.0).
- load_id: `6f1b3a4c-52a4-4dad-a739-1b4bce0f55ef`
...
- load_id: `2b241a9b-15d4-41d1-9c38-76f61f4cc161`
...
- load_id: `b2a1cf83-f25e-4959-ad75-50b188e2d453`
...
- load_id: `e8694681-7027-49b8-bec6-4e1419369d3f`
...
- load_id: `989ba08f-95c2-4b3a-baad-10a61411430d`
...
- load_id: `a266deb7-7bc6-4bb2-9077-1127e3441a22`
...
- load_id: `c8ce53ce-b599-4023-a5ca-61b8e2423f54`
...
- No graded predictions; document-only.
- load_id: `6ae95f82-28d5-46dc-b86c-36e470d534f6`
