# Rate Calculator Scenarios -- 20260510_015329

**Run ID:** `29a179af-656a-4d25-b720-2c4027d7eef5`
**Total scenarios:** 45
...
- load_id: `a92ef0c6-4423-4dc8-a8f3-a1de3c873b80`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `0c30d006-db63-4c83-adf9-3d4ac2f826b2`
...
- load_id: `969fdab5-e5f3-4e53-a452-b5c3fbc770f6`
...
- load_id: `bf7f63b8-0053-4357-adeb-4bcf2bbd1cbf`
...
- load_id: `bf3c9f7c-2431-4845-8238-14a9de542018`
...
- load_id: `3689bf94-2693-4741-bb21-3f49a632f2e1`
...
- cost_estimate matched (1610.0).
- load_id: `3870097f-975e-4d09-9151-4c856d5fd464`
...
- load_id: `285cd28f-ea50-4d77-b238-376b4cc93c8b`
...
- load_id: `a36f7415-b07f-47cd-81d5-9c5234deefec`
...
- load_id: `6d53c73f-e403-4d76-853a-47b91bc81c36`
...
- load_id: `b56d9357-edb4-4b90-99bd-ea41dfd2e100`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `156e8ae2-4aa6-488c-a6c5-2ffe9fe7323e`
...
- load_id: `21bcafbf-0f54-41e8-a06a-878aeb1026b2`
...
- load_id: `7fc4bea6-edfb-4f10-9cdf-b68451553abe`
...
- load_id: `5aeec868-2b42-4141-960b-f5725e65a1aa`
...
- cost_estimate matched (1610.0).
- load_id: `29ceb743-f8aa-4f95-be21-fd8f64d0f189`
...
- cost_estimate matched (1610.0).
- load_id: `4fe0554a-a482-46bd-9621-fc3a554e8c89`
...
- cost_estimate matched (1610.0).
- load_id: `021fca46-ea2d-4bce-bbdb-60e661576474`
...
- cost_estimate matched (1610.0).
- load_id: `f0be42e8-e6f8-4f95-b3b9-acf2e11ef69a`
...
- cost_estimate matched (1610.0).
- load_id: `b9393734-fe15-4b46-b3ae-4c3007ed2398`
...
- cost_estimate matched (1610.0).
- load_id: `7b091d14-ffe8-4b8c-ad3c-bb319770625c`
...
- cost_estimate matched (1610.0).
- load_id: `8a7923a7-7233-47b1-97bf-d8d1ccdcd1bc`
...
- cost_estimate matched (1610.0).
- load_id: `84998aaa-02d9-4d16-8e79-700a6d11902d`
...
- cost_estimate matched (1610.0).
- load_id: `9362bb1f-9efc-47f3-b72e-25a0d2474a53`
...
- cost_estimate matched (1610.0).
- load_id: `c578136f-8af7-466c-bb85-09b17c9fa167`
...
- cost_estimate matched (1610.0).
- load_id: `d5a65aa1-3a79-4bcb-a4ae-c20b405bfcb6`
...
- cost_estimate matched (1610.0).
- load_id: `06270733-dcf7-4e63-99d1-2417810cf414`
...
- cost_estimate matched (1610.0).
- load_id: `7b94e29e-f5b8-4b62-9569-3fe06016de33`
...
- cost_estimate matched (245.0).
- load_id: `30e30c69-054d-4646-861d-786683fce0fd`
...
- load_id: `4b2ccc5c-9e6c-45a8-8b0b-d0fc91f5a371`
...
- load_id: `67a78952-a5e6-48b4-964d-06d3ac4f6300`
...
- load_id: `31804e81-538a-476d-b88e-9506fcdeb7de`
...
- load_id: `6f188144-2535-433e-be62-b4b031d8eb22`
...
- load_id: `b9217de6-f315-48e7-98f5-d75e81c0a3e0`
...
- load_id: `8ddaf18f-2105-46ac-9462-556869ebe0d8`
...
- No graded predictions; document-only.
- load_id: `34377adf-92f8-47bf-a916-6aa6822c7fe2`
