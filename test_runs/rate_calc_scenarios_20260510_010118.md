# Rate Calculator Scenarios -- 20260510_010118

**Run ID:** `997bb1b4-ae47-4163-92d2-e2f9e0ebbce1`
**Total scenarios:** 45
...
- load_id: `02a38ff9-f20d-4010-ab55-0d1df4a2ba35`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `d491f67e-2430-4f51-90f6-3908a645ce68`
...
- load_id: `837ddae1-0c97-419d-8d3a-8963a32870ba`
...
- load_id: `62eaacba-712b-4997-8d5d-4cf875236d44`
...
- load_id: `1be5239f-eddb-422b-82e4-0353e4c24110`
...
- load_id: `99c7d092-c818-4a7e-9add-82d29458a385`
...
- cost_estimate matched (1610.0).
- load_id: `15527044-f6bc-4895-9245-a61dd03fc5df`
...
- load_id: `747cdb00-0d71-46f9-a2ee-59a8a5b518fa`
...
- load_id: `aafc07ae-8ecf-4bc0-92ae-ec393d54d2d4`
...
- load_id: `81095e52-e63f-45ae-a54e-41218b0dca6f`
...
- load_id: `a4d1f8e6-cd69-4868-89e8-1b92d17aea12`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `013e188c-d79d-46eb-ab20-14d0a2774191`
...
- load_id: `21c640b6-f58d-46ea-9c5b-11d2fc238dbe`
...
- load_id: `8554514b-e1d0-4e62-a439-ec43477aa65a`
...
- load_id: `64828aaa-8df8-41ce-b751-84a7f7646e1e`
...
- cost_estimate matched (1610.0).
- load_id: `7c5b9e60-1d45-4e50-b3a9-d11e283173dd`
...
- cost_estimate matched (1610.0).
- load_id: `a45dc44a-cb1c-42e4-8bf9-b77b7427cff8`
...
- cost_estimate matched (1610.0).
- load_id: `8547ad96-1bb8-47ee-a396-91feb3605a12`
...
- cost_estimate matched (1610.0).
- load_id: `63c1d1cb-7eb0-48ae-9a14-f4d686621efe`
...
- cost_estimate matched (1610.0).
- load_id: `8d681f34-5137-46ea-a0d5-524ac08f5818`
...
- cost_estimate matched (1610.0).
- load_id: `a17f6bf3-6636-4878-be44-183c25b44aa7`
...
- cost_estimate matched (1610.0).
- load_id: `b9fbb07a-fffc-4394-833d-f82f6df449b3`
...
- cost_estimate matched (1610.0).
- load_id: `708b2f8f-a8ef-4ff8-8684-3b2ac1579b68`
...
- cost_estimate matched (1610.0).
- load_id: `239f8f00-7141-4083-b435-0cc0cb071f49`
...
- cost_estimate matched (1610.0).
- load_id: `46c2dbcd-0d56-499f-93b0-d6ceda38aca8`
...
- cost_estimate matched (1610.0).
- load_id: `290161a2-8479-4580-b3a6-5eb4ae15b7a7`
...
- cost_estimate matched (1610.0).
- load_id: `c85fcec0-70c7-4420-968c-7e17626461b6`
...
- cost_estimate matched (1610.0).
- load_id: `125bb798-c426-4c28-9654-59341d75bde7`
...
- cost_estimate matched (245.0).
- load_id: `1d06d55c-d2be-4542-8eb1-003cd06982c4`
...
- load_id: `e5eea303-8e06-48b7-8878-acce75e6da13`
...
- load_id: `a0d59fdc-ba36-4825-9194-385cf2a2719e`
...
- load_id: `956c298d-ca23-40cb-bf4a-f0ed3079185d`
...
- load_id: `5b836451-dd86-4550-b6f8-3aa471db4096`
...
- load_id: `d0208256-fa7a-49e6-93a2-7f74572f96e8`
...
- load_id: `bf4295c6-3735-46dd-9e24-a12ed19287ac`
...
- No graded predictions; document-only.
- load_id: `e9889839-0883-4fed-a68a-70a9853afed0`
