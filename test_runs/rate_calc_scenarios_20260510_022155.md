# Rate Calculator Scenarios -- 20260510_022155

**Run ID:** `27392fe8-4469-4fc6-aec4-b802b76b6f3d`
**Total scenarios:** 45
...
- load_id: `3a6c03c8-d323-4201-a255-3b472d2bcfa6`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `88342957-98af-42d3-98e3-5e341289a6da`
...
- load_id: `70d08b72-b168-453f-9dfe-218677d2cdcd`
...
- load_id: `78ce2e47-778b-4201-ac9c-d8ffc8780a89`
...
- load_id: `9dea377b-c544-46a8-84a9-1be3c033085c`
...
- load_id: `dc5d638c-c468-4866-b0c8-015786a84033`
...
- cost_estimate matched (1610.0).
- load_id: `40be690f-05fd-41d6-a24c-9f28cd1f823e`
...
- load_id: `ec53b78b-8eca-4d68-abfb-3ea0fb4915a6`
...
- load_id: `ec098bdf-6966-429c-b23b-1660a18db294`
...
- load_id: `6b0428db-fb0d-490e-b849-18963b43f554`
...
- load_id: `4898ff00-3ed8-43dc-8c23-44714118d27d`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `645fbfe7-7b12-48b2-8006-6d5297142f9f`
...
- load_id: `77424103-0179-4d42-aab6-dd439e623041`
...
- load_id: `1cbb5df9-07ad-495f-b384-2b0b0e9c5b02`
...
- load_id: `59487536-0c32-4252-b8af-a1c66952dbb6`
...
- cost_estimate matched (1610.0).
- load_id: `36fcdff6-c297-42dd-aa64-4999638d9f35`
...
- cost_estimate matched (1610.0).
- load_id: `c382ea51-6156-43df-935b-3144dbd1890b`
...
- cost_estimate matched (1610.0).
- load_id: `c5bc81c8-da80-4537-aef6-d2cfbec6447f`
...
- cost_estimate matched (1610.0).
- load_id: `b9d9476f-175b-4cae-9bec-52fa855b5610`
...
- cost_estimate matched (1610.0).
- load_id: `61a60ef2-5dc7-4eb1-a6b6-cd72d9730aec`
...
- cost_estimate matched (1610.0).
- load_id: `203bd744-4ad5-40a4-ba0c-92fff4f545b1`
...
- cost_estimate matched (1610.0).
- load_id: `ecf00507-82be-4a58-aa3b-e9b38c761af8`
...
- cost_estimate matched (1610.0).
- load_id: `cd731cec-10c0-4155-8155-230399a7aa9f`
...
- cost_estimate matched (1610.0).
- load_id: `a4cc3ac5-1241-4d77-a473-1a21d1ee0b00`
...
- cost_estimate matched (1610.0).
- load_id: `2254b8f0-9594-4d9a-a128-637122a62c1d`
...
- cost_estimate matched (1610.0).
- load_id: `306c3e74-7f48-450c-8635-8c7f63c76889`
...
- cost_estimate matched (1610.0).
- load_id: `7fed8888-8aa3-46fe-942e-de776e047b8b`
...
- cost_estimate matched (1610.0).
- load_id: `6721c5c7-f2d0-4091-a37a-d257efcb054b`
...
- cost_estimate matched (245.0).
- load_id: `8c1271cb-b4ff-4919-b795-5e8e0d8143b2`
...
- load_id: `5ec07444-db82-4c85-bf06-fd54843eeb7c`
...
- load_id: `35e51337-fb59-4823-8445-693eed4c0bcc`
...
- load_id: `5ee89ed0-a0a4-42c4-8307-617d9d10ce4a`
...
- load_id: `4b5fa7ac-6a95-45af-a078-aeda216e0726`
...
- load_id: `43476f1e-ab7e-4a45-a07e-c73836a3670f`
...
- load_id: `a9117918-415f-4780-b2c1-9d856d6f55fb`
...
- No graded predictions; document-only.
- load_id: `e9fd8393-2c40-4a39-86af-a591084eeef1`
