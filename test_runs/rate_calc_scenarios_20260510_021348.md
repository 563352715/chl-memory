# Rate Calculator Scenarios -- 20260510_021348

**Run ID:** `26abf2c0-af76-4f85-8f73-e1602ab6b388`
**Total scenarios:** 45
...
- load_id: `4726ce9a-2e90-431d-bc55-729bb507eae7`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `2f41218d-821c-4c1d-912a-5f20d695cf2d`
...
- load_id: `77f1b346-719d-4fdf-a5b5-31ee1b9a6658`
...
- load_id: `dbcacc8a-503b-4160-a38b-39cd8cd14f54`
...
- load_id: `6852aace-660b-41b9-b569-4e1c59c287da`
...
- load_id: `15520d58-642a-4a24-bfd2-5ca0e8474d3d`
...
- cost_estimate matched (1610.0).
- load_id: `e0383025-e9eb-4e23-aed8-a33b8533a3fb`
...
- load_id: `181fe0e8-a836-4ac6-a25e-44070d83688a`
...
- load_id: `7a8e8d11-0233-4faf-ae8d-d0c6fd91945a`
...
- load_id: `12273c45-bd59-4a0e-9548-a1e6bc05fd1a`
...
- load_id: `9e81c5a0-25da-4bff-a103-c3c0cfe57f21`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `38ecad7f-6982-4126-8354-9042544b4d8d`
...
- load_id: `df799604-f1f5-4b1c-9c37-d40905e08e88`
...
- load_id: `af560ebb-ddca-4640-934f-3fc4dea6dc49`
...
- load_id: `c6c09d9b-b6ee-4b5d-947f-ad8960d57db6`
...
- cost_estimate matched (1610.0).
- load_id: `34bf241b-b847-470c-acff-d5bc0a3c55bf`
...
- cost_estimate matched (1610.0).
- load_id: `df2df3fe-ba89-4704-836b-b519b8a81e36`
...
- cost_estimate matched (1610.0).
- load_id: `641994ee-d386-4e88-b950-fca03251d798`
...
- cost_estimate matched (1610.0).
- load_id: `0c3b98df-acb0-4425-aabc-040f138dd559`
...
- cost_estimate matched (1610.0).
- load_id: `1287385a-5ca5-4806-8a60-c1e605fed1ff`
...
- cost_estimate matched (1610.0).
- load_id: `441ff6ea-7c48-4138-9025-e5697c136727`
...
- cost_estimate matched (1610.0).
- load_id: `aa5a5df6-0fed-4785-a1ed-81a8186aab16`
...
- cost_estimate matched (1610.0).
- load_id: `e466f154-6172-4e56-b30b-e44a1aa6c629`
...
- cost_estimate matched (1610.0).
- load_id: `47954bc2-92cf-45ff-a2cb-e9bd470ba944`
...
- cost_estimate matched (1610.0).
- load_id: `3fb24984-807d-4113-8ebf-746879240a43`
...
- cost_estimate matched (1610.0).
- load_id: `5605ee81-9ce3-4200-b923-a94605ec2fe8`
...
- cost_estimate matched (1610.0).
- load_id: `28047087-4658-455d-a66a-c23c6369c4f2`
...
- cost_estimate matched (1610.0).
- load_id: `be534090-7c7a-4eba-a13a-e40d44aef930`
...
- cost_estimate matched (245.0).
- load_id: `b70ac25e-4a00-4a16-b38c-5de20cf3b293`
...
- load_id: `c671c472-3e42-461d-a5d1-fd9d0583dfc6`
...
- load_id: `70088206-f916-41fb-9b5a-c056fcef5d94`
...
- load_id: `d0ee1161-694c-4a8f-8799-c8ae6931336b`
...
- load_id: `e64ee411-1966-4806-93fb-25adccee451d`
...
- load_id: `9f145b52-5868-4f4e-806e-149ec804e3a0`
...
- load_id: `1b8c45f5-b8ae-4e92-bc83-111b829b9cc9`
...
- No graded predictions; document-only.
- load_id: `d0cdb816-349c-4777-9424-2b7bb5e2e584`
