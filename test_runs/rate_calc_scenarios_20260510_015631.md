# Rate Calculator Scenarios -- 20260510_015631

**Run ID:** `00fda8a5-4691-4e03-beea-89915674a2a4`
**Total scenarios:** 45
...
- load_id: `b1a4d7a5-0261-453b-bfb5-0973cf45255f`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `2759a685-222f-4644-8a61-cd46ad14421e`
...
- load_id: `772201ac-6d3c-4707-a254-7ce4b4b88d9c`
...
- load_id: `c199daf4-f210-448b-959f-dc5f55c02fc9`
...
- load_id: `939a3c89-aadb-48ff-b6cc-49d408a321e9`
...
- load_id: `4d7ebbe1-4a60-4e71-ba4d-935bf4c0183d`
...
- cost_estimate matched (1610.0).
- load_id: `be5717df-365e-4183-8514-961f06554154`
...
- load_id: `c37b395b-b9ef-419b-a569-484315097056`
...
- load_id: `b59d06a5-09f9-410d-bac5-9c0266c66740`
...
- load_id: `108caf18-9663-462c-86b8-f2b155752fc9`
...
- load_id: `7704ec3c-9bb8-4059-98c4-8e39edd9ada6`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `7bc83f1d-705f-4097-af5f-def8b6784dab`
...
- load_id: `48daf954-307a-4e58-9767-ec9d416444f4`
...
- load_id: `44b5b734-6e28-4aaf-8451-4a372481b11a`
...
- load_id: `7a0321e3-b9d8-487c-8d15-308ef4469ca8`
...
- cost_estimate matched (1610.0).
- load_id: `f4a6641d-a2c6-48a3-b301-18a0d91c6614`
...
- cost_estimate matched (1610.0).
- load_id: `cfd86528-795a-4c7e-9f1d-5ad247ba6809`
...
- cost_estimate matched (1610.0).
- load_id: `06ea8f97-0704-496a-b9f2-ce0221f71fb3`
...
- cost_estimate matched (1610.0).
- load_id: `c5618536-bb4d-4d31-bc9b-8be41ef4afae`
...
- cost_estimate matched (1610.0).
- load_id: `8934c0d9-c6df-4d15-a82c-b4b42486708d`
...
- cost_estimate matched (1610.0).
- load_id: `306b92f3-ceb8-4071-ad02-2de0280bed42`
...
- cost_estimate matched (1610.0).
- load_id: `e20bd774-fd1d-4ff7-857c-1121e26306e1`
...
- cost_estimate matched (1610.0).
- load_id: `3bb39979-53fd-4272-9f4d-2ad2f9dc9601`
...
- cost_estimate matched (1610.0).
- load_id: `a4e4377b-d9d9-4e52-a70b-7f1197e09c8d`
...
- cost_estimate matched (1610.0).
- load_id: `13de5146-6097-48bf-8820-a1048eb1af80`
...
- cost_estimate matched (1610.0).
- load_id: `4c9ff5c3-fa62-4f4e-8004-1a1e8a47f968`
...
- cost_estimate matched (1610.0).
- load_id: `677cda9a-0aef-4b48-b08b-3a9b9d3e9d33`
...
- cost_estimate matched (1610.0).
- load_id: `965bf72c-2d9c-4cb6-bf2b-f8ae966ae2c1`
...
- cost_estimate matched (245.0).
- load_id: `28179251-9c1f-412c-99bb-34d9fa0ace7a`
...
- load_id: `c5a9aa6c-0918-4313-969e-84eafab1f145`
...
- load_id: `38a7d92b-c55c-4c23-b9a3-b6f60f3dc201`
...
- load_id: `c4405da4-446e-430f-8500-e39a9c6c467d`
...
- load_id: `b50c96b1-c782-4db2-ad7c-ec8c70972e10`
...
- load_id: `13edb0c1-6274-4c5f-9d54-caab5e84e105`
...
- load_id: `7fd872f7-a8f4-4bbf-a0b3-3e6e8b8701eb`
...
- No graded predictions; document-only.
- load_id: `b69aa15b-5aef-4a6c-95d9-d3dc3f56b955`
