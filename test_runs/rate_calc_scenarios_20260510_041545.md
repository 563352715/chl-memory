# Rate Calculator Scenarios -- 20260510_041545

**Run ID:** `c858f464-adef-45bf-bd74-2439529cd0d4`
**Total scenarios:** 45
...
- load_id: `db080332-c99c-4370-a430-8233a1b6f45a`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `f78a24d9-c550-4b6b-9dba-eb542cc5b4aa`
...
- load_id: `c873d2a9-165e-41cb-8d65-4e61c4134372`
...
- load_id: `9c503add-f0b1-4a08-a904-e6b0ddc4192c`
...
- load_id: `663d08a5-6c24-48d5-97d7-ac36a27ed39f`
...
- load_id: `a46fbf5a-ce4e-436c-a637-b4e9af2b668a`
...
- cost_estimate matched (1610.0).
- load_id: `4676d639-a068-459f-81a1-0fa77cac8c1c`
...
- load_id: `29a45f71-7df4-4803-a24b-2483bccefd9c`
...
- load_id: `0da3684a-2d23-44f7-8ee5-6d2bc39ecb57`
...
- load_id: `f2bfbcb8-00eb-4d14-b784-4536687998bf`
...
- load_id: `2d8cb843-7c86-4474-9e40-0e61f962a81c`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `a86b8762-7518-4d14-8f3f-018366231e6a`
...
- load_id: `136b5427-967f-446a-9f84-1a418e664f93`
...
- load_id: `4afec63e-d88c-4428-9945-08bdd5afe435`
...
- load_id: `ee1b88c3-1cf1-416a-875a-70056df02b0c`
...
- cost_estimate matched (1610.0).
- load_id: `1f213057-de3c-4af0-8e50-a709ca41afe3`
...
- cost_estimate matched (1610.0).
- load_id: `3226130d-a885-4a81-8b5a-eac9c63f1fa9`
...
- cost_estimate matched (1610.0).
- load_id: `146f7536-92f4-4e93-803a-7f06e1d8f4f8`
...
- cost_estimate matched (1610.0).
- load_id: `990c2c43-7c70-4394-88de-7bdcb7bb255f`
...
- cost_estimate matched (1610.0).
- load_id: `0d58e767-037e-4c3d-83f5-6899084735aa`
...
- cost_estimate matched (1610.0).
- load_id: `8d5ce7c9-6882-4be1-b4d2-f3b601ad9e25`
...
- cost_estimate matched (1610.0).
- load_id: `e4ab1bcf-c513-4e7c-923a-61c10f059caf`
...
- cost_estimate matched (1610.0).
- load_id: `dde4dda4-5982-4791-8c17-48922a8ffff9`
...
- cost_estimate matched (1610.0).
- load_id: `616ee87f-e56b-47bc-a8b8-f9ec15753ad0`
...
- cost_estimate matched (1610.0).
- load_id: `740a6570-b708-4eb5-8829-b2f1bf0a9c87`
...
- cost_estimate matched (1610.0).
- load_id: `61a6a010-1442-4b44-aa8d-2d685ceb4f93`
...
- cost_estimate matched (1610.0).
- load_id: `15cd32f8-7695-42c4-b10f-4b62c12826d0`
...
- cost_estimate matched (1610.0).
- load_id: `bee3b1e8-096f-4317-b95f-fa6f91b3bd32`
...
- cost_estimate matched (245.0).
- load_id: `48254f01-03a9-4007-b060-351e52348407`
...
- load_id: `cfd2e752-d4da-4991-8b93-20af0eaf7ab5`
...
- load_id: `b441f9e4-cbb7-478c-ad2e-8dea0f27eb02`
...
- load_id: `e74b72b0-96d6-49ea-9f3a-af317f332b6c`
...
- load_id: `d68f4a02-366e-44ff-b4e2-196660eee2cd`
...
- load_id: `79e9ef8d-cd4d-49e3-b103-22ed7322c076`
...
- load_id: `92c67e3d-ab75-4892-a560-384eb85467f6`
...
- No graded predictions; document-only.
- load_id: `8b68b59c-aef7-4556-be14-03052f2f9163`
