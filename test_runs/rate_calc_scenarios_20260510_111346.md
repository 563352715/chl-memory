# Rate Calculator Scenarios -- 20260510_111346

**Run ID:** `b2708cdc-246e-4829-bafb-3fa7bfa42250`
**Total scenarios:** 45
...
- load_id: `76b59c2d-8e81-47fd-86d0-604f691233ee`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `a29981e6-94b9-4bf8-be3b-c82d99776e28`
...
- load_id: `0de035e0-cf23-4ab7-943a-b6f018dcf46f`
...
- load_id: `fb81c924-eeee-4dfc-8d1d-2accc6b294d5`
...
- load_id: `51f5b0fc-95fd-4da4-a85c-661cb454f019`
...
- load_id: `aa805134-00a9-458a-811d-0193a8f62777`
...
- cost_estimate matched (1610.0).
- load_id: `e98ff28f-77f6-4a8f-b90e-c6e42516baf5`
...
- load_id: `583c38d8-8948-4180-8b4b-9893ef4d12a8`
...
- load_id: `f36b7bc5-d984-49d9-b9fe-498bb632a971`
...
- load_id: `0555a00b-74b0-4b11-aec3-0e36241cf2b6`
...
- load_id: `2a112374-d743-42a9-8692-80f34c8d68e8`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `250d9ec5-4d9c-4e3e-8494-6ce8482f6e77`
...
- load_id: `f38be1df-22e1-418e-ab3c-d7bd5300e7c5`
...
- load_id: `df2f2c45-1de6-4e89-b316-7d7de4223dcf`
...
- load_id: `7df9f2c8-cf14-4f58-918c-a978a1077710`
...
- cost_estimate matched (1610.0).
- load_id: `cb16e3e3-c64b-4e30-9d8b-6bd67c9cdea2`
...
- cost_estimate matched (1610.0).
- load_id: `9c2d7609-0012-4213-8664-930517c792cb`
...
- cost_estimate matched (1610.0).
- load_id: `48913aec-dd79-44ed-84d3-60063c6696a4`
...
- cost_estimate matched (1610.0).
- load_id: `00b9cbf6-65f7-42e7-a2e5-10ca95c5732f`
...
- cost_estimate matched (1610.0).
- load_id: `b720de58-3da3-4edc-a0cb-b9a8db23bb10`
...
- cost_estimate matched (1610.0).
- load_id: `e12e5e8f-00d1-4bc0-b191-ba63cb3acb4c`
...
- cost_estimate matched (1610.0).
- load_id: `92697a60-cd70-4e9f-af92-a22ff5068cfd`
...
- cost_estimate matched (1610.0).
- load_id: `b457f19a-3adb-4c44-ad8d-35994933251b`
...
- cost_estimate matched (1610.0).
- load_id: `f8692417-53ed-4113-be65-12bf4b447d25`
...
- cost_estimate matched (1610.0).
- load_id: `420f7fff-10ab-4be2-a2a5-ea216214cb5c`
...
- cost_estimate matched (1610.0).
- load_id: `46212430-153b-42f6-8028-b4f9cbd2f353`
...
- cost_estimate matched (1610.0).
- load_id: `e99d9676-afea-4217-b425-6ec80ddba707`
...
- cost_estimate matched (1610.0).
- load_id: `aa67fda1-cd37-4b8c-9ed6-d7e05335434f`
...
- cost_estimate matched (245.0).
- load_id: `ebfa08bb-0f38-4c60-b522-204aaa6aad9e`
...
- load_id: `dd2927fc-92cf-43ec-b1fd-a02a2da63bf7`
...
- load_id: `9c902722-b5a1-40ae-8e2a-563a9c6bbca5`
...
- load_id: `6ab1a649-efc1-413d-b558-80f0fc3b2a1b`
...
- load_id: `34744b3f-afca-4784-9fa4-aab9caab9326`
...
- load_id: `22d1c20d-fa89-463d-bb48-8172e5aa44e2`
...
- load_id: `a3570710-955d-47d9-8c12-4d06c37dbfe2`
...
- No graded predictions; document-only.
- load_id: `24c0ef88-2169-4ee0-8f76-93450ab0e872`
