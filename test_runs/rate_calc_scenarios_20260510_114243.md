# Rate Calculator Scenarios -- 20260510_114243

**Run ID:** `b80cd57f-a35f-48fb-8f0f-a31147f8638b`
**Total scenarios:** 45
...
- load_id: `e17958bc-5260-4e62-9717-9887632fd993`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `64c1d186-34a7-493e-844e-f11b3be4a795`
...
- load_id: `55a187af-a0dc-4c26-bae7-bb261f7c9a81`
...
- load_id: `49625356-38f2-4390-9fae-3fc49ad93e7c`
...
- load_id: `e1c92de2-3aab-4367-ba9a-dfcf636e4926`
...
- load_id: `a0be8dec-d388-4f5f-b1ef-dde1f716fc71`
...
- cost_estimate matched (1610.0).
- load_id: `ca9219a2-d644-495a-8e9b-eae712c99aa3`
...
- load_id: `2ae97d41-80be-4521-8057-b1e656e3e3ad`
...
- load_id: `439c359d-ce46-4218-ad60-f75908e04f2f`
...
- load_id: `8af7462e-6376-411f-aaef-476cab522700`
...
- load_id: `61702aad-2c27-43f1-be95-52a97bb1576d`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `5ac39ee8-94cd-4333-ba4d-5452c47305d8`
...
- load_id: `6f1785d2-9d33-4039-aec7-d0e259d05881`
...
- load_id: `839c4c1f-b185-4a61-878e-3731f23ed27f`
...
- load_id: `3f762c9d-fe00-4d76-afcd-a32df8d69d7d`
...
- cost_estimate matched (1610.0).
- load_id: `19c94fc3-e80c-4373-acae-405bcd9db639`
...
- cost_estimate matched (1610.0).
- load_id: `8da3e309-1c5d-4fe5-8f09-a4571f959222`
...
- cost_estimate matched (1610.0).
- load_id: `94a4f679-0567-4230-904a-72743a2448b6`
...
- cost_estimate matched (1610.0).
- load_id: `39a9b96b-0327-482e-b44e-c153b6d21de1`
...
- cost_estimate matched (1610.0).
- load_id: `58554bc0-3ea7-4e86-ba43-84002fac92be`
...
- cost_estimate matched (1610.0).
- load_id: `e41a1449-021b-4ff3-bc26-da3da385e896`
...
- cost_estimate matched (1610.0).
- load_id: `65ab513f-54fe-4aa5-b689-98ac5d5a7a02`
...
- cost_estimate matched (1610.0).
- load_id: `04622a6c-ad4c-42cd-952a-462963e28420`
...
- cost_estimate matched (1610.0).
- load_id: `bd0e023d-e362-42d0-b942-9b03a6504280`
...
- cost_estimate matched (1610.0).
- load_id: `5eb46392-961c-47de-93fa-18afb2156f70`
...
- cost_estimate matched (1610.0).
- load_id: `ee4fea6c-2975-4991-be0c-70ecf868d337`
...
- cost_estimate matched (1610.0).
- load_id: `9d81ccd6-021f-40cf-8f51-da89cdd6f7a6`
...
- cost_estimate matched (1610.0).
- load_id: `1f16d45c-8698-4dc3-85cc-ca529fabbaae`
...
- cost_estimate matched (245.0).
- load_id: `c27211bb-5c92-4d1b-b648-203315d59c5c`
...
- load_id: `2fdd91f0-b5d8-4cd8-a8e1-81e87b26e974`
...
- load_id: `0f10efa2-b1b5-4221-bcd3-41878c558d50`
...
- load_id: `35873b15-6adb-41bf-82a1-4616b98b6c1e`
...
- load_id: `6dfb303e-518e-4a38-99a0-d6a5e689240a`
...
- load_id: `3614f570-3acd-43c9-a6bd-3d6b4a53fcfd`
...
- load_id: `287b89fe-f7da-4118-bfad-ab8852a877d7`
...
- No graded predictions; document-only.
- load_id: `a5e55d01-055b-4a45-8d0d-51f57b0f2402`
