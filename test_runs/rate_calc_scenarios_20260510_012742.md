# Rate Calculator Scenarios -- 20260510_012742

**Run ID:** `d54d499d-b98f-4903-a9b9-c3928889b877`
**Total scenarios:** 45
...
- load_id: `1d1e8c82-f8e3-4884-ac77-b64ebca686d8`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `c3665683-abfb-496c-9318-510339034e95`
...
- load_id: `68eb3490-652f-4354-bc08-49d30078fa3f`
...
- load_id: `1288f0e6-54f0-4e26-a631-8cfcd78185b9`
...
- load_id: `99bb1acd-a399-4803-bcd4-d9a4c2a26c58`
...
- load_id: `edaef911-a774-4d51-9da2-fb0ac6301739`
...
- cost_estimate matched (1610.0).
- load_id: `b1d0640a-0202-451d-acaf-b6d7d6c8269d`
...
- load_id: `113b6352-b19d-4e66-9af3-444a20a14d8e`
...
- load_id: `36c428b5-1314-45a1-a303-244474c00395`
...
- load_id: `9db26011-e985-45df-8ab3-1e1480f7b8b2`
...
- load_id: `d4eab0f6-b4f8-4a97-abd5-67899ba94aec`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `17ec7035-4329-44a4-ba43-4576a34c0b32`
...
- load_id: `d647149f-c535-4e83-85b6-67b6c60ffc0d`
...
- load_id: `7fe0a658-d168-42c3-888f-16d3a00bf62b`
...
- load_id: `0a1cf1aa-50ea-43cf-b718-4ffa54fc571a`
...
- cost_estimate matched (1610.0).
- load_id: `71a0ce77-c2bf-4f0d-a88c-4775c04d1dcf`
...
- cost_estimate matched (1610.0).
- load_id: `5d2a3817-2451-4f8f-9104-9ba34fe79cab`
...
- cost_estimate matched (1610.0).
- load_id: `b40b81b5-3439-46d4-815d-4195269f958c`
...
- cost_estimate matched (1610.0).
- load_id: `b02ac203-ff0e-4336-b8d5-79ea7b07dbab`
...
- cost_estimate matched (1610.0).
- load_id: `147882ce-27e9-46d2-b2fb-bef6f603c36b`
...
- cost_estimate matched (1610.0).
- load_id: `22638ab4-e388-4abe-8c9f-9ebf5e32f550`
...
- cost_estimate matched (1610.0).
- load_id: `6d23b6d4-411a-4721-81d1-9f83f74fcf19`
...
- cost_estimate matched (1610.0).
- load_id: `433266e7-f6f2-4780-8902-bf56a753a7b8`
...
- cost_estimate matched (1610.0).
- load_id: `41296808-f990-4586-bf5e-f879a399e596`
...
- cost_estimate matched (1610.0).
- load_id: `3ec213dc-07f1-480f-8edc-a55f0df0c0ba`
...
- cost_estimate matched (1610.0).
- load_id: `a3c4a4a0-dc41-4aa4-a6b8-98208ef77f40`
...
- cost_estimate matched (1610.0).
- load_id: `972432c8-e300-49eb-a5cb-9c47c3d5c07d`
...
- cost_estimate matched (1610.0).
- load_id: `572b8d04-3177-432e-b05d-bf35ec863808`
...
- cost_estimate matched (245.0).
- load_id: `4cb9f410-d716-45c1-ba63-32057de1e514`
...
- load_id: `db57fb0d-9e6d-44f0-9834-77c2e61deeec`
...
- load_id: `1e7e46fc-ebfe-448f-ac36-05a9cbed0609`
...
- load_id: `ad3230aa-c7b4-4e61-82cc-3ace0362163d`
...
- load_id: `71fb84fd-b20e-4ba6-bdb1-b700f6794b42`
...
- load_id: `c29d3804-01e8-47e7-bbb3-8d8969ed4386`
...
- load_id: `55409d5f-4822-4e7b-b639-cf4624651951`
...
- No graded predictions; document-only.
- load_id: `229153ad-620b-435c-a51c-3eb2ab93b818`
