# Rate Calculator Scenario Battery -- 20260510_001025

Total: 66  |  PASS: 29  |  FAIL: 1  |  OPEN: 36
...
| 46 | FAIL | margin | `margin_soft_warn_below_15pct` | verdict: expected 'soft_warn', got 'hard_block' |
...
### margin_soft_warn_below_15pct

- description: Sell $2200 / Buy $1980 -> margin $220 (10%) -- soft_warn.
- error: verdict: expected 'soft_warn', got 'hard_block'
- actual: `{'verdict': 'hard_block', 'sell_rate': 2200.0, 'carrier_rate': 1980.0, 'margin_usd': 220.0, 'margin_pct': 0.1, 'floors': {'margin_floor_usd': {'margin_usd': 220.0, 'min_required': 250.0}}, 'reasons': ['❌ Margin $220.00 is below absolute floor of $250.00.'], 'reason_short': 'below_floor_usd', 'margin_pct_display': 10.0}`
