# Rate Calculator Scenarios -- 20260510_111658

**Run ID:** `692051e4-4000-4a14-8160-5e047584b686`
**Total scenarios:** 45
...
- load_id: `9ad88c43-3128-43a1-b393-4baa08f68f1b`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `3e3ee385-7ef4-441d-a346-ea1d377cf75d`
...
- load_id: `f7fd3fb4-bbb3-4c62-bf39-042484b380eb`
...
- load_id: `783a332c-d556-4f06-9c0d-49e6d2326a5e`
...
- load_id: `16f4dfc3-a36a-42ee-bb3f-2cf8ba089559`
...
- load_id: `08ceb776-6398-429f-acbd-b5aa47b8d90b`
...
- cost_estimate matched (1610.0).
- load_id: `e86a18d6-85cb-467c-bfd7-e7df78aa03e0`
...
- load_id: `b2f61f2c-bc8d-4b3b-9647-9c9881c1e5d2`
...
- load_id: `304fafc5-f9dc-44fc-b137-6a23e0007c38`
...
- load_id: `9e819d6d-506b-4e6c-b4cc-793f30a8f412`
...
- load_id: `ce810768-ad48-4bc2-96e3-600a83b5404c`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `62c0956c-6b32-4d47-b599-d074d9f5eb95`
...
- load_id: `7ec47363-807d-4667-bcee-9685dd5b5418`
...
- load_id: `61f98534-30ae-479b-9f44-1ca0f518f967`
...
- load_id: `ef046240-c19a-48e8-9fab-6c99f36c5e3b`
...
- cost_estimate matched (1610.0).
- load_id: `906d8948-ebca-4bc2-bfd9-dc78e45c2741`
...
- cost_estimate matched (1610.0).
- load_id: `a142f05f-3288-47f0-b6e4-75d621ebea48`
...
- cost_estimate matched (1610.0).
- load_id: `3694a173-807b-4f51-88d3-6f8d52f9136e`
...
- cost_estimate matched (1610.0).
- load_id: `e3eff621-6972-4aaf-94d2-58dee1dc04ee`
...
- cost_estimate matched (1610.0).
- load_id: `1684e2da-c1bf-4da9-bb67-e930889aa3b1`
...
- cost_estimate matched (1610.0).
- load_id: `2310452a-431b-4d1a-bce8-e2bcce60c99b`
...
- cost_estimate matched (1610.0).
- load_id: `e87cf92c-efcd-4bfc-b044-b072a8503bdf`
...
- cost_estimate matched (1610.0).
- load_id: `8bc7d1d3-ce8b-4896-ab6b-5617f8e1328e`
...
- cost_estimate matched (1610.0).
- load_id: `e368913e-bd8f-4ce5-a435-7cd73006c20a`
...
- cost_estimate matched (1610.0).
- load_id: `a5f97ea9-59b2-4355-8c03-a287a1883883`
...
- cost_estimate matched (1610.0).
- load_id: `22d107ea-96c2-4c12-8ee8-b9759faf3a71`
...
- cost_estimate matched (1610.0).
- load_id: `88ddd81f-9785-45fc-aa0f-191298e944c7`
...
- cost_estimate matched (1610.0).
- load_id: `d19c12ba-8573-4d27-b179-c6c987df2d9d`
...
- cost_estimate matched (245.0).
- load_id: `47629022-944a-489d-b675-9fee6a2c0fab`
...
- load_id: `9c218e6b-15a1-424c-8bb3-cd1dab0762ac`
...
- load_id: `18ac639b-39ef-4c32-886c-704d0d9fa72d`
...
- load_id: `e4dcef3e-ec51-4d93-8612-6c86c9adaa16`
...
- load_id: `d49c7a46-8a87-4680-9ae8-f49df12a0131`
...
- load_id: `89f030d0-43ac-4fb4-b3e9-c26fea59a4f7`
...
- load_id: `f9bfb0b6-3e72-411e-a6ec-12c80cc25461`
...
- No graded predictions; document-only.
- load_id: `a9ef4eb4-e43d-4ae3-977e-c71fba5e8dd7`
