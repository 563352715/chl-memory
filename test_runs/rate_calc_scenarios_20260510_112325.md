# Rate Calculator Scenarios -- 20260510_112325

**Run ID:** `3d9e4261-2361-4751-9430-e2db3b19c8dc`
**Total scenarios:** 45
...
- load_id: `da580ad5-6e34-4410-942b-8d690d86fba8`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `d0911612-8a71-48e7-a143-b2e91cd4998f`
...
- load_id: `a8e35b0e-22a4-44b9-8816-3a402773ace2`
...
- load_id: `7608d41f-610e-428a-afe7-0422560ee5ad`
...
- load_id: `e3c2fedf-a852-43d2-a6ce-5b47731b184f`
...
- load_id: `f89d362f-737c-4bfb-a8b2-993a198cfe3b`
...
- cost_estimate matched (1610.0).
- load_id: `b35d07c4-85f8-47ab-8b8f-ae996bafcf65`
...
- load_id: `e09f1abb-36a6-4194-8066-3d1ac10cce09`
...
- load_id: `90cdb040-c1ee-48c3-879f-4ba219a5775b`
...
- load_id: `f71f7abc-c3cb-426f-87f0-5259dec9b261`
...
- load_id: `bf78956a-57a2-44e2-888f-6aa4ce162318`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `5a7da175-56a7-4e92-9a31-1a9bdb6188c9`
...
- load_id: `c3bf2f57-1695-44e6-90b6-f76e46046ffa`
...
- load_id: `80a298f1-8431-4d62-8dc2-039d59083441`
...
- load_id: `93d4e0c9-dd82-485b-9443-32e73f0469e2`
...
- cost_estimate matched (1610.0).
- load_id: `ee720e27-82cb-4439-8095-a727245251c2`
...
- cost_estimate matched (1610.0).
- load_id: `01b2970e-8cf6-4965-86dd-912c9dd106b4`
...
- cost_estimate matched (1610.0).
- load_id: `5d5404a6-0810-4024-8cb7-d29589340703`
...
- cost_estimate matched (1610.0).
- load_id: `81a64733-abdd-411f-ad90-41f449e3669e`
...
- cost_estimate matched (1610.0).
- load_id: `afe4fd3f-ca51-45be-ad39-4ee0ac32456e`
...
- cost_estimate matched (1610.0).
- load_id: `c393844f-dad9-4437-9e08-24dafc53c33c`
...
- cost_estimate matched (1610.0).
- load_id: `2c47fe1c-c5d0-462a-ab1b-79e180fdf0ec`
...
- cost_estimate matched (1610.0).
- load_id: `7ba3803d-12e0-47d7-a9b1-10efe221a6d2`
...
- cost_estimate matched (1610.0).
- load_id: `689d1405-d815-4fc3-95e8-45b601a8000e`
...
- cost_estimate matched (1610.0).
- load_id: `a0b9a514-28ce-47bd-95c7-ccc780213571`
...
- cost_estimate matched (1610.0).
- load_id: `413714c6-7ba5-45ea-9d1e-a5d9bd0a7293`
...
- cost_estimate matched (1610.0).
- load_id: `d2945a0a-abc5-40d4-a4e0-206715304658`
...
- cost_estimate matched (1610.0).
- load_id: `5cc9ea79-f968-4aed-a78c-5c0de504e931`
...
- cost_estimate matched (245.0).
- load_id: `5e710dca-abb6-499f-b694-47e50670329d`
...
- load_id: `fa0e912c-fa2e-4bf1-bd83-0139e1efe9be`
...
- load_id: `7efb6544-5095-4f09-815f-39149066d6f4`
...
- load_id: `bea8d180-6d84-41f7-82dd-f591bf333085`
...
- load_id: `b37e8f4a-a7b6-403b-8cb3-ac3cc7faaa5f`
...
- load_id: `d6c5fc9a-e6c0-4fb5-949e-ec99f3a724f1`
...
- load_id: `1b4a4e52-79a6-4699-bfe0-8a4aae3d186e`
...
- No graded predictions; document-only.
- load_id: `0d94eae0-2fd3-4314-bae7-d91bca3be701`
