# Rate Calculator Scenarios -- 20260510_015431

**Run ID:** `26639c6a-1d52-427e-9839-cbe4c37bcca9`
**Total scenarios:** 45
...
- load_id: `3e5db73c-7825-4841-85af-bf8379234c5b`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `6fcff52d-2d50-43ca-b20b-3ec1c2b46b58`
...
- load_id: `c6beb67e-0b7f-4aca-aa05-2069fd5205ba`
...
- load_id: `88dc0ba6-8731-4760-b341-ee4cf3bdf0db`
...
- load_id: `aca76759-f39f-4b88-a6c1-5b66d6bfb85b`
...
- load_id: `9ed54471-e1cb-4862-9708-602aa61e5f1f`
...
- cost_estimate matched (1610.0).
- load_id: `f3c24b4a-c03a-4c8a-9075-0af726d3360f`
...
- load_id: `477945f9-6387-44a2-b762-242336012102`
...
- load_id: `c8be82a6-9012-4999-992a-e59db0782bb8`
...
- load_id: `535adef0-0d0b-4cee-bf6b-e0aa57362831`
...
- load_id: `53fac544-11e1-4239-8fa7-7ee851668d02`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `b79e61c2-318e-4d29-aaa2-cd49c8227d6f`
...
- load_id: `2b919b4f-433e-42cd-b4b8-14a202602b91`
...
- load_id: `83def13f-d94a-4844-bf79-7694bd1f46fc`
...
- load_id: `344acb38-c487-47cb-a9de-6491bc9a9504`
...
- cost_estimate matched (1610.0).
- load_id: `7b2f2ab7-51c4-48d2-86ab-961c616bd468`
...
- cost_estimate matched (1610.0).
- load_id: `a8737175-8d05-4f06-8076-777317f91813`
...
- cost_estimate matched (1610.0).
- load_id: `ae28a39e-eb6b-47a0-bd5d-172a3272ede7`
...
- cost_estimate matched (1610.0).
- load_id: `fe518ab4-86ea-4ed5-809a-f0ac698e449e`
...
- cost_estimate matched (1610.0).
- load_id: `c8021ac1-27ad-4d70-936d-d2d4efa503e4`
...
- cost_estimate matched (1610.0).
- load_id: `8b05b6da-ca78-45b8-bfef-f78a42d82416`
...
- cost_estimate matched (1610.0).
- load_id: `57580d1f-091f-45f3-8962-6582775f00c4`
...
- cost_estimate matched (1610.0).
- load_id: `f0e3872f-59fc-40e5-9885-0724b0aa9a21`
...
- cost_estimate matched (1610.0).
- load_id: `6e1b63e3-3f76-4503-80a6-0cc05d5b9fff`
...
- cost_estimate matched (1610.0).
- load_id: `8b86fd94-8c26-4360-9777-be7e07e53fd3`
...
- cost_estimate matched (1610.0).
- load_id: `5cc1c032-ca5c-4b7e-b754-9a3658010b23`
...
- cost_estimate matched (1610.0).
- load_id: `09711e15-25b8-497d-a93e-a6fe4a12da87`
...
- cost_estimate matched (1610.0).
- load_id: `379a57d2-26e9-4978-b7a7-2b9efaf9e254`
...
- cost_estimate matched (245.0).
- load_id: `04ff6fe6-2058-464e-984b-043be0f4410f`
...
- load_id: `d7e18d6d-9761-4849-a2cc-a11c229ef556`
...
- load_id: `85466de4-76ec-4d51-84cc-8341cb3b75e4`
...
- load_id: `ba0f41bd-1ad9-4f8b-b3b1-dbcf8e44715b`
...
- load_id: `07514987-a3e2-41e7-aa12-a7616ee7da49`
...
- load_id: `b4ebe07e-6f64-43f1-abde-27c21588b5aa`
...
- load_id: `0692432b-671d-4c12-a367-aac6473cbaee`
...
- No graded predictions; document-only.
- load_id: `10ba720d-f7cd-40a1-9478-b832b62e722c`
