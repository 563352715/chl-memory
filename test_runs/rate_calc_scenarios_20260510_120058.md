# Rate Calculator Scenarios -- 20260510_120058

**Run ID:** `efec0efc-7b11-477c-8810-d06b23b07cee`
**Total scenarios:** 45
...
- load_id: `99b0cf0f-f8fb-4dce-bc8e-228eac28895f`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `364d346e-02d0-491f-b715-c43fd07d95a0`
...
- load_id: `d273de2a-e0dc-4efa-b099-af8889aefcfd`
...
- load_id: `cee7f1eb-4b86-4eb5-8eca-eb1ab1aa8e19`
...
- load_id: `0e896dda-ef44-4e49-85bb-2741137db143`
...
- load_id: `ea7952b5-6f93-441d-ad01-323cd5723f6d`
...
- cost_estimate matched (1610.0).
- load_id: `2a9259c6-e51d-4bb5-8be2-f86e8f00786b`
...
- load_id: `54e842f8-cf48-4989-b1ac-a6328cde559e`
...
- load_id: `91522e09-e03e-4408-afbc-73be07604b60`
...
- load_id: `aed6b38b-cbdd-4952-858c-e990430db880`
...
- load_id: `f3264b64-25e4-4e08-8d47-4c474a7bb05d`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `bac7818e-4208-446e-a978-5028733d8c5c`
...
- load_id: `030096ab-05f6-4322-8d0c-97d009ca6bde`
...
- load_id: `13b91568-766d-49bf-abe2-edcea2a8b9d2`
...
- load_id: `5cf92a22-51c4-44aa-95bb-b251a4d075dc`
...
- cost_estimate matched (1610.0).
- load_id: `967d5e60-33b3-4778-9f4b-c027843be3af`
...
- cost_estimate matched (1610.0).
- load_id: `573ff9a4-6ffc-4dc4-a079-10cd5205c814`
...
- cost_estimate matched (1610.0).
- load_id: `edeeecd2-622a-400f-9fd5-55942b57d559`
...
- cost_estimate matched (1610.0).
- load_id: `c1eb04a8-d381-4233-b736-759871ab0fbc`
...
- cost_estimate matched (1610.0).
- load_id: `e9bf6386-4e88-4ae5-8a82-fd4811f1b9fa`
...
- cost_estimate matched (1610.0).
- load_id: `870acb6a-c83c-4b0e-8cd6-383dabeaf2dc`
...
- cost_estimate matched (1610.0).
- load_id: `bee77de0-12f5-4510-aa1b-be736ed8abcf`
...
- cost_estimate matched (1610.0).
- load_id: `ce05375f-a608-4fa3-9f7e-1dee002763f0`
...
- cost_estimate matched (1610.0).
- load_id: `c62af47e-30ab-4ca9-8965-c00ec8a807e8`
...
- cost_estimate matched (1610.0).
- load_id: `6657e55e-8747-4be9-926b-9364d171cae4`
...
- cost_estimate matched (1610.0).
- load_id: `c6a8b262-91a7-4be8-8f1a-ad33e6da258e`
...
- cost_estimate matched (1610.0).
- load_id: `58200747-7c10-4797-a985-9b227cd3f117`
...
- cost_estimate matched (1610.0).
- load_id: `4c481c92-ba0b-4f02-bfa5-14f74b617a15`
...
- cost_estimate matched (245.0).
- load_id: `41b32322-0218-4c18-9d12-d1c321e61086`
...
- load_id: `e2bbb2a9-233e-4043-9885-8dccdd939366`
...
- load_id: `149a0cf8-040e-45c7-bcae-e624206a86f4`
...
- load_id: `230b3bef-2f59-4ce2-a5c9-e90dc709fcd6`
...
- load_id: `346dfcdf-1d80-4383-998e-757a96dc59b6`
...
- load_id: `da947fdc-1a75-47c5-8126-96940b698dbb`
...
- load_id: `28b91237-a0bd-4290-ace0-abd4118cd665`
...
- No graded predictions; document-only.
- load_id: `ed4c98da-fc3c-4d2b-9698-34b6546565c0`
