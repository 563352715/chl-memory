# Rate Calculator Scenarios -- 20260510_032155

**Run ID:** `f84661a5-c79f-41b6-b46c-24cab2cdb23e`
**Total scenarios:** 45
...
- load_id: `cdc16e76-9d7a-4e77-9de3-f93315ee92d5`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `ce35b331-17bf-481c-876b-30cbefd61088`
...
- load_id: `523ddb32-67bc-4891-a4e1-7d236a1f9d44`
...
- load_id: `908dbc49-84c7-48e3-89ed-47d3ffb61623`
...
- load_id: `40ea4299-46f0-4a2a-9afe-c655670503e3`
...
- load_id: `7232930b-f7f3-403f-88da-c66c4302726c`
...
- cost_estimate matched (1610.0).
- load_id: `b75938b9-675d-4130-806d-05be40e02a6e`
...
- load_id: `ba7b49a8-04ef-40f7-bd1d-be4a12bd88a8`
...
- load_id: `e1feb9fe-7aae-40b7-b527-90b1c0ae43e5`
...
- load_id: `4c077d17-acd2-4645-a7e6-a1eec34a9180`
...
- load_id: `d14d24cc-f41e-479c-aa47-1ea38a07d9b6`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `d1ea6477-6289-4e6a-a176-172f1bfa5314`
...
- load_id: `2a2d458a-e8b9-407e-ba59-f530ed0778a2`
...
- load_id: `cf7bb0fa-28c1-4b71-ba94-8de193ee83eb`
...
- load_id: `c5fba9da-0039-4d07-a539-3c05b16e44db`
...
- cost_estimate matched (1610.0).
- load_id: `574da198-0cb8-4392-9fbe-ebd69ecb0c3f`
...
- cost_estimate matched (1610.0).
- load_id: `63c35b24-818e-4e5c-b538-078bd3e30861`
...
- cost_estimate matched (1610.0).
- load_id: `e39a9b11-2883-405c-91bc-2aa6178dad45`
...
- cost_estimate matched (1610.0).
- load_id: `e68f0c28-a844-410e-9093-652aa613c6c2`
...
- cost_estimate matched (1610.0).
- load_id: `a4104e7c-462c-4718-9df6-1d86dd78416d`
...
- cost_estimate matched (1610.0).
- load_id: `48e3cbee-a18b-496c-abb5-19ff03d871ca`
...
- cost_estimate matched (1610.0).
- load_id: `ae493435-ae73-46d4-b51a-f3baadc9c8fe`
...
- cost_estimate matched (1610.0).
- load_id: `441e8cce-1568-43b1-aed2-e4f4c769512f`
...
- cost_estimate matched (1610.0).
- load_id: `7127d737-356f-4fc4-ac81-22e2d30423eb`
...
- cost_estimate matched (1610.0).
- load_id: `10e43a87-9d87-4624-99da-3dacced3afd0`
...
- cost_estimate matched (1610.0).
- load_id: `674396be-c5e3-49d7-a275-ecc1af8e4761`
...
- cost_estimate matched (1610.0).
- load_id: `04ca66dd-862c-4d29-8f6d-547f1374ec57`
...
- cost_estimate matched (1610.0).
- load_id: `478c16b2-0e16-43bb-9001-570719c7be3a`
...
- cost_estimate matched (245.0).
- load_id: `3b311f76-b5ba-4eef-9f97-2b7b04989903`
...
- load_id: `27ce4b8d-d0fe-4eed-ac2f-aa6e2ed7d827`
...
- load_id: `6a57667c-5ae2-451a-83eb-9c604c0db8a7`
...
- load_id: `b4bb9233-50f4-45e8-9441-783c8ad7ad34`
...
- load_id: `03b94b50-59f8-4df0-98c6-547bf1486b37`
...
- load_id: `95244e0c-da71-4254-a91b-d8c52c61384e`
...
- load_id: `eeb6562b-162d-4c67-bea0-58a5fb609b5e`
...
- No graded predictions; document-only.
- load_id: `9b4d5c1b-2c36-47e8-859d-471bc1a3afcf`
