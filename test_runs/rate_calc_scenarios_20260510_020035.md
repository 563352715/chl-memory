# Rate Calculator Scenarios -- 20260510_020035

**Run ID:** `57b6278a-00db-4b8e-adb6-6712d1249a5b`
**Total scenarios:** 45
...
- load_id: `c8e54381-8ad6-4bac-9ff5-20e22e28adb1`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `6ba29f39-0b04-442b-87d6-8ee9affa4873`
...
- load_id: `94cd024a-6d6d-4730-800d-40a2bde6d832`
...
- load_id: `329d9bde-ea48-4acf-a3b9-01ef504038b9`
...
- load_id: `a08ce36d-9df2-45af-aeb0-2b5af229b670`
...
- load_id: `044d1b9a-33ac-4501-8f14-80573926ed9e`
...
- cost_estimate matched (1610.0).
- load_id: `e372bbc9-ae93-4a39-a713-b22ca9955181`
...
- load_id: `9320e29a-e2a6-4dd5-a098-338d5ae57947`
...
- load_id: `1f86df69-f0cc-4e28-9246-c18e0abc4589`
...
- load_id: `7e3bc751-d3db-4b33-9842-4545a471365f`
...
- load_id: `912f3e2b-3675-4ef2-ae7e-dbdad854b6c3`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `c54679ec-b036-45e2-bb71-155477a65f9d`
...
- load_id: `0c46ee19-5d21-48e6-89d7-c77d2e7baa03`
...
- load_id: `89a2dbcd-de71-44c4-ad1a-098d29744b55`
...
- load_id: `889f9816-570c-4ca4-a153-410147d0d924`
...
- cost_estimate matched (1610.0).
- load_id: `27b7fce0-5ded-45f3-ac5d-7211ff43d327`
...
- cost_estimate matched (1610.0).
- load_id: `199dbdd7-c658-4ffa-8cbc-62c247fd14e1`
...
- cost_estimate matched (1610.0).
- load_id: `b5aa0379-ea3d-4409-9da2-3d94340e8cbc`
...
- cost_estimate matched (1610.0).
- load_id: `1012d08e-b541-40ea-b1c1-59fb2d670ac7`
...
- cost_estimate matched (1610.0).
- load_id: `04ef5bd3-cec7-4056-8180-a2687943e682`
...
- cost_estimate matched (1610.0).
- load_id: `293542e8-dee7-43eb-a50d-8c8d4647b3a9`
...
- cost_estimate matched (1610.0).
- load_id: `08022014-3c54-4958-ba67-9bc987d76fb5`
...
- cost_estimate matched (1610.0).
- load_id: `1e7d9997-f496-4c57-a2a4-8e070a91ef9a`
...
- cost_estimate matched (1610.0).
- load_id: `6c1ca033-1b5b-4d12-bccb-da88944fc9d4`
...
- cost_estimate matched (1610.0).
- load_id: `715bcfd7-b71d-4b53-98a7-c6bf61929256`
...
- cost_estimate matched (1610.0).
- load_id: `ebf1a717-0381-4e65-8476-aa3a27f65df2`
...
- cost_estimate matched (1610.0).
- load_id: `65a6c07a-a1cc-4cc9-9153-26a337197d40`
...
- cost_estimate matched (1610.0).
- load_id: `207af02f-0728-400b-9483-08cd894d0ab7`
...
- cost_estimate matched (245.0).
- load_id: `da9afc6b-566e-4723-9ec7-d9e10c724829`
...
- load_id: `5ee4f13a-73db-4d11-8a0d-0eea38af905b`
...
- load_id: `539b9f4d-8f78-4e03-9c0a-d964476b7738`
...
- load_id: `846e7e7b-f955-465d-803a-234773ab8c6a`
...
- load_id: `f65e7dfc-8576-432f-ad4d-5f31acb9af9d`
...
- load_id: `f066e33d-5a72-4540-9107-4b7cabd4c572`
...
- load_id: `9d5b2eac-3b54-4573-90f9-1bee96825c60`
...
- No graded predictions; document-only.
- load_id: `e0463c91-0afe-42d3-9fcd-7be356618436`
