# Rate Calculator Scenarios -- 20260510_121350

**Run ID:** `f31e3404-c5d7-4a42-9290-b62629b83316`
**Total scenarios:** 45
...
- load_id: `71515289-f5c7-48cf-9116-ec8f4a1bff6f`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `e383abf1-bcbf-4ec0-baa5-58690edb7e58`
...
- load_id: `7cd44b35-f75c-4610-b92f-48589337391a`
...
- load_id: `07860319-4047-476a-9a32-4011b77bbbec`
...
- load_id: `aae4199b-4fa8-4206-9823-5058e6e044e6`
...
- load_id: `3a3949c2-a508-4faa-94d2-49334283d920`
...
- cost_estimate matched (1610.0).
- load_id: `9bdc5f46-3602-4034-8432-36f3ff7d2adc`
...
- load_id: `f6f38ab2-b458-4336-bb05-ffb3cd1f864f`
...
- load_id: `a8f8db25-daf1-4254-9072-f3eed39e7f44`
...
- load_id: `a28d9fa9-6d3c-4fe5-b0fc-dade5be71ad4`
...
- load_id: `0b8cbf76-e372-4892-99a4-fb46ec5c7d2e`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `fccafe06-c27a-41fa-8c4b-a69c969275b3`
...
- load_id: `3e8243f2-a276-43f4-a776-c1305761c5b9`
...
- load_id: `bda66282-9507-4fb6-a7ef-3e6659002d2b`
...
- load_id: `80575c7b-a50d-4db7-8b09-c29a74b16b08`
...
- cost_estimate matched (1610.0).
- load_id: `3106b190-96f3-4c6f-97df-5232190fc83e`
...
- cost_estimate matched (1610.0).
- load_id: `1befdb07-3394-4203-bc11-15b865248e32`
...
- cost_estimate matched (1610.0).
- load_id: `d98a5425-10c0-4a6d-8691-7d906f9cc1af`
...
- cost_estimate matched (1610.0).
- load_id: `067ed903-b770-43ae-bb5a-af07af7b484f`
...
- cost_estimate matched (1610.0).
- load_id: `4d8e924d-10f5-42d4-98c0-3e795c4bf2fc`
...
- cost_estimate matched (1610.0).
- load_id: `317e3220-9c37-4d85-a212-b0f917e15351`
...
- cost_estimate matched (1610.0).
- load_id: `7a183942-a17b-406d-932c-814b9a9bce67`
...
- cost_estimate matched (1610.0).
- load_id: `96a5d9b3-3a82-4614-bdc6-963622f0671b`
...
- cost_estimate matched (1610.0).
- load_id: `da3daf16-5e26-4db4-a754-a0c539deca5e`
...
- cost_estimate matched (1610.0).
- load_id: `8ffef30a-c29c-4b48-a2f2-996bb7cced16`
...
- cost_estimate matched (1610.0).
- load_id: `c127f1af-4d66-41f4-8243-afbdcbdaa6d0`
...
- cost_estimate matched (1610.0).
- load_id: `e9b41c85-8228-43be-9507-6745f5156e36`
...
- cost_estimate matched (1610.0).
- load_id: `13accf74-fd14-459a-8b8f-aab777a96bc3`
...
- cost_estimate matched (245.0).
- load_id: `5570113d-c55c-4978-b9c4-95613fc800a6`
...
- load_id: `97586411-b16b-48b9-82df-ff066a83a6bc`
...
- load_id: `2ab754e1-9b1f-4f2d-a8fb-f1a1f7cad0d0`
...
- load_id: `7ed47186-320c-4015-95ab-7d2366591cf1`
...
- load_id: `0cff7d74-b300-4356-8d05-9075777236b1`
...
- load_id: `1cd65d73-06ae-489e-9897-e6131cb09aa1`
...
- load_id: `ee17f330-0cc0-4911-ab0b-f767e868c899`
...
- No graded predictions; document-only.
- load_id: `c793b281-7339-4b46-8195-674c777480a2`
