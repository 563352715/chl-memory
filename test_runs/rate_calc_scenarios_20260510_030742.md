# Rate Calculator Scenarios -- 20260510_030742

**Run ID:** `af314242-202c-453b-972d-98984099d7b2`
**Total scenarios:** 45
...
- load_id: `ee9916c7-dcac-4d2d-a8cd-534842149a33`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `5b9ffb5f-506f-4a95-98ff-68346285faf2`
...
- load_id: `7902f74c-05bf-4ebd-b8a8-34a47fde5308`
...
- load_id: `93218d40-a381-4a0b-a54c-c4fe5f56f933`
...
- load_id: `a9027d02-ba20-4cf3-9b11-182c79f93f88`
...
- load_id: `a8440609-1017-49fd-aa1e-da4dbeb0cc53`
...
- cost_estimate matched (1610.0).
- load_id: `32ddd685-ccb3-4f09-8e97-15a05dd74c3f`
...
- load_id: `1545ab3b-7a26-45b0-8674-778897351b7a`
...
- load_id: `3bcdee8f-5981-4b23-bf97-66dee48d0eeb`
...
- load_id: `97a39e77-f687-489e-bd68-87ff10f8d4bc`
...
- load_id: `6b0c084d-e32c-4770-9ee3-52a98ba5939b`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `f720ff6f-1864-4e29-aa0d-615c762e53c2`
...
- load_id: `2d2d9e93-dafa-42dd-9455-e9f197365ef2`
...
- load_id: `1d2e9fa1-5c37-40e2-b4db-1dbeb932004e`
...
- load_id: `81d13163-7618-49f0-bf1f-d878c037c82d`
...
- cost_estimate matched (1610.0).
- load_id: `59e54ef9-6519-4f86-888d-5b64a8e72891`
...
- cost_estimate matched (1610.0).
- load_id: `648573f1-d30c-4c3a-95e6-84f4f642a695`
...
- cost_estimate matched (1610.0).
- load_id: `0cee4597-626e-49af-a087-94e8c7b94f44`
...
- cost_estimate matched (1610.0).
- load_id: `820c1ee4-82f5-455e-82f3-ecac5519b6ae`
...
- cost_estimate matched (1610.0).
- load_id: `b3e5c4b8-0e7b-4c00-b5d7-a90b44a02751`
...
- cost_estimate matched (1610.0).
- load_id: `dc197e46-af3b-4bb6-97ba-fecf73f2e4c1`
...
- cost_estimate matched (1610.0).
- load_id: `8b814f77-7bab-4249-af12-7e826adeccd1`
...
- cost_estimate matched (1610.0).
- load_id: `3b6492d0-c003-45eb-9442-4a153cb41ff2`
...
- cost_estimate matched (1610.0).
- load_id: `27b72cfa-0dda-493d-812b-a5d4be2aa3af`
...
- cost_estimate matched (1610.0).
- load_id: `f0dce45d-3037-4692-9e1c-6b2c54ade422`
...
- cost_estimate matched (1610.0).
- load_id: `d27ea3a2-bace-4f4c-8478-e048ae8362f3`
...
- cost_estimate matched (1610.0).
- load_id: `324168ff-1e7e-4ece-aff2-750921ff76e9`
...
- cost_estimate matched (1610.0).
- load_id: `95f67c02-e5d0-455d-b719-c7d3328ce40f`
...
- cost_estimate matched (245.0).
- load_id: `25da7c5c-81a7-48ba-bb41-4347ea8c36db`
...
- load_id: `5fd8ac0a-adc4-4d94-a63f-7c9bc4ad1e5e`
...
- load_id: `353c806c-eda6-4235-aa08-fcbf063b2b55`
...
- load_id: `be90b378-6dfd-4c03-b1df-98f5756ccd5d`
...
- load_id: `bf47931a-767b-4b1d-88db-8dac207e40da`
...
- load_id: `a9f31094-507a-4ff1-adf0-49b2384619d0`
...
- load_id: `4417629a-6cc1-4a53-a9b1-fc0a5faefb94`
...
- No graded predictions; document-only.
- load_id: `ba6fa99c-7523-44c1-9bd0-08f4a1a79a40`
