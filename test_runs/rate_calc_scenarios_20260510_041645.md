# Rate Calculator Scenarios -- 20260510_041645

**Run ID:** `23bd95bc-d659-41cf-ade8-ed2a68fa219d`
**Total scenarios:** 45
...
- load_id: `a2318ece-8409-4026-98a1-98f4ffc54d86`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `321bfcaf-68fc-4667-901d-a63dfc9b1169`
...
- load_id: `cd2dfccb-5b82-40fe-a677-6757feb8a18e`
...
- load_id: `1f9cd640-10d5-4b82-97e4-69116aca2cc8`
...
- load_id: `aa75e040-cc51-4e43-a178-24e696905481`
...
- load_id: `ade7243b-2d2e-4d16-8d07-e5011018faf0`
...
- cost_estimate matched (1610.0).
- load_id: `a12c1dc1-46f8-4ed8-bed1-f246c59bb6ff`
...
- load_id: `1cd06284-d997-48b7-952a-c2a838a9e4c5`
...
- load_id: `e85a5b67-f8f0-4189-8453-8214f54c95a2`
...
- load_id: `0194bb5c-8963-4c38-9566-788f98f38b11`
...
- load_id: `6cce5fa3-652d-4b6b-9ef2-1259c6110012`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `546156e8-58c9-479f-ba3d-615b0ab8cfdc`
...
- load_id: `a8a3de81-646c-40b1-975f-15b2f32380fa`
...
- load_id: `a3b2a559-1bac-4ec5-a8de-fc2a7897e8bd`
...
- load_id: `eaffe525-de8c-4fd2-9317-00938e9c71d1`
...
- cost_estimate matched (1610.0).
- load_id: `77bb1286-e724-4298-9c62-a3add0ecebcb`
...
- cost_estimate matched (1610.0).
- load_id: `4afd2518-b210-4674-aa4d-3b63e2ec65a1`
...
- cost_estimate matched (1610.0).
- load_id: `12b5ab5f-797b-45f4-a648-5e44b6e5eed6`
...
- cost_estimate matched (1610.0).
- load_id: `830a8f81-41dc-4c9b-be3c-94e5280ba3b5`
...
- cost_estimate matched (1610.0).
- load_id: `e0747207-89fe-491e-a2eb-21c8c322068a`
...
- cost_estimate matched (1610.0).
- load_id: `c0daec46-c241-4f54-9b3b-24f67dc677e9`
...
- cost_estimate matched (1610.0).
- load_id: `6dd1053b-3477-4ee9-b929-5d5d4b3c3306`
...
- cost_estimate matched (1610.0).
- load_id: `161f5294-53e0-4902-a80a-97a04c560266`
...
- cost_estimate matched (1610.0).
- load_id: `d3ce9372-a1da-495a-ba0f-54aa30c128cc`
...
- cost_estimate matched (1610.0).
- load_id: `045b180b-ebef-4f76-8ffb-0f1d40813e9c`
...
- cost_estimate matched (1610.0).
- load_id: `d975ecb4-2cd4-42ba-b918-1a7bb8535ffc`
...
- cost_estimate matched (1610.0).
- load_id: `e51a9dca-9a7a-48cb-977b-1333141e1de0`
...
- cost_estimate matched (1610.0).
- load_id: `8806330a-9a48-4c71-860c-551b4f87334d`
...
- cost_estimate matched (245.0).
- load_id: `774cf33b-ccaf-4cab-bf46-e7db908224ae`
...
- load_id: `03e1f55f-4b54-4e44-95f1-c3e19f112332`
...
- load_id: `43bfc301-d443-4954-976d-433e06ab8006`
...
- load_id: `bc246aee-9062-4ee9-bcd7-05bdfbc76370`
...
- load_id: `860ada3e-05f3-4309-bf48-0603e912441d`
...
- load_id: `93b05f74-a667-4f72-87d9-392cdfe11117`
...
- load_id: `316ecbed-feba-4104-87bc-9cf946a81626`
...
- No graded predictions; document-only.
- load_id: `fe6fcb62-08ce-49c9-87d9-27139a0c6115`
