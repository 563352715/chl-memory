# Rate Calculator Scenarios -- 20260510_113930

**Run ID:** `c8f9bd81-9ef3-465d-b202-d1bddb15478f`
**Total scenarios:** 45
...
- load_id: `9dd52a21-f60c-404b-9950-317a58d03208`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `21aaa57f-9755-4c54-89f4-51d1440e498e`
...
- load_id: `7fa8fcc1-c6a6-4ab1-9ce1-22c601ba8d4a`
...
- load_id: `ecaa4007-47c3-444f-849e-56ee6373d00c`
...
- load_id: `b43a3def-7167-4fff-a5a9-7820bd8f70fc`
...
- load_id: `3457d5a6-728c-4bf8-9ef9-6953969be1d0`
...
- cost_estimate matched (1610.0).
- load_id: `ca84955f-44a2-4d0e-8220-f45cbfa93f5a`
...
- load_id: `e81591cc-93d0-4475-8998-c708a8d11a95`
...
- load_id: `8435c9d5-a94c-418e-b7b0-27afd0c2d471`
...
- load_id: `808e61a5-b937-4a7e-ae12-c3bf1f7b845a`
...
- load_id: `7f14d296-585a-4c70-afe2-a3b8091c58cb`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `7d02c4ad-b156-4d7f-be2c-98ba579ad7e2`
...
- load_id: `4714aae1-5749-4aca-aadd-211b0974f286`
...
- load_id: `55b0a0dd-711c-4695-b23b-0d4677afcbcc`
...
- load_id: `283c1093-5004-419e-a203-71176fcdf1c0`
...
- cost_estimate matched (1610.0).
- load_id: `5f887c58-c94d-4f93-9a5b-3dc0bb5200e9`
...
- cost_estimate matched (1610.0).
- load_id: `a0ccf126-e2f5-4391-a1d3-1539c48cd26b`
...
- cost_estimate matched (1610.0).
- load_id: `25f94015-0a18-4bd6-8acb-4d85335598dc`
...
- cost_estimate matched (1610.0).
- load_id: `77503f97-f3ec-49fd-821d-3c1b425b8815`
...
- cost_estimate matched (1610.0).
- load_id: `cd831796-0a2e-49a2-8389-ad7bcd4ffdba`
...
- cost_estimate matched (1610.0).
- load_id: `0fdec894-bf7d-4f80-bfce-4b281ae27a46`
...
- cost_estimate matched (1610.0).
- load_id: `0eb79355-1c55-4abd-bb5b-bdcee176fedd`
...
- cost_estimate matched (1610.0).
- load_id: `d10d1651-e7a0-4aed-88b1-876e133414a0`
...
- cost_estimate matched (1610.0).
- load_id: `c83d0d3c-5331-4f4a-944c-31c25de70f4d`
...
- cost_estimate matched (1610.0).
- load_id: `148c1f31-6bd9-4bbb-b969-a921ea3c3a9a`
...
- cost_estimate matched (1610.0).
- load_id: `e10d753e-05d1-4d3f-9f8e-74fe68bb3f82`
...
- cost_estimate matched (1610.0).
- load_id: `d73b863f-98d2-4b6f-bc86-a41b690fec02`
...
- cost_estimate matched (1610.0).
- load_id: `ee178e1e-f2c2-45af-9e61-50e14dc1326a`
...
- cost_estimate matched (245.0).
- load_id: `d73583e3-e6ff-4cc1-bb7b-67be0fe87971`
...
- load_id: `a514dbf8-e2f8-451b-8b25-ce3d32ad43e2`
...
- load_id: `f0c4adb6-aea1-4188-aaab-c6243efc637d`
...
- load_id: `c18b6066-bd9d-4c10-9bac-ccfdd1a5cb08`
...
- load_id: `49ffe02e-3752-4074-9103-76491d4c9dbf`
...
- load_id: `82427849-c532-4f70-995a-8be7ccab7a1a`
...
- load_id: `bcc06d52-4687-4575-b67f-f195415706d5`
...
- No graded predictions; document-only.
- load_id: `acac4cdc-436e-4ae1-963d-032e723e28f0`
