# Rate Calculator Scenarios -- 20260510_043058

**Run ID:** `a8122b50-99bb-42d4-892c-48d6a031c193`
**Total scenarios:** 45
...
- load_id: `76b26697-d6ca-4a5b-9801-8804b522a631`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `5acb6626-153f-4e61-b9be-52b444f26d33`
...
- load_id: `ceaf6b70-7ef5-4b8e-b4ff-601af40a4c54`
...
- load_id: `53502ee3-60a4-4f00-8666-f337bc795a06`
...
- load_id: `dd8ed522-bf76-4fe1-911e-1f295b910c60`
...
- load_id: `94e3896b-cb58-4287-8e85-88df52dca126`
...
- cost_estimate matched (1610.0).
- load_id: `19909246-2300-4d28-8d87-614e1f0e4835`
...
- load_id: `e9fe669b-50d8-4b75-8d51-4ecedfaa58ca`
...
- load_id: `01d3890f-30e7-40ab-b67b-2b49d89a2ed7`
...
- load_id: `20148d07-c71a-4aec-a197-915ad978f8a0`
...
- load_id: `00d633bf-6fd3-4fd2-b280-825b29fbf4b6`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `39daac7d-603f-4054-86b5-d0365346121c`
...
- load_id: `66538131-d4ae-4084-96b6-ae6933d8eef9`
...
- load_id: `2937c912-9e00-4b81-8362-f19b2392156e`
...
- load_id: `6046d483-dd9a-4592-b753-9c3472c0b4a1`
...
- cost_estimate matched (1610.0).
- load_id: `f1822c74-af55-4261-bf48-0ce99bd4748e`
...
- cost_estimate matched (1610.0).
- load_id: `35df886b-5d76-4182-9b11-625bfc7f1902`
...
- cost_estimate matched (1610.0).
- load_id: `9c27b1f8-1b9f-40fe-9536-e2ac4927580f`
...
- cost_estimate matched (1610.0).
- load_id: `13717741-cb27-4a22-84c7-990f8b6e07f3`
...
- cost_estimate matched (1610.0).
- load_id: `94835641-896e-46e2-87cc-83b957110120`
...
- cost_estimate matched (1610.0).
- load_id: `c28ac6f7-33ce-4133-9154-bb0b8c4fa89f`
...
- cost_estimate matched (1610.0).
- load_id: `a0e7caef-5cfe-4f3f-8f58-6f451e7a0139`
...
- cost_estimate matched (1610.0).
- load_id: `2f336ba6-9bf4-42b7-81ce-36487506a2e7`
...
- cost_estimate matched (1610.0).
- load_id: `8c9bd636-f05b-43cf-941f-af602c651e46`
...
- cost_estimate matched (1610.0).
- load_id: `5937db28-8a32-4c08-ab89-e7731325a53c`
...
- cost_estimate matched (1610.0).
- load_id: `a392b3b1-5ba5-448e-a9b8-e93aeec2e150`
...
- cost_estimate matched (1610.0).
- load_id: `7d19b73f-02bf-4c81-a70b-5fee306aba20`
...
- cost_estimate matched (1610.0).
- load_id: `47b5afa2-8e8d-443e-ae00-fd59f6bd17b0`
...
- cost_estimate matched (245.0).
- load_id: `51561ef1-a183-4e10-bd21-143ff07da213`
...
- load_id: `f1edd7d1-8a87-4aad-9a33-14a3d161f68a`
...
- load_id: `7de9c029-de71-45a7-9c26-1dc3247b68f1`
...
- load_id: `67d4665a-8279-4240-93f2-fd2a8d3a811a`
...
- load_id: `cb3793bc-8a14-4419-abe3-558bc55a3ee7`
...
- load_id: `2e5fc23a-5a23-4d48-9997-983d1a167c0c`
...
- load_id: `3c19a651-66e6-4276-88f8-eb610df16d15`
...
- No graded predictions; document-only.
- load_id: `50ef16b6-da9a-4f88-8132-4a0a214bd6fc`
