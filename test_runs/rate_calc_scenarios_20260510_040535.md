# Rate Calculator Scenarios -- 20260510_040535

**Run ID:** `fd2d0116-3576-4183-a575-80bf6f60a401`
**Total scenarios:** 45
...
- load_id: `895120bb-472b-4be0-8d91-ff7ba65cb4ab`
...
- **predicted:** `{"cost_estimate_value": 245.0, "visibility_bonus": 50.0, "rate_calc_base_rpm": 2.5}`
- cost_estimate matched (245.0).
- load_id: `0eef6527-2f65-4492-b80d-232c1aaba3b9`
...
- load_id: `c2b2a6fc-0f0f-4dde-948f-228e4412b4cf`
...
- load_id: `d9a0126f-29c9-4ce4-b6a1-83ce9e32c14f`
...
- load_id: `2eb64911-9a9c-4a30-bb2f-877baaa576a2`
...
- load_id: `b20c3f1a-147c-4909-9859-ca0c4ee847e4`
...
- cost_estimate matched (1610.0).
- load_id: `279a2e9e-de06-4554-a55f-702a2952691f`
...
- load_id: `79785410-fef1-49b3-ae6d-5d5395f0e905`
...
- load_id: `dc864a73-97fb-4065-ac33-2ee4bad45e32`
...
- load_id: `7ff04afd-5172-4abe-b729-59896e19a09b`
...
- load_id: `8cff7cb4-9623-48a4-ab37-8adbd945cc7c`
...
- **predicted:** `{"rate_calc_base_rpm": 3.1, "cost_estimate_value": 1980.5}`
- cost_estimate matched (1980.5).
- load_id: `1d400611-ba55-4b44-873c-0e08ef227042`
...
- load_id: `3eda5328-593c-4f13-8da9-a7f2aae4667f`
...
- load_id: `42fe581e-56f5-4b8f-be7f-ac7ab3197b9a`
...
- load_id: `b22ff9e3-64e0-4a3c-9b13-811bdac10426`
...
- cost_estimate matched (1610.0).
- load_id: `003aa4b1-1369-4003-911e-1a08338cdd92`
...
- cost_estimate matched (1610.0).
- load_id: `36dc0726-36ce-4f6c-9c20-c444fb10960f`
...
- cost_estimate matched (1610.0).
- load_id: `0e8c2bca-659d-4bc7-8689-793299b4fef5`
...
- cost_estimate matched (1610.0).
- load_id: `c3a582b5-a84e-48ae-8ce7-a46edec4e20a`
...
- cost_estimate matched (1610.0).
- load_id: `61f3cffd-82a6-460d-8662-a38dc970859c`
...
- cost_estimate matched (1610.0).
- load_id: `360dd458-96af-46a7-bbef-28b85822cb7a`
...
- cost_estimate matched (1610.0).
- load_id: `6b44d7b1-37d2-4319-875d-b4f987e6a4a2`
...
- cost_estimate matched (1610.0).
- load_id: `d56e80f1-ea83-461c-8203-dcf54ec2db46`
...
- cost_estimate matched (1610.0).
- load_id: `9e23e4c2-9016-4a4a-a397-9e242804db4f`
...
- cost_estimate matched (1610.0).
- load_id: `3fd942f4-a05d-4fdf-836d-9e9e8d00461a`
...
- cost_estimate matched (1610.0).
- load_id: `aef45fd1-93ae-484d-92c4-f3aefd6bcc36`
...
- cost_estimate matched (1610.0).
- load_id: `24fe98f4-a156-470a-af59-6dffdf11dc6a`
...
- cost_estimate matched (1610.0).
- load_id: `3dd6e641-4658-4583-ba61-d3099721700a`
...
- cost_estimate matched (245.0).
- load_id: `62b9007f-be99-4f8a-a4bd-e474776a065c`
...
- load_id: `b633a21d-e768-4f86-ab69-85f51e79db35`
...
- load_id: `a858c18c-3a08-4170-b496-31cfcf3fe743`
...
- load_id: `99fc70f1-f8bd-4805-887f-6eb8ecc1c0d3`
...
- load_id: `029530c1-08c9-4148-9008-c4694e5032cb`
...
- load_id: `9395638a-87cc-43eb-a6a0-b2be11694466`
...
- load_id: `464bea10-ae63-4778-9c1d-b99a79083334`
...
- No graded predictions; document-only.
- load_id: `6482a5b2-dfb5-4947-b1ec-c21a60bd6d3b`
